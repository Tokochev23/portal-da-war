import"./preload-helper-f85Crcwt.js";/* empty css             */import{L as v,f as m,a as Me,b as ae,V as Ie,c as x,s as le,d as g,e as de,r as ce,g as ue,u as Se,h as Ae,i as ke,j as Te,k as oe,v as _e}from"./firebase-DhEDpEFS.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-app-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-auth-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-storage-compat.js";class $e{constructor(){this.focusableElements=[],this.currentFocusIndex=-1,this.skipLinks=[],this.announcements=new Set,this.init()}init(){this.createSkipLinks(),this.setupKeyboardNavigation(),this.setupFocusManagement(),this.setupLiveRegions(),this.setupAnnouncements(),this.setupColorContrastMode(),this.setupReducedMotion(),v.info("Sistema de acessibilidade inicializado")}createSkipLinks(){const e=document.createElement("div");e.className="skip-links sr-only-focusable",e.innerHTML=`
