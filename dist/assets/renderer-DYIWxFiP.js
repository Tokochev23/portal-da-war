...
import{f as g,b as h,c as Le,d as fe}from"./utils-DLoRv3re.js";import{R as Y}from"./resourceConsumptionCalculator-Bk-hb2mA.js";import{R as Z}from"./resourceProductionCalculator-C5abBl5S.js";import{C as Re}from"./consumerGoodsCalculator-RQh-OK8I.js";import{db as x}from"./firebase-Byc2ZILV.js";import{B as A}from"./shipyardSystem-OMSau52w.js";import{_ as Ne}from"./preload-helper-f85Crcwt.js";import{i as $,I as Oe,e as D}from"./espionageOperationsSystem-BMSdpmVp.js";const K={basic:{name:"Básica",description:"Orçamento e recursos gerais",costMultiplier:1,successBaseChance:.7,icon:"🔍"},intermediate:{name:"Intermediária",description:"Recursos + tecnologias e capacidades",costMultiplier:2.5,successBaseChance:.5,icon:"🔬"},total:{name:"Total",description:"Acesso completo ao inventário militar",costMultiplier:5,successBaseChance:.3,icon:"🎯"}},Fe=5e4;class qe{constructor(){this.activeOperations=new Map,this.lastUpdate=null}async hasActiveSpying(t,e,s){try{const i=await x.collection("espionageOperations").where("spyCountryId","==",t).where("targetCountryId","==",e).where("active","==",!0).get();if(i.empty)return null;const n=i.docs[0].data();return n.id=i.docs[0].id,n.validUntilTurn<s?(await this.deactivateOperation(n.id),null):n}catch(i){return console.error("Erro ao verificar espionagem ativa:",i),null}}calculateOperationCost(t,e,s){const i=K[t];if(!i)return 0;let n=Fe*i.costMultiplier*e;const r=.5+(parseFloat(s.WarPower)||50)/100;return Math.round(n*r)}calculateSuccessChance(t,e,s){const i=K[t];if(!i)return 0;let n=i.successBaseChance;const o=(parseFloat(e.Tecnologia)||0)/100;n+=o*.2;const r=(parseFloat(s.CounterIntelligence)||0)/100;n-=r*3;const l=(parseFloat(s.Urbanizacao)||0)/100;return n-=l*.1,Math.max(.05,Math.min(.95,n))}async initiateOperation(t,e,s,i,n){try{if(await this.hasActiveSpying(t.id,e.id,n))return{success:!1,error:"Você já tem uma operação ativa neste país!"};const r=this.calculateOperationCost(s,i,e);if(this.calculateBudget(t)<r)return{success:!1,error:"Orçamento insuficiente para esta operação!"};const d=this.calculateSuccessChance(s,t,e),c=Math.random()<=d,v=(parseFloat(e.CounterIntelligence)||0)/100*.5,f=Math.random()<=v,b={spyCountryId:t.id,spyCountryName:t.Pais,targetCountryId:e.id,targetCountryName:e.Pais,level:s,startTurn:n,validUntilTurn:n+i,duration:i,investment:r,detected:f,succeeded:c,active:c,createdAt:new Date().toISOString()},w=await x.collection("espionageOperations").add(b);f&&await this.createDetectionNotification(e.id,t.Pais,c);try{await A.addExpense(t.id,A.EXPENSE_CATEGORIES.AGENCY_BUDGET,r,`Operação de espionagem contra ${e.Pais}`)}catch(C){console.error("⚠️ Erro ao registrar despesa de espionagem no budget tracker:",C)}return{success:!0,operation:{...b,id:w.id},cost:r,succeeded:c,detected:f,successChance:Math.round(d*100)}}catch(o){return console.error("Erro ao iniciar operação de espionagem:",o),{success:!1,error:"Erro ao processar operação: "+o.message}}}async deactivateOperation(t){try{return await x.collection("espionageOperations").doc(t).update({active:!1,deactivatedAt:new Date().toISOString()}),!0}catch(e){return console.error("Erro ao desativar operação:",e),!1}}async getActiveOperations(t,e){try{const s=await x.collection("espionageOperations").where("spyCountryId","==",t).where("active","==",!0).get(),i=[];for(const n of s.docs){const o=n.data();o.id=n.id,o.validUntilTurn>=e?i.push(o):await this.deactivateOperation(n.id)}return i}catch(s){return console.error("Erro ao buscar operações ativas:",s),[]}}async getSpyingAttempts(t){try{return(await x.collection("espionageOperations").where("targetCountryId","==",t).where("detected","==",!0).get()).docs.map(s=>({id:s.id,...s.data()}))}catch(e){return console.error("Erro ao buscar tentativas de espionagem:",e),[]}}async createDetectionNotification(t,e,s){try{const i={countryId:t,type:"espionage_detected",message:s?`⚠️ Espionagem detectada! ${e} conseguiu acessar informações classificadas.`:`🛡️ Tentativa de espionagem bloqueada! ${e} tentou acessar informações mas foi impedido.`,spyCountry:e,succeeded:s,read:!1,createdAt:new Date().toISOString()};await x.collection("notifications").add(i)}catch(i){console.error("Erro ao criar notificação:",i)}}async updateCounterIntelligence(t,e){try{const s=Math.max(0,Math.min(10,parseFloat(e)||0));return await x.collection("paises").doc(t).update({CounterIntelligence:s}),{success:!0,newValue:s}}catch(s){return console.error("Erro ao atualizar contra-espionagem:",s),{success:!1,error:s.message}}}calculateBudget(t){const e=parseFloat(t.PIB)||0,s=(parseFloat(t.Burocracia)||0)/100,i=(parseFloat(t.Estabilidade)||0)/100;return e*.25*s*i*1.5}async cleanExpiredOperations(t){try{const e=await x.collection("espionageOperations").where("active","==",!0).get();let s=0;for(const i of e.docs)i.data().validUntilTurn<t&&(await this.deactivateOperation(i.id),s++);return console.log(`🧹 ${s} operações de espionagem expiradas foram limpas.`),s}catch(e){return console.error("Erro ao limpar operações expiradas:",e),0}}getLevels(){return K}}const y=new qe;class ke{constructor(){this.modal=null,this.targetCountry=null,this.spyCountry=null,this.currentTurn=0,this.selectedLevel="basic",this.selectedDuration=3,this.createModal()}createModal(){this.modal=document.createElement("div"),this.modal.id="espionage-modal",this.modal.className="hidden fixed inset-0 z-[70] flex items-center justify-center bg-black/70 backdrop-blur-sm",this.modal.innerHTML=`
  ...
  `;t.innerHTML=l,je(a),Ee(a.id)}function je(a){const t=document.getElementById("counter-intel-slider"),e=document.getElementById("counter-intel-value"),s=document.getElementById("counter-intel-cost"),i=document.getElementById("save-counter-intel"),n=document.getElementById("refresh-attempts");!t||!e||!s||!i||(t.addEventListener("input",o=>{const r=parseFloat(o.target.value);e.textContent=`${r}%`;const d=y.calculateBudget(a)*(r/100);s.textContent=`${g(d)}/turno`}),i.addEventListener("click",async()=>{const o=parseFloat(t.value);i.disabled=!0,i.textContent="⏳ Salvando...";const r=await y.updateCounterIntelligence(a.id,o),l=document.getElementById("counter-intel-feedback"),d=document.getElementById("counter-intel-feedback-text");r.success?(l.className="mt-3 p-3 rounded-lg bg-green-500/10 border border-green-500/30",d.className="text-sm text-green-300",d.textContent=`✅ Configuração salva! Nível de contra-espionagem: ${r.newValue}%`,a.CounterIntelligence=r.newValue,setTimeout(()=>{const p=document.getElementById("counter-intel-container");p&&we(a,p)},2e3)):(l.className="mt-3 p-3 rounded-lg bg-red-500/10 border border-red-500/30",d.className="text-sm text-red-300",d.textContent=`❌ Erro ao salvar: ${r.error}`),l.classList.remove("hidden"),i.disabled=!1,i.textContent="💾 Salvar Configuração",setTimeout(()=>{l.classList.add("hidden")},5e3)}),n&&n.addEventListener("click",()=>{Ee(a.id)}))}async function Ee(a){const t=document.getElementById("detected-attempts-list");if(t){t.innerHTML='<p class="text-xs text-slate-400">⏳ Carregando...</p>';try{const e=await y.getSpyingAttempts(a);if(e.length===0){t.innerHTML=`
      ...
      `;return}e.sort((i,n)=>new Date(n.createdAt)-new Date(i.createdAt));const s=e.slice(0,5);t.innerHTML=s.map(i=>{const n=!i.succeeded,o=n?"🛡️":"⚠️",r=n?"BLOQUEADO":"SUCESSO",l=n?"green":"red",d=Math.max(0,i.startTurn);return`
        ...
        <div class="space-y-4">
          <div class="grid grid-cols-2 gap-3">
            <div class="p-3 rounded-lg bg-slate-900/50">
              ...
              <p class="text-2xl font-bold ${s<3?"text-red-400":s<6?"text-amber-400":"text-green-400"}">
                ${s<3?"⚠️":s<6?"🟡":"🟢"} ${s>0?"Baixa":"Nenhuma"}
              </p>
            </div>
            <div class="p-3 rounded-lg bg-slate-900/50">
              <p class="text-xs text-slate-400 mb-1">Investimento</p>
              <p class="text-2xl font-bold text-brand-400">${s}%</p>
  ...
  `;e.innerHTML=r,Ke(a,n,s),Q(a,t)}function Ge(a){const t=parseFloat(a.PIB)||0,e=(parseFloat(a.Burocracia)||0)/100,s=(parseFloat(a.Estabilidade)||0)/100;return t*.25*e*s*1.5}function Ke(a,t,e){const s=document.getElementById("counter-intel-slider"),i=document.getElementById("counter-intel-preview"),n=document.getElementById("save-counter-intel-btn");if(!s||!i||!n)return;let o=e;function r(l){const d=l/100*t,p=l*5,c=l*3;let m="Nenhuma",v="text-red-400";l>=7?(m="Alta",v="text-green-400"):l>=4?(m="Média",v="text-amber-400"):l>0&&(m="Baixa",v="text-orange-400"),i.innerHTML=`
      <div class="space-y-2">
    ...
    `,n.disabled=l===e,o=l}r(e),s.addEventListener("input",l=>{r(parseFloat(l.target.value))}),n.addEventListener("click",async()=>{n.disabled=!0,n.textContent="💾 Salvando...";try{await window.db.collection("paises").doc(a.id).update({CounterIntelligence:o,updatedAt:new Date().toISOString()}),alert(`✅ Contra-espionagem atualizada para ${o}%`),window.reloadCurrentCountry&&await window.reloadCurrentCountry()}catch(l){console.error("Erro ao salvar contra-espionagem:",l),alert("❌ Erro ao salvar: "+l.message)}n.disabled=!1,n.textContent="💾 Salvar Configuração"})}async function Q(a,t){const e=document.getElementById("pending-alerts-list"),s=document.getElementById("resolved-alerts-list"),i=document.getElementById("pending-count-badge"),n=document.getElementById("resolved-count-badge");if(!e||!s)return;e.innerHTML='<p class="text-sm text-slate-400">⏳ Carregando alertas...</p>',s.innerHTML='<p class="text-sm text-slate-400">⏳ Carregando...</p>';try{const r=await J.getAllCountryAlerts(a.id),l=r.filter(c=>c.status==="pending"),d=r.filter(c=>c.status==="resolved"||c.status==="investigated");i.textContent=l.length,n.textContent=d.length,l.length===0?e.innerHTML=`
      ...
      `:(e.innerHTML=l.map(c=>We(c,t,a)).join(""),Ze(a,t));const p=d.slice(0,5);p.length===0?s.innerHTML=`
      ...
      `:s.innerHTML=p.map(c=>Ye(c)).join("")}catch(r){console.error("Erro ao carregar alertas:",r),e.innerHTML='<p class="text-sm text-red-400">❌ Erro ao carregar alertas</p>'}const o=document.getElementById("refresh-alerts-btn");o&&o.addEventListener("click",()=>Q(a,t))}function We(a,t,e){const s=q[a.severity],i=J.calculateInvestigationCost(a,e);return`
  ...
  `}function Ye(a){const t=a.investigation||{},e=t.result;let s="✅",i="Investigação Concluída",n="green";e==="CRITICAL_FAILURE"?(s="💥",i="Falha Crítica",n="red"):e==="FAILURE"?(s="❌",i="Falha",n="red"):e==="PARTIAL"?(s="⚠️",i="Sucesso Parcial",n="amber"):e==="COMPLETE"&&(s="🎯",i="Sucesso Total",n="green");const o=a.revealed||{};return`
  ...
  `}function Ze(a,t){document.querySelectorAll(".investigate-btn").forEach(s=>{s.addEventListener("click",async i=>{const n=i.currentTarget.dataset.alertId,o=parseInt(i.currentTarget.dataset.cost);if(confirm(`Investigar esta ameaça custará ${g(o)}. Confirmar?`)){s.disabled=!0,s.textContent="⏳ Investigando...";try{const r=window.appState?.currentTurn||0,l=await J.investigateAlert(n,t,a,r);l.success?(Je(l),setTimeout(()=>{Q(a,t)},3e3)):(alert("Erro: "+l.error),s.disabled=!1,s.textContent=`🔍 Investigar - ${g(o)}`)}catch(r){console.error("Erro ao investigar:",r),alert("Erro ao processar investigação"),s.disabled=!1,s.textContent=`🔍 Investigar - ${g(o)}`}}})})}function Je(a){const{roll:t,result:e,cost:s}=a;let i=`
...
🚨 PAÍS IDENTIFICADO: ${e.revealed.spyCountry}`),alert(i)}async function Qe(){try{return(await window.db.collection("paises").get()).docs.map(t=>({id:t.id,...t.data()}))}catch(a){return console.error("Erro ao buscar países:",a),[]}}async function _(a,t){if(!t||!a)return;const e=await $.getAgency(a.id);if(!e){t.innerHTML=`
    ...
    `;const i=document.getElementById("open-agency-foundation");i&&i.addEventListener("click",()=>{Ne(()=>import("./agencyFoundationModal-pYOUhsHn.js"),__vite__mapDeps([0,1,2,3,4,5])).then(n=>{const o=window.appState?.currentTurn||0;n.default.show(a,o)})});return}const s=`
    <div class="space-y-6">
      <!-- Header da Agência -->
      <div class="p-6 rounded-2xl border border-slate-700 bg-slate-800/40">
  ...
  `;t.innerHTML=s,Xe(e),Ie(e,a),et(e,a),rt(e,a)}async function Xe(a){const t=await D.getAgencyOperations(a.id),e=document.getElementById("active-ops-count");e&&(e.textContent=t.length)}function et(a,t){const e=document.querySelectorAll(".agency-tab");e.forEach(s=>{s.addEventListener("click",i=>{const n=i.currentTarget.dataset.tab;e.forEach(o=>{o.classList.remove("border-brand-500","text-brand-400"),o.classList.add("border-transparent","text-slate-400")}),i.currentTarget.classList.add("border-brand-500","text-brand-400"),i.currentTarget.classList.remove("border-transparent","text-slate-400"),n==="research"?Ie(a,t):n==="operations"?Te(a,t):n==="security"&&st(a,t)})})}function Ie(a,t){const e=document.getElementById("agency-tab-content");if(!e)return;const s=a.currentResearch,i=k.getAvailableTechnologies(a.technologies||[],t);let n="";if(s&&s.techId){const o=k.getAllTechnologies()[s.techId];n=`
  ...
  `,s&&it(a,t),nt(a,t)}async function Te(a,t){const e=document.getElementById("agency-tab-content");if(e){e.innerHTML=`
  ...
  `;try{const s=await D.getAgencyOperations(a.id),i=await Qe(),n=i.filter(o=>o.id!==t.id);e.innerHTML=`
      <div class="space-y-6">
    ...
    `,at(a,t,n)}catch(s){console.error("Erro ao carregar operações:",s),e.innerHTML=`
      <div class="text-center py-12">
    ...
    `}}}function tt(a,t){const e=t.find(r=>r.id===a.targetCountryId),s=D.getPhases(),i=a.phase||1,n=s[i]?.name||"Fase Desconhecida",o=s[i]?.icon||"❓";return`
    <div class="p-4 rounded-xl border border-slate-700 bg-slate-800/50 hover:border-slate-600 transition">
      <div class="flex items-start justify-between mb-3">
        <div class="flex-1">
  ...
  `}function at(a,t,e){const s=document.getElementById("start-new-operation-btn"),i=document.getElementById("new-operation-modal"),n=document.getElementById("close-operation-modal"),o=document.getElementById("cancel-operation-btn"),r=document.getElementById("confirm-operation-btn"),l=document.getElementById("target-country-select"),d=document.getElementById("target-country-info");s?.addEventListener("click",()=>{i?.classList.remove("hidden")}),n?.addEventListener("click",()=>{i?.classList.add("hidden")}),o?.addEventListener("click",()=>{i?.classList.add("hidden")}),i?.addEventListener("click",p=>{p.target===i&&i.classList.add("hidden")}),l?.addEventListener("change",p=>{const c=p.target.value;if(c){const m=e.find(v=>v.id===c);m&&(d.classList.remove("hidden"),d.innerHTML=`
        ...
        `,r.disabled=!1)}else d.classList.add("hidden"),r.disabled=!0}),r?.addEventListener("click",async()=>{const p=l.value;if(p){r.disabled=!0,r.textContent="⏳ Iniciando...";try{const c=window.appState?.currentTurn||0,m=e.find(f=>f.id===p),v=await D.initiateOperation(a,m,t,4,c);v.success?(alert("Operação iniciada com sucesso!"),i.classList.add("hidden"),Te(a,t)):(alert("Erro: "+v.error),r.disabled=!1,r.textContent="Iniciar Infiltração")}catch(c){console.error("Erro ao iniciar operação:",c),alert("Erro ao processar operação"),r.disabled=!1,r.textContent="Iniciar Infiltração"}}})}function st(a,t){const e=document.getElementById("agency-tab-content");if(!e)return;e.innerHTML='<div id="security-alerts-container"></div>';const s=document.getElementById("security-alerts-container");s&&Ve(t,a,s)}function it(a,t){const e=document.getElementById("attempt-research-btn");e&&e.addEventListener("click",async()=>{e.disabled=!0,e.textContent="🎲 Rolando...";try{const s=window.appState?.currentTurn||0,i=await k.attemptResearch(a.id,t,s);i.success?(ot(i),setTimeout(()=>{const n=document.getElementById("agency-dashboard-container");n&&_(t,n)},2e3)):alert("Erro: "+i.error)}catch(s){console.error("Erro ao tentar pesquisa:",s),alert("Erro ao processar pesquisa")}e.disabled=!1,e.textContent="🎲 Tentar Pesquisa"})}function nt(a,t){document.querySelectorAll(".start-research-btn").forEach(s=>{s.addEventListener("click",async i=>{const n=i.currentTarget.dataset.techId;if(confirm("Iniciar pesquisa desta tecnologia?")){s.disabled=!0,s.textContent="Iniciando...";try{const o=window.appState?.currentTurn||0,r=await k.startResearch(a.id,n,t,o);if(r.success){if(alert(`Pesquisa iniciada: ${r.tech.name}
Custo: ${g(r.cost)}`),window.reloadCurrentCountry){const d=await window.reloadCurrentCountry();d&&(t=d)}const l=document.getElementById("intelligence-dashboard-container");l&&_(t,l)}else alert("Erro: "+r.error)}catch(o){console.error("Erro ao iniciar pesquisa:",o),alert("Erro ao processar")}s.disabled=!1,s.textContent="Pesquisar"}})})}function ot(a){const{roll:t,result:e,tech:s}=a;let i=`
🎲 Rolagem: ${t.baseRoll} + ${t.modifiers} = ${t.finalRoll}

${e.icon} ${e.message}
  `;e.unlocked&&(i+=`

✅ ${s.name} desbloqueada!`),alert(i)}function rt(a,t){const e=document.getElementById("budget-card");e&&e.addEventListener("click",()=>{lt(a,t)})}async function lt(a,t){const e=$.calculateBudget(t),s=a.budgetPercent,i=$.getTiers(),n=`
...
Novo orçamento: ${g(w)} (${b}%)`),f(),window.reloadCurrentCountry){const O=await window.reloadCurrentCountry();if(O){const F=document.getElementById("intelligence-dashboard-container");F&&_(O,F)}}}catch(E){console.error("Erro ao atualizar orçamento:",E),alert("Erro ao atualizar orçamento: "+E.message),m.disabled=!1,m.textContent="Confirmar Alteração"}})}const dt={renderAgencyDashboard:_},Nt=Object.freeze(Object.defineProperty({__proto__:null,default:dt,renderAgencyDashboard:_},Symbol.toStringTag,{value:"Module"}));function ct(a){return a?typeof a=="string"?a.length>10?`${a.slice(0,10)}…`:a:a.nome?a.nome:a.displayName?a.displayName:a.email?a.email.split("@")[0]:String(a.id||"Jogador"):"Jogador"}const u={countryListContainer:document.getElementById("lista-paises-publicos"),emptyState:document.getElementById("empty-state"),totalCountriesBadge:document.getElementById("total-paises-badge"),totalPlayers:document.getElementById("total-players"),pibMedio:document.getElementById("pib-medio"),estabilidadeMedia:document.getElementById("estabilidade-media"),paisesPublicos:document.getElementById("paises-publicos"),playerCountryName:document.getElementById("player-country-name"),playerCurrentTurn:document.getElementById("player-current-turn"),playerPib:document.getElementById("player-pib"),playerEstabilidade:document.getElementById("player-estabilidade"),playerCombustivel:document.getElementById("player-combustivel"),playerPibDelta:document.getElementById("player-pib-delta"),playerEstabilidadeDelta:document.getElementById("player-estabilidade-delta"),playerCombustivelDelta:document.getElementById("player-combustivel-delta"),playerHistorico:document.getElementById("player-historico"),playerNotifications:document.getElementById("player-notifications"),playerPanel:document.getElementById("player-panel"),userRoleBadge:document.getElementById("user-role-badge"),countryPanelModal:document.getElementById("country-panel-modal"),countryPanelContent:document.getElementById("country-panel-content"),closeCountryPanelBtn:document.getElementById("close-country-panel")};function ye(a,t,e){return Math.max(t,Math.min(e,a))}function $e(a){return a<=20?{label:"Anarquia",tone:"bg-rose-500/15 text-rose-300 border-rose-400/30"}:a<=49?{label:"Instável",tone:"bg-amber-500/15 text-amber-300 border-amber-400/30"}:a<=74?{label:"Neutro",tone:"bg-sky-500/15 text-sky-300 border-sky-400/30"}:{label:"Tranquilo",tone:"bg-emerald-500/15 text-emerald-300 border-emerald-400/30"}}function X(a){const t=(parseFloat(a.PIB)||0)/(parseFloat(a.Populacao)||1),e=ye(t,0,2e4)/200,s=Math.round(e*.45+(parseFloat(a.Tecnologia)||0)*.55);return ye(s,1,100)}function Pe(a){const t=parseFloat(a.PIB)||0,e=(parseFloat(a.Burocracia)||0)/100,s=(parseFloat(a.Estabilidade)||0)/100;return t*.25*e*s*1.5}function ee(a){const t=Pe(a),e=(parseFloat(a.MilitaryBudgetPercent)||30)/100;return t*e}function te(a){const t=(parseFloat(a.MilitaryDistributionVehicles)||40)/100,e=(parseFloat(a.MilitaryDistributionAircraft)||30)/100,s=(parseFloat(a.MilitaryDistributionNaval)||30)/100;return{vehicles:t,aircraft:e,naval:s,maintenancePercent:.15}}function ut(a){const t=ee(a),e=te(a);return t*e.vehicles}function pt(a){const t=ee(a),e=te(a);return t*e.aircraft}function mt(a){const t=ee(a),e=te(a);return t*e.naval}const gt={afeganistao:"AF",afghanistan:"AF","africa do sul":"ZA","south africa":"ZA",alemanha:"DE",germany:"DE",argentina:"AR",australia:"AU",austria:"AT",belgica:"BE",belgium:"BE",bolivia:"BO",brasil:"BR",brazil:"BR",canada:"CA",chile:"CL",china:"CN",colombia:"CO","coreia do sul":"KR","south korea":"KR","coreia do norte":"KP","north korea":"KP",cuba:"CU",dinamarca:"DK",denmark:"DK",egito:"EG",egypt:"EG",espanha:"ES",spain:"ES","estados unidos":"US",eua:"US",usa:"US","united states":"US",finlandia:"FI",franca:"FR",france:"FR",grecia:"GR",greece:"GR",holanda:"NL","paises baixos":"NL",netherlands:"NL",hungria:"HU",hungary:"HU",india:"IN",indonesia:"ID",ira:"IR",iran:"IR",iraque:"IQ",iraq:"IQ",irlanda:"IE",ireland:"IE",israel:"IL",italia:"IT",italy:"IT",japao:"JP",japan:"JP",malasia:"MY",malaysia:"MY",marrocos:"MA",morocco:"MA",mexico:"MX",nigeria:"NG",noruega:"NO",norway:"NO","nova zelandia":"NZ","new zealand":"NZ",peru:"PE",polonia:"PL",poland:"PL",portugal:"PT","reino unido":"GB",inglaterra:"GB",uk:"GB","united kingdom":"GB",russia:"RU",urss:"RU","uniao sovietica":"RU",singapura:"SG",singapore:"SG",suecia:"SE",sweden:"SE",suica:"CH",switzerland:"CH",turquia:"TR",turkey:"TR",ucrania:"UA",ukraine:"UA",uruguai:"UY",venezuela:"VE",vietna:"VN",vietnam:"VN",equador:"EC",paraguai:"PY",albania:"AL",argelia:"DZ",algeria:"DZ",andorra:"AD",angola:"AO","antigua e barbuda":"AG","antigua and barbuda":"AG",armenia:"AM",azerbaijao:"AZ",azerbaijan:"AZ",bahamas:"BS",bahrein:"BH",bahrain:"BH",bangladesh:"BD",barbados:"BB",belarus:"BY",bielorrússia:"BY",belize:"BZ",benin:"BJ",butao:"BT",bhutan:"BT","bosnia e herzegovina":"BA","bosnia and herzegovina":"BA",botsuana:"BW",botswana:"BW",brunei:"BN",bulgaria:"BG","burkina faso":"BF",burundi:"BI",camboja:"KH",cambodia:"KH",camarões:"CM",cameroon:"CM","cabo verde":"CV","cape verde":"CV","republica centro-africana":"CF","central african republic":"CF",chade:"TD",chad:"TD",comores:"KM",comoros:"KM",congo:"CG","costa rica":"CR",croacia:"HR",croatia:"HR",chipre:"CY",cyprus:"CY","republica tcheca":"CZ","czech republic":"CZ",tchequia:"CZ","republica dominicana":"DO","dominican republic":"DO","timor-leste":"TL","east timor":"TL","el salvador":"SV","guine equatorial":"GQ","equatorial guinea":"GQ",eritreia:"ER",estonia:"EE",etiopia:"ET",ethiopia:"ET",fiji:"FJ",gabao:"GA",gabon:"GA",gambia:"GM",georgia:"GE",gana:"GH",ghana:"GH",guatemala:"GT",guine:"GN",guinea:"GN","guine-bissau":"GW","guinea-bissau":"GW",guiana:"GY",guyana:"GY",haiti:"HT",honduras:"HN",islandia:"IS",iceland:"IS",jamaica:"JM",jordania:"JO",jordan:"JO",cazaquistao:"KZ",kazakhstan:"KZ",quenia:"KE",kenya:"KE",kiribati:"KI",kuwait:"KW",quirguistao:"KG",kyrgyzstan:"KG",laos:"LA",letonia:"LV",latvia:"LV",libano:"LB",lebanon:"LB",lesoto:"LS",lesotho:"LS",liberia:"LR",libia:"LY",libya:"LY",liechtenstein:"LI",lituania:"LT",lithuania:"LT",luxemburgo:"LU",luxembourg:"LU",madagascar:"MG",malawi:"MW",maldivas:"MV",maldives:"MV",mali:"ML",malta:"MT","ilhas marshall":"MH","marshall islands":"MH",mauritania:"MR",mauricio:"MU",mauritius:"MU",micronesia:"FM",moldova:"MD",monaco:"MC",mongolia:"MN",montenegro:"ME",mocambique:"MZ",mozambique:"MZ",myanmar:"MM",birmania:"MM",namibia:"NA",nauru:"NR",nepal:"NP",nicaragua:"NI",niger:"NE","macedonia do norte":"MK","north macedonia":"MK",oma:"OM",oman:"OM",paquistao:"PK",pakistan:"PK",palau:"PW",panama:"PA","papua-nova guine":"PG","papua new guinea":"PG",filipinas:"PH",philippines:"PH",catar:"QA",qatar:"QA",romenia:"RO",romania:"RO",ruanda:"RW","sao cristovao e nevis":"KN","saint kitts and nevis":"KN","santa lucia":"LC","saint lucia":"LC","sao vicente e granadinas":"VC","saint vincent and the grenadines":"VC",samoa:"WS","san marino":"SM","sao tome e principe":"ST","sao tome and principe":"ST","arabia saudita":"SA","saudi arabia":"SA",senegal:"SN",servia:"RS",serbia:"RS",seicheles:"SC",seychelles:"SC","serra leoa":"SL","sierra leone":"SL",eslovaquia:"SK",slovakia:"SK",eslovenia:"SI",slovenia:"SI","ilhas salomao":"SB","solomon islands":"SB",somalia:"SO","sri lanka":"LK",sudao:"SD",sudan:"SD",suriname:"SR",siria:"SY",syria:"SY",tajiquistao:"TJ",tajikistan:"TJ",tanzania:"TZ",tailandia:"TH",thailand:"TH",togo:"TG",tonga:"TO","trinidad e tobago":"TT","trinidad and tobago":"TT",tunisia:"TN",turcomenistao:"TM",turkmenistan:"TM",tuvalu:"TV",uganda:"UG","emirados arabes unidos":"AE","united arab emirates":"AE",uzbequistao:"UZ",uzbekistan:"UZ",vanuatu:"VU","cidade do vaticano":"VA","vatican city":"VA",vaticano:"VA",iemen:"YE",yemen:"YE",zambia:"ZM",zimbabue:"ZW",zimbabwe:"ZW"};function vt(a){if(!a)return null;const t=(a||"").toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}","gu"),"");return gt[t]||null}function bt(a){return(a||"").toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}","gu"),"").replace(/[^\w\s]/g,"").replace(/\s+/g," ").trim()}const W={"africa equatorial francesa":"assets/flags/historical/África Equatorial Francesa_.png","africa ocidental francesa":"assets/flags/historical/África Ocidental Francesa.gif","africa portuguesa":"assets/flags/historical/África Portuguesa.png","alemanha ocidental":"assets/flags/historical/Alemanha Ocidental_.png","alemanha oriental":"assets/flags/historical/Alemanha Oriental.png",andorra:"assets/flags/historical/Andorra.png",bulgaria:"assets/flags/historical/Flag_of_Bulgaria_(1948–1967).svg.png",canada:"assets/flags/historical/Flag_of_Canada_(1921–1957).svg.png",espanha:"assets/flags/historical/Flag_of_Spain_(1945–1977).svg.png",grecia:"assets/flags/historical/State_Flag_of_Greece_(1863-1924_and_1935-1973).svg.png",hungria:"assets/flags/historical/Flag_of_Hungary_(1949-1956).svg.png",iugoslavia:"assets/flags/historical/Flag_of_Yugoslavia_(1946-1992).svg.png",romenia:"assets/flags/historical/Flag_of_Romania_(1952–1965).svg.png","caribe britanico":"assets/flags/historical/Caribe Britânico.png",congo:"assets/flags/historical/Flag_of_the_Congo_Free_State.svg.png","costa do ouro":"assets/flags/historical/Flag_of_the_Gold_Coast_(1877–1957).svg.png",egito:"assets/flags/historical/Flag_of_Egypt_(1952–1958).svg.png",etiopia:"assets/flags/historical/Flag_of_Ethiopia_(1897–1974).svg.png",ira:"assets/flags/historical/State_flag_of_the_Imperial_State_of_Iran_(with_standardized_lion_and_sun).svg.png",iran:"assets/flags/historical/State_flag_of_the_Imperial_State_of_Iran_(with_standardized_lion_and_sun).svg.png",iraque:"assets/flags/historical/Flag_of_Iraq_(1924–1959).svg.png",quenia:"assets/flags/historical/Flag_of_Kenya_(1921–1963).svg.png",kenya:"assets/flags/historical/Flag_of_Kenya_(1921–1963).svg.png","rodesia do sul":"assets/flags/historical/Flag_of_Southern_Rhodesia_(1924–1964).svg.png",siria:"assets/flags/historical/Flag_of_the_United_Arab_Republic_(1958–1971),_Flag_of_Syria_(1980–2024).svg.png",syria:"assets/flags/historical/Flag_of_the_United_Arab_Republic_(1958–1971),_Flag_of_Syria_(1980–2024).svg.png","uniao sovietica":"assets/flags/historical/Flag_of_the_Soviet_Union_(1936_–_1955).svg.png",urss:"assets/flags/historical/Flag_of_the_Soviet_Union_(1936_–_1955).svg.png",russia:"assets/flags/historical/Flag_of_the_Soviet_Union_(1936_–_1955).svg.png"};function xt(a){if(!a)return null;const t=bt(a);if(W[t])return W[t];for(const[e,s]of Object.entries(W))if(t.includes(e)||e.includes(t))return s;return null}function N(a,t="h-full w-full"){if(!a)return'<span class="text-slate-400 text-xs">🏴</span>';const e=xt(a);if(e)return`<img src="${e}" alt="Bandeira de ${a}" class="${t} object-contain" loading="lazy">`;const s=vt(a);return s?`<img src="${`assets/flags/countries/${s.toLowerCase()}.png`}" alt="Bandeira de ${a}" class="${t} object-contain" loading="lazy">`:(Be.add(String(a||"").trim()),'<span class="text-slate-400 text-xs">🏴</span>')}const Be=new Set;window.getMissingFlagCountries||(window.getMissingFlagCountries=()=>Array.from(Be).sort());function ft(a){if(!u.countryListContainer)return;u.countryListContainer.innerHTML="";const t=a.filter(e=>e.Pais&&e.PIB&&e.Populacao&&e.Estabilidade&&e.Urbanizacao&&e.Tecnologia);if(u.totalCountriesBadge&&(u.totalCountriesBadge.textContent=`${t.length} países`),t.length===0){u.countryListContainer.innerHTML='<div class="col-span-full text-center py-12"><div class="text-slate-400 mb-2">Nenhum país para exibir.</div></div>';return}t.forEach(e=>{const s=e.PIB??e.geral?.PIB??0,i=e.geral?.Populacao??e.Populacao??0,n=e.geral?.Estabilidade??e.Estabilidade??0,o=e.geral?.Tecnologia??e.Tecnologia??0,r=e.geral?.Urbanizacao??e.Urbanizacao??0,l=g(s),d=Number(i).toLocaleString("pt-BR"),p=$e(parseFloat(n)),c={...e,PIB:s,Populacao:i,Tecnologia:o},m=X(c),v=N(e.Pais),f=`
        ...
        <div class="flex items-center justify-between gap-3">
          <div class="flex items-center gap-2">
            ...
            <div class="min-w-0">
              ...
              ${e.Player?`<div class="text-[10px] text-emerald-400 truncate">Jogador: ${e.PlayerName||ct(e.Player)}</div>`:""}
            </div>
          </div>
      ...
      </button>`;u.countryListContainer.innerHTML+=f})}async function ht(a){const t=window.appState?.playerCountry,e=window.appState?.currentTurn||0,s=window.appState?.userPermissions||{};if(t&&a.id===t.id)return{level:"owner",bypass:!0};if(s.isAdmin||s.isNarrator)return{level:"total",bypass:!0,reason:"admin"};if(t){const n=await y.hasActiveSpying(t.id,a.id,e);if(n)return{level:n.level,bypass:!1,espionage:n}}return{level:"none",bypass:!1}}function Ce(a,t){const e=t.level;return e==="owner"||e==="total"||["nome","bandeira","populacao","pib","pibPerCapita","modeloPolitico","wpi"].includes(a)?!0:e==="basic"?["orcamento","recursos","bensConsumo"].includes(a):e==="intermediate"?["orcamento","recursos","bensConsumo","tecnologia","estabilidade","urbanizacao","capacidadesProducao"].includes(a):!1}async function yt(a){if(!u.countryPanelContent||!u.countryPanelModal)return;const t=await ht(a),e=a.PIB??a.geral?.PIB??0,s=a.geral?.Populacao??a.Populacao??0,i=a.geral?.Estabilidade??a.Estabilidade??0,n=a.geral?.Tecnologia??a.Tecnologia??0,o=a.geral?.Urbanizacao??a.Urbanizacao??0,r={...a,PIB:e,Populacao:s,Tecnologia:n},l=X(r),d=Pe({PIB:e,Burocracia:a.Burocracia,Estabilidade:i}),p=ut({PIB:e,Veiculos:a.Veiculos}),c=pt({PIB:e,Aeronautica:a.Aeronautica}),m=mt({PIB:e,Marinha:a.Marinha}),v=$e(parseFloat(i)),f=g(e),b=Number(s).toLocaleString("pt-BR"),w=g(a.PIBPerCapita||e/s),C=Math.max(0,Math.min(100,parseFloat(o))),E=`<span class="inline-grid h-8 w-12 place-items-center rounded-md ring-1 ring-white/10 bg-slate-800 overflow-hidden">${N(a.Pais)}</span>`;let S="";if(t.bypass&&t.reason==="admin")S=`
    ...
    <div class="space-y-4">
      ...
      <div class="flex items-start justify-between gap-3">
        <div>
          <h2 class="text-2xl font-extrabold tracking-tight flex items-center gap-2">${E} ${a.Pais}</h2>
    ...
    <div class="rounded-2xl border border-white/10 bg-slate-900/30 p-4">
      ...
      <div class="mt-4 space-y-2">
        ${[["Modelo Político",a.ModeloPolitico||"—"],["PIB total",f],["PIB per capita",w],["Orçamento Nacional",`<span class="text-emerald-400">${g(d)}</span>`],["Prod. Veículos/turno",`<span class="text-blue-400">${g(p)}</span>`],["Prod. Aeronaves/turno",`<span class="text-cyan-400">${g(c)}</span>`],["Prod. Navios/turno",`<span class="text-indigo-400">${g(m)}</span>`],["População",b],["War Power Index",`${l}/100`],["Burocracia",`${a.Burocracia||0}%`],["Combustível",`${a.Combustivel||0}`],["Último Turno",`#${a.TurnoUltimaAtualizacao||0}`]].map(([I,xe])=>`
  ...
  `;u.countryPanelContent.innerHTML=Me;const me=document.getElementById("btn-ver-recursos"),ge=document.getElementById("btn-ver-inventario"),P=document.getElementById("modal-recursos"),B=document.getElementById("modal-inventario"),ve=document.getElementById("close-modal-recursos"),be=document.getElementById("close-modal-inventario");me&&P&&me.addEventListener("click",()=>{P.classList.remove("hidden")}),ge&&B&&ge.addEventListener("click",()=>{B.classList.remove("hidden")}),ve&&P&&(ve.addEventListener("click",()=>{P.classList.add("hidden")}),P.addEventListener("click",I=>{I.target===P&&P.classList.add("hidden")})),be&&B&&(be.addEventListener("click",()=>{B.classList.add("hidden")}),B.addEventListener("click",I=>{I.target===B&&B.classList.add("hidden")}));const G=u.countryPanelModal;G.classList.remove("hidden"),requestAnimationFrame(()=>{G.classList.remove("opacity-0");const I=G.querySelector(".transform");I&&I.classList.remove("-translate-y-2")}),Ct(a)}async function Ct(a){const t=window.appState?.playerCountry,e=window.appState?.currentTurn||0;console.log("DEBUG: [setupEspionageSystem] País renderizado:",a),console.log("DEBUG: [setupEspionageSystem] País do jogador (appState):",t);const s=document.getElementById("espionage-button-container"),i=document.getElementById("counter-intel-container"),n=document.getElementById("agency-button-container");if(!(!s||!i)){if(t&&a.id===t.id){if(we(a,i),s.innerHTML="",n){n.innerHTML=`
      ...
      `;const o=document.getElementById("btn-open-agency");o&&o.addEventListener("click",()=>{wt(a)})}return}if(t&&a.id!==t.id){const o=await y.hasActiveSpying(t.id,a.id,e);if(o){const r=o.validUntilTurn-e;s.innerHTML=`
      ...
      `;const r=document.getElementById("btn-spy-country");r&&r.addEventListener("click",()=>{De.show(a,t,e)})}i.innerHTML=""}else s.innerHTML="",i.innerHTML="",n&&(n.innerHTML="")}}function wt(a){const t=document.createElement("div");t.id="agency-modal",t.className="fixed inset-0 z-[70] flex items-center justify-center bg-black/70 backdrop-blur-sm",t.innerHTML=`
  ...
  `,document.body.appendChild(t);const e=document.getElementById("close-agency-modal");e&&e.addEventListener("click",()=>{t.remove()}),t.addEventListener("click",i=>{i.target===t&&t.remove()});const s=document.getElementById("agency-dashboard-content");s&&_(a,s)}function Et(a,t){const{userRoleBadge:e}=u,s=document.querySelector('a[href="narrador.html"]');s&&(s.style.display=a||t?"block":"none"),e&&(t?(e.textContent="Admin",e.className="text-xs px-2 py-1 rounded-full bg-red-500/10 text-red-400 border border-red-500/20"):a?(e.textContent="Narrador",e.className="text-xs px-2 py-1 rounded-full bg-brand-500/10 text-brand-400 border border-brand-500/20"):(e.textContent="Jogador",e.className="text-xs px-2 py-1 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20"))}function It(a){const t=document.createElement("div");t.className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm";const e=`
    <div class="w-full max-w-2xl max-h-[80vh] rounded-2xl bg-bg-soft border border-bg-ring/70 p-6 overflow-hidden">
      ...
      <div class="max-h-96 overflow-y-auto space-y-2">
        ${a.map(s=>{const i=N(s.Pais,"h-6 w-9");return`
            <div class="pais-option rounded-xl border border-bg-ring/70 p-3 cursor-pointer" data-pais-id="${s.id}" data-pais-nome="${s.Pais}">
              <div class="flex items-center gap-3">
                ...
                <div class="text-right">
                  ...
                  <div class="text-sm font-bold text-slate-200">${X(s)}</div>
                </div>
              </div>
            </div>`}).join("")}
      </div>
    ...
    </div>`;return t.innerHTML=e,document.body.appendChild(t),t}function Tt(a){const t=a.filter(r=>r.Player),e=t.map(r=>parseFloat(String(r.PIB).replace(/[$.]+/g,"").replace(",","."))||0),s=t.map(r=>parseFloat(String(r.Estabilidade).replace(/%/g,""))||0),i=e.length>0?e.reduce((r,l)=>r+l,0)/e.length:0,n=s.length>0?s.reduce((r,l)=>r+l,0)/s.length:0,o=a.filter(r=>{const l=(r.Visibilidade||"").toString().trim().toLowerCase();return l==="público"||l==="publico"||l==="public"}).length;u.totalPlayers&&fe("total-players",t.length),u.pibMedio&&(u.pibMedio.textContent=g(i)),u.estabilidadeMedia&&(u.estabilidadeMedia.textContent=`${Math.round(n)}/100`),u.paisesPublicos&&fe("paises-publicos",o)}function $t(a,t){if(a&&u.playerPanel){u.playerCountryName&&(u.playerCountryName.textContent=a.Pais||"País do Jogador");const e=document.getElementById("player-flag-container");e&&(e.innerHTML=N(a.Pais,"h-full w-full")),u.playerCurrentTurn&&(u.playerCurrentTurn.textContent=`#${t}`);const s=(parseFloat(a.PIB)||0)/(parseFloat(a.Populacao)||1),i=document.getElementById("player-pib-per-capita");if(i&&(i.textContent=g(s)),u.playerPib){const d=a.PIB||0,p=Le(d);u.playerPib.textContent=p}const n=Number(a.Estabilidade)||0;u.playerEstabilidade&&(u.playerEstabilidade.textContent=`${n}/100`);const o=document.getElementById("player-estabilidade-bar");if(o&&(o.style.width=`${Math.max(0,Math.min(100,n))}%`,n>=75?o.className="h-1.5 rounded-full bg-emerald-400":n>=50?o.className="h-1.5 rounded-full bg-cyan-400":n>=25?o.className="h-1.5 rounded-full bg-yellow-400":o.className="h-1.5 rounded-full bg-red-400"),u.playerCombustivel){const d=Y.calculateCountryConsumption(a),p=Z.calculateCountryProduction(a),c=Math.round((p.Combustivel||0)-(d.Combustivel||0));u.playerCombustivel.textContent=c}if(u.playerCombustivelDelta){const d=Y.calculateCountryConsumption(a),p=Z.calculateCountryProduction(a),c=Math.round((p.Combustivel||0)-(d.Combustivel||0));u.playerCombustivelDelta.textContent=c>=0?`+${c}`:`${c}`}u.playerPibDelta&&(u.playerPibDelta.textContent="Sem histórico"),u.playerEstabilidadeDelta&&(u.playerEstabilidadeDelta.textContent="Sem histórico"),u.playerHistorico&&(u.playerHistorico.innerHTML=`
