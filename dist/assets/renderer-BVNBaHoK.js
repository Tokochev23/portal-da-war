const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/agencyFoundationModal-BgQfKVM6.js","assets/preload-helper-f85Crcwt.js","assets/espionageOperationsSystem-yA0URGjb.js","assets/firebase-BARDcBiw.js"])))=>i.map(i=>d[i]);
import{h as b,j as g,k as h,l as qe,m as Ce}from"./firebase-BARDcBiw.js";import{R as J}from"./resourceConsumptionCalculator-dQu245X_.js";import{R as Q}from"./resourceProductionCalculator-b8MxHWSv.js";import{C as Fe}from"./consumerGoodsCalculator-Bg6C08yH.js";import{query as L,collection as E,where as C,getDocs as R,addDoc as X,doc as k,updateDoc as ee,getDoc as Ie}from"https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";import{_ as ke}from"./preload-helper-f85Crcwt.js";import{i as $,I as De,e as j}from"./espionageOperationsSystem-yA0URGjb.js";const Z={basic:{name:"Básica",description:"Orçamento e recursos gerais",costMultiplier:1,successBaseChance:.7,icon:"🔍"},intermediate:{name:"Intermediária",description:"Recursos + tecnologias e capacidades",costMultiplier:2.5,successBaseChance:.5,icon:"🔬"},total:{name:"Total",description:"Acesso completo ao inventário militar",costMultiplier:5,successBaseChance:.3,icon:"🎯"}},je=5e4;class ze{constructor(){this.activeOperations=new Map,this.lastUpdate=null}async hasActiveSpying(t,e,a){try{const i=L(E(b,"espionageOperations"),C("spyCountryId","==",t),C("targetCountryId","==",e),C("active","==",!0)),n=await R(i);if(n.empty)return null;const o=n.docs[0].data();return o.id=n.docs[0].id,o.validUntilTurn<a?(await this.deactivateOperation(o.id),null):o}catch(i){return console.error("Erro ao verificar espionagem ativa:",i),null}}calculateOperationCost(t,e,a){const i=Z[t];if(!i)return 0;let n=je*i.costMultiplier*e;const r=.5+(parseFloat(a.WarPower)||50)/100;return Math.round(n*r)}calculateSuccessChance(t,e,a){const i=Z[t];if(!i)return 0;let n=i.successBaseChance;const o=(parseFloat(e.Tecnologia)||0)/100;n+=o*.2;const r=(parseFloat(a.CounterIntelligence)||0)/100;n-=r*3;const l=(parseFloat(a.Urbanizacao)||0)/100;return n-=l*.1,Math.max(.05,Math.min(.95,n))}async initiateOperation(t,e,a,i,n){try{if(await this.hasActiveSpying(t.id,e.id,n))return{success:!1,error:"Você já tem uma operação ativa neste país!"};const r=this.calculateOperationCost(a,i,e);if(this.calculateBudget(t)<r)return{success:!1,error:"Orçamento insuficiente para esta operação!"};const c=this.calculateSuccessChance(a,t,e),u=Math.random()<=c,v=(parseFloat(e.CounterIntelligence)||0)/100*.5,f=Math.random()<=v,x={spyCountryId:t.id,spyCountryName:t.Pais,targetCountryId:e.id,targetCountryName:e.Pais,level:a,startTurn:n,validUntilTurn:n+i,duration:i,investment:r,detected:f,succeeded:u,active:u,createdAt:new Date().toISOString()},I=await X(E(b,"espionageOperations"),x);return f&&await this.createDetectionNotification(e.id,t.Pais,u),{success:!0,operation:{...x,id:I.id},cost:r,succeeded:u,detected:f,successChance:Math.round(c*100)}}catch(o){return console.error("Erro ao iniciar operação de espionagem:",o),{success:!1,error:"Erro ao processar operação: "+o.message}}}async deactivateOperation(t){try{const e=k(b,"espionageOperations",t);return await ee(e,{active:!1,deactivatedAt:new Date().toISOString()}),!0}catch(e){return console.error("Erro ao desativar operação:",e),!1}}async getActiveOperations(t,e){try{const a=L(E(b,"espionageOperations"),C("spyCountryId","==",t),C("active","==",!0)),i=await R(a),n=[];for(const o of i.docs){const r=o.data();r.id=o.id,r.validUntilTurn>=e?n.push(r):await this.deactivateOperation(o.id)}return n}catch(a){return console.error("Erro ao buscar operações ativas:",a),[]}}async getSpyingAttempts(t){try{const e=L(E(b,"espionageOperations"),C("targetCountryId","==",t),C("detected","==",!0));return(await R(e)).docs.map(i=>({id:i.id,...i.data()}))}catch(e){return console.error("Erro ao buscar tentativas de espionagem:",e),[]}}async createDetectionNotification(t,e,a){try{const i={countryId:t,type:"espionage_detected",message:a?`⚠️ Espionagem detectada! ${e} conseguiu acessar informações classificadas.`:`🛡️ Tentativa de espionagem bloqueada! ${e} tentou acessar informações mas foi impedido.`,spyCountry:e,succeeded:a,read:!1,createdAt:new Date().toISOString()};await X(E(b,"notifications"),i)}catch(i){console.error("Erro ao criar notificação:",i)}}async updateCounterIntelligence(t,e){try{const a=Math.max(0,Math.min(10,parseFloat(e)||0)),i=k(b,"paises",t);return await ee(i,{CounterIntelligence:a}),{success:!0,newValue:a}}catch(a){return console.error("Erro ao atualizar contra-espionagem:",a),{success:!1,error:a.message}}}calculateBudget(t){const e=parseFloat(t.PIB)||0,a=(parseFloat(t.Burocracia)||0)/100,i=(parseFloat(t.Estabilidade)||0)/100;return e*.25*a*i*1.5}async cleanExpiredOperations(t){try{const e=L(E(b,"espionageOperations"),C("active","==",!0)),a=await R(e);let i=0;for(const n of a.docs)n.data().validUntilTurn<t&&(await this.deactivateOperation(n.id),i++);return console.log(`🧹 ${i} operações de espionagem expiradas foram limpas.`),i}catch(e){return console.error("Erro ao limpar operações expiradas:",e),0}}getLevels(){return Z}}const y=new ze;class He{constructor(){this.modal=null,this.targetCountry=null,this.spyCountry=null,this.currentTurn=0,this.selectedLevel="basic",this.selectedDuration=3,this.createModal()}createModal(){this.modal=document.createElement("div"),this.modal.id="espionage-modal",this.modal.className="hidden fixed inset-0 z-[70] flex items-center justify-center bg-black/70 backdrop-blur-sm",this.modal.innerHTML=`
  ...
  `;e.innerHTML=a,ae(s,t)}async function ae(s,t){const e=document.getElementById("pending-alerts-list"),a=document.getElementById("resolved-alerts-list"),i=document.getElementById("pending-count-badge"),n=document.getElementById("resolved-count-badge");if(!e||!a)return;e.innerHTML='<p class="text-sm text-slate-400">⏳ Carregando alertas...</p>',a.innerHTML='<p class="text-sm text-slate-400">⏳ Carregando...</p>';try{const r=await te.getAllCountryAlerts(s.id),l=r.filter(u=>u.status==="pending"),c=r.filter(u=>u.status==="resolved"||u.status==="investigated");i.textContent=l.length,n.textContent=c.length,l.length===0?e.innerHTML=`
      ...
      `:a.innerHTML=p.map(u=>Je(u)).join("")}catch(r){console.error("Erro ao carregar alertas:",r),e.innerHTML='<p class="text-sm text-red-400">❌ Erro ao carregar alertas</p>'}const o=document.getElementById("refresh-alerts-btn");o&&o.addEventListener("click",()=>ae(s,t))}function Ye(s,t,e){const a=F[s.severity],i=te.calculateInvestigationCost(s,e);return`
...
🚨 PAÍS IDENTIFICADO: ${e.revealed.spyCountry}`),alert(i)}async function et(){try{return(await window.db.collection("paises").get()).docs.map(t=>({id:t.id,...t.data()}))}catch(s){return console.error("Erro ao buscar países:",s),[]}}async function N(s,t){if(!t||!s)return;const e=await $.getAgency(s.id);if(!e){t.innerHTML=`
    ...
    `;const i=document.getElementById("open-agency-foundation");i&&i.addEventListener("click",()=>{ke(()=>import("./agencyFoundationModal-BgQfKVM6.js"),__vite__mapDeps([0,1,2,3])).then(n=>{const o=window.appState?.currentTurn||0;n.default.show(s,o)})});return}const a=`
    <div class="space-y-6">
      <!-- Header da Agência -->
  ...
  `;t.innerHTML=a,tt(e),Pe(e,s),at(e,s),dt(e,s)}async function tt(s){const t=await j.getAgencyOperations(s.id),e=document.getElementById("active-ops-count");e&&(e.textContent=t.length)}function at(s,t){const e=document.querySelectorAll(".agency-tab");e.forEach(a=>{a.addEventListener("click",i=>{const n=i.currentTarget.dataset.tab;e.forEach(o=>{o.classList.remove("border-brand-500","text-brand-400"),o.classList.add("border-transparent","text-slate-400")}),i.currentTarget.classList.add("border-brand-500","text-brand-400"),i.currentTarget.classList.remove("border-transparent","text-slate-400"),n==="research"?Pe(s,t):n==="operations"?Be(s,t):n==="security"&&nt(s,t)})})}function Pe(s,t){const e=document.getElementById("agency-tab-content");if(!e)return;const a=s.currentResearch,i=D.getAvailableTechnologies(s.technologies||[],t);let n="";if(a&&a.techId){const o=D.getAllTechnologies()[a.techId];n=`
  ...
  `,a&&ot(s,t),rt(s,t)}async function Be(s,t){const e=document.getElementById("agency-tab-content");if(e){e.innerHTML=`
  ...
  `;try{const a=await j.getAgencyOperations(s.id),i=await et(),n=i.filter(o=>o.id!==t.id);e.innerHTML=`
      <div class="space-y-6">
    ...
    `}}}function st(s,t){const e=t.find(r=>r.id===s.targetCountryId),a=j.getPhases(),i=s.phase||1,n=a[i]?.name||"Fase Desconhecida",o=a[i]?.icon||"❓";return`
    <div class="p-4 rounded-xl border border-slate-700 bg-slate-800/50 hover:border-slate-600 transition">
      <div class="flex items-start justify-between mb-3">
        <div class="flex-1">
...
✅ ${a.name} desbloqueada!`),alert(i)}function dt(s,t){const e=document.getElementById("budget-card");e&&e.addEventListener("click",()=>{ct(s,t)})}async function ct(s,t){const e=$.calculateBudget(t),a=s.budgetPercent,i=$.getTiers(),n=`
  ...
  `,o=document.createElement("div");o.innerHTML=n,document.body.appendChild(o);const r=document.getElementById("budget-change-modal"),l=document.getElementById("budget-slider"),c=document.getElementById("budget-preview"),p=document.getElementById("close-budget-modal"),u=document.getElementById("cancel-budget-btn"),m=document.getElementById("confirm-budget-btn");function v(x){const I=Math.round(e*(x/100)),P=$.calculateTier(x),T=i[P];c.innerHTML=`
      <div class="space-y-3">
        <div class="flex items-center justify-between">
...
Novo orçamento: ${g(I)} (${x}%)`),f(),window.reloadCurrentCountry){const B=await window.reloadCurrentCountry();if(B){const S=document.getElementById("intelligence-dashboard-container");S&&N(B,S)}}}catch(T){console.error("Erro ao atualizar orçamento:",T),alert("Erro ao atualizar orçamento: "+T.message),m.disabled=!1,m.textContent="Confirmar Alteração"}})}const ut={renderAgencyDashboard:N},Rt=Object.freeze(Object.defineProperty({__proto__:null,default:ut,renderAgencyDashboard:N},Symbol.toStringTag,{value:"Module"})),d={countryListContainer:document.getElementById("lista-paises-publicos"),emptyState:document.getElementById("empty-state"),totalCountriesBadge:document.getElementById("total-paises-badge"),totalPlayers:document.getElementById("total-players"),pibMedio:document.getElementById("pib-medio"),estabilidadeMedia:document.getElementById("estabilidade-media"),paisesPublicos:document.getElementById("paises-publicos"),playerCountryName:document.getElementById("player-country-name"),playerCurrentTurn:document.getElementById("player-current-turn"),playerPib:document.getElementById("player-pib"),playerEstabilidade:document.getElementById("player-estabilidade"),playerCombustivel:document.getElementById("player-combustivel"),playerPibDelta:document.getElementById("player-pib-delta"),playerEstabilidadeDelta:document.getElementById("player-estabilidade-delta"),playerCombustivelDelta:document.getElementById("player-combustivel-delta"),playerHistorico:document.getElementById("player-historico"),playerNotifications:document.getElementById("player-notifications"),playerPanel:document.getElementById("player-panel"),userRoleBadge:document.getElementById("user-role-badge"),countryPanelModal:document.getElementById("country-panel-modal"),countryPanelContent:document.getElementById("country-panel-content"),closeCountryPanelBtn:document.getElementById("close-country-panel")};function we(s,t,e){return Math.max(t,Math.min(e,s))}function Se(s){return s<=20?{label:"Anarquia",tone:"bg-rose-500/15 text-rose-300 border-rose-400/30"}:s<=49?{label:"Instável",tone:"bg-amber-500/15 text-amber-300 border-amber-400/30"}:s<=74?{label:"Neutro",tone:"bg-sky-500/15 text-sky-300 border-sky-400/30"}:{label:"Tranquilo",tone:"bg-emerald-500/15 text-emerald-300 border-emerald-400/30"}}function se(s){const t=(parseFloat(s.PIB)||0)/(parseFloat(s.Populacao)||1),e=we(t,0,2e4)/200,a=Math.round(e*.45+(parseFloat(s.Tecnologia)||0)*.55);return we(a,1,100)}function _e(s){const t=parseFloat(s.PIB)||0,e=(parseFloat(s.Burocracia)||0)/100,a=(parseFloat(s.Estabilidade)||0)/100;return t*.25*e*a*1.5}function ie(s){const t=_e(s),e=(parseFloat(s.MilitaryBudgetPercent)||30)/100;return t*e}function ne(s){const t=(parseFloat(s.MilitaryDistributionVehicles)||40)/100,e=(parseFloat(s.MilitaryDistributionAircraft)||30)/100,a=(parseFloat(s.MilitaryDistributionNaval)||30)/100;return{vehicles:t,aircraft:e,naval:a,maintenancePercent:.15}}function pt(s){const t=ie(s),e=ne(s);return t*e.vehicles}function mt(s){const t=ie(s),e=ne(s);return t*e.aircraft}function gt(s){const t=ie(s),e=ne(s);return t*e.naval}const vt={afeganistao:"AF",afghanistan:"AF","africa do sul":"ZA","south africa":"ZA",alemanha:"DE",germany:"DE",argentina:"AR",australia:"AU",austria:"AT",belgica:"BE",belgium:"BE",bolivia:"BO",brasil:"BR",brazil:"BR",canada:"CA",chile:"CL",china:"CN",colombia:"CO","coreia do sul":"KR","south korea":"KR","coreia do norte":"KP","north korea":"KP",cuba:"CU",dinamarca:"DK",denmark:"DK",egito:"EG",egypt:"EG",espanha:"ES",spain:"ES","estados unidos":"US",eua:"US",usa:"US","united states":"US",finlandia:"FI",franca:"FR",france:"FR",grecia:"GR",greece:"GR",holanda:"NL","paises baixos":"NL",netherlands:"NL",hungria:"HU",hungary:"HU",india:"IN",indonesia:"ID",ira:"IR",iran:"IR",iraque:"IQ",iraq:"IQ",irlanda:"IE",ireland:"IE",israel:"IL",italia:"IT",italy:"IT",japao:"JP",japan:"JP",malasia:"MY",malaysia:"MY",marrocos:"MA",morocco:"MA",mexico:"MX",nigeria:"NG",noruega:"NO",norway:"NO","nova zelandia":"NZ","new zealand":"NZ",peru:"PE",polonia:"PL",poland:"PL",portugal:"PT","reino unido":"GB",inglaterra:"GB",uk:"GB","united kingdom":"GB",russia:"RU",urss:"RU","uniao sovietica":"RU",singapura:"SG",singapore:"SG",suecia:"SE",sweden:"SE",suica:"CH",switzerland:"CH",turquia:"TR",turkey:"TR",ucrania:"UA",ukraine:"UA",uruguai:"UY",venezuela:"VE",vietna:"VN",vietnam:"VN",equador:"EC",paraguai:"PY",albania:"AL",argelia:"DZ",algeria:"DZ",andorra:"AD",angola:"AO","antigua e barbuda":"AG","antigua and barbuda":"AG",armenia:"AM",azerbaijao:"AZ",azerbaijan:"AZ",bahamas:"BS",bahrein:"BH",bahrain:"BH",bangladesh:"BD",barbados:"BB",belarus:"BY",bielorrússia:"BY",belize:"BZ",benin:"BJ",butao:"BT",bhutan:"BT","bosnia e herzegovina":"BA","bosnia and herzegovina":"BA",botsuana:"BW",botswana:"BW",brunei:"BN",bulgaria:"BG","burkina faso":"BF",burundi:"BI",camboja:"KH",cambodia:"KH",camarões:"CM",cameroon:"CM","cabo verde":"CV","cape verde":"CV","republica centro-africana":"CF","central african republic":"CF",chade:"TD",chad:"TD",comores:"KM",comoros:"KM",congo:"CG","costa rica":"CR",croacia:"HR",croatia:"HR",chipre:"CY",cyprus:"CY","republica tcheca":"CZ","czech republic":"CZ",tchequia:"CZ","republica dominicana":"DO","dominican republic":"DO","timor-leste":"TL","east timor":"TL","el salvador":"SV","guine equatorial":"GQ","equatorial guinea":"GQ",eritreia:"ER",estonia:"EE",etiopia:"ET",ethiopia:"ET",fiji:"FJ",gabao:"GA",gabon:"GA",gambia:"GM",georgia:"GE",gana:"GH",ghana:"GH",guatemala:"GT",guine:"GN",guinea:"GN","guine-bissau":"GW","guinea-bissau":"GW",guiana:"GY",guyana:"GY",haiti:"HT",honduras:"HN",islandia:"IS",iceland:"IS",jamaica:"JM",jordania:"JO",jordan:"JO",cazaquistao:"KZ",kazakhstan:"KZ",quenia:"KE",kenya:"KE",kiribati:"KI",kuwait:"KW",quirguistao:"KG",kyrgyzstan:"KG",laos:"LA",letonia:"LV",latvia:"LV",libano:"LB",lebanon:"LB",lesoto:"LS",lesotho:"LS",liberia:"LR",libia:"LY",libya:"LY",liechtenstein:"LI",lituania:"LT",lithuania:"LT",luxemburgo:"LU",luxembourg:"LU",madagascar:"MG",malawi:"MW",maldivas:"MV",maldives:"MV",mali:"ML",malta:"MT","ilhas marshall":"MH","marshall islands":"MH",mauritania:"MR",mauricio:"MU",mauritius:"MU",micronesia:"FM",moldova:"MD",monaco:"MC",mongolia:"MN",montenegro:"ME",mocambique:"MZ",mozambique:"MZ",myanmar:"MM",birmania:"MM",namibia:"NA",nauru:"NR",nepal:"NP",nicaragua:"NI",niger:"NE","macedonia do norte":"MK","north macedonia":"MK",oma:"OM",oman:"OM",paquistao:"PK",pakistan:"PK",palau:"PW",panama:"PA","papua-nova guine":"PG","papua new guinea":"PG",filipinas:"PH",philippines:"PH",catar:"QA",qatar:"QA",romenia:"RO",romania:"RO",ruanda:"RW","sao cristovao e nevis":"KN","saint kitts and nevis":"KN","santa lucia":"LC","saint lucia":"LC","sao vicente e granadinas":"VC","saint vincent and the grenadines":"VC",samoa:"WS","san marino":"SM","sao tome e principe":"ST","sao tome and principe":"ST","arabia saudita":"SA","saudi arabia":"SA",senegal:"SN",servia:"RS",serbia:"RS",seicheles:"SC",seychelles:"SC","serra leoa":"SL","sierra leone":"SL",eslovaquia:"SK",slovakia:"SK",eslovenia:"SI",slovenia:"SI","ilhas salomao":"SB","solomon islands":"SB",somalia:"SO","sri lanka":"LK",sudao:"SD",sudan:"SD",suriname:"SR",siria:"SY",syria:"SY",tajiquistao:"TJ",tajikistan:"TJ",tanzania:"TZ",tailandia:"TH",thailand:"TH",togo:"TG",tonga:"TO","trinidad e tobago":"TT","trinidad and tobago":"TT",tunisia:"TN",turcomenistao:"TM",turkmenistan:"TM",tuvalu:"TV",uganda:"UG","emirados arabes unidos":"AE","united arab emirates":"AE",uzbequistao:"UZ",uzbekistan:"UZ",vanuatu:"VU","cidade do vaticano":"VA","vatican city":"VA",vaticano:"VA",iemen:"YE",yemen:"YE",zambia:"ZM",zimbabue:"ZW",zimbabwe:"ZW"};function bt(s){if(!s)return null;const t=(s||"").toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}","gu"),"");return vt[t]||null}function xt(s){return(s||"").toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}","gu"),"").replace(/[^\w\s]/g,"").replace(/\s+/g," ").trim()}const Y={"africa equatorial francesa":"assets/flags/historical/África Equatorial Francesa_.png","africa ocidental francesa":"assets/flags/historical/África Ocidental Francesa.gif","africa portuguesa":"assets/flags/historical/África Portuguesa.png","alemanha ocidental":"assets/flags/historical/Alemanha Ocidental_.png","alemanha oriental":"assets/flags/historical/Alemanha Oriental.png",andorra:"assets/flags/historical/Andorra.png",bulgaria:"assets/flags/historical/Flag_of_Bulgaria_(1948–1967).svg.png",canada:"assets/flags/historical/Flag_of_Canada_(1921–1957).svg.png",espanha:"assets/flags/historical/Flag_of_Spain_(1945–1977).svg.png",grecia:"assets/flags/historical/State_Flag_of_Greece_(1863-1924_and_1935-1973).svg.png",hungria:"assets/flags/historical/Flag_of_Hungary_(1949-1956).svg.png",iugoslavia:"assets/flags/historical/Flag_of_Yugoslavia_(1946-1992).svg.png",romenia:"assets/flags/historical/Flag_of_Romania_(1952–1965).svg.png","caribe britanico":"assets/flags/historical/Caribe Britânico.png",congo:"assets/flags/historical/Flag_of_the_Congo_Free_State.svg.png","costa do ouro":"assets/flags/historical/Flag_of_the_Gold_Coast_(1877–1957).svg.png",egito:"assets/flags/historical/Flag_of_Egypt_(1952–1958).svg.png",etiopia:"assets/flags/historical/Flag_of_Ethiopia_(1897–1974).svg.png",ira:"assets/flags/historical/State_flag_of_the_Imperial_State_of_Iran_(with_standardized_lion_and_sun).svg.png",iran:"assets/flags/historical/State_flag_of_the_Imperial_State_of_Iran_(with_standardized_lion_and_sun).svg.png",iraque:"assets/flags/historical/Flag_of_Iraq_(1924–1959).svg.png",quenia:"assets/flags/historical/Flag_of_Kenya_(1921–1963).svg.png",kenya:"assets/flags/historical/Flag_of_Kenya_(1921–1963).svg.png","rodesia do sul":"assets/flags/historical/Flag_of_Southern_Rhodesia_(1924–1964).svg.png",siria:"assets/flags/historical/Flag_of_the_United_Arab_Republic_(1958–1971),_Flag_of_Syria_(1980–2024).svg.png",syria:"assets/flags/historical/Flag_of_the_United_Arab_Republic_(1958–1971),_Flag_of_Syria_(1980–2024).svg.png","uniao sovietica":"assets/flags/historical/Flag_of_the_Soviet_Union_(1936_–_1955).svg.png",urss:"assets/flags/historical/Flag_of_the_Soviet_Union_(1936_–_1955).svg.png",russia:"assets/flags/historical/Flag_of_the_Soviet_Union_(1936_–_1955).svg.png"};function ft(s){if(!s)return null;const t=xt(s);if(Y[t])return Y[t];for(const[e,a]of Object.entries(Y))if(t.includes(e)||e.includes(t))return a;return null}function q(s,t="h-full w-full"){if(!s)return'<span class="text-slate-400 text-xs">🏴</span>';const e=ft(s);if(e)return`<img src="${e}" alt="Bandeira de ${s}" class="${t} object-contain" loading="lazy">`;const a=bt(s);return a?`<img src="${`assets/flags/countries/${a.toLowerCase()}.png`}" alt="Bandeira de ${s}" class="${t} object-contain" loading="lazy">`:(Ae.add(String(s||"").trim()),'<span class="text-slate-400 text-xs">🏴</span>')}const Ae=new Set;window.getMissingFlagCountries||(window.getMissingFlagCountries=()=>Array.from(Ae).sort());function ht(s){if(!d.countryListContainer)return;d.countryListContainer.innerHTML="";const t=s.filter(e=>e.Pais&&e.PIB&&e.Populacao&&e.Estabilidade&&e.Urbanizacao&&e.Tecnologia);if(d.totalCountriesBadge&&(d.totalCountriesBadge.textContent=`${t.length} países`),t.length===0){d.countryListContainer.innerHTML='<div class="col-span-full text-center py-12"><div class="text-slate-400 mb-2">Nenhum país para exibir.</div></div>';return}t.forEach(e=>{const a=e.PIB??e.geral?.PIB??0,i=e.geral?.Populacao??e.Populacao??0,n=e.geral?.Estabilidade??e.Estabilidade??0,o=e.geral?.Tecnologia??e.Tecnologia??0,r=e.geral?.Urbanizacao??e.Urbanizacao??0,l=g(a),c=Number(i).toLocaleString("pt-BR"),p=Se(parseFloat(n)),u={...e,PIB:a,Populacao:i,Tecnologia:o},m=se(u),v=q(e.Pais),f=`
      ...
      </button>`;d.countryListContainer.innerHTML+=f})}function yt(s){if(!d.countryPanelContent||!d.countryPanelModal)return;const t=s.PIB??s.geral?.PIB??0,e=s.geral?.Populacao??s.Populacao??0,a=s.geral?.Estabilidade??s.Estabilidade??0,i=s.geral?.Tecnologia??s.Tecnologia??0,n=s.geral?.Urbanizacao??s.Urbanizacao??0,o={...s,PIB:t,Populacao:e,Tecnologia:i},r=se(o),l=_e({PIB:t,Burocracia:s.Burocracia,Estabilidade:a}),c=pt({PIB:t,Veiculos:s.Veiculos}),p=mt({PIB:t,Aeronautica:s.Aeronautica}),u=gt({PIB:t,Marinha:s.Marinha}),m=Se(parseFloat(a)),v=g(t),f=Number(e).toLocaleString("pt-BR"),x=g(s.PIBPerCapita||t/e),I=Math.max(0,Math.min(100,parseFloat(n))),T=`
    <div class="space-y-4">
      <div class="flex items-start justify-between gap-3">
        <div>
          <h2 class="text-2xl font-extrabold tracking-tight flex items-center gap-2">${`<span class="inline-grid h-8 w-12 place-items-center rounded-md ring-1 ring-white/10 bg-slate-800 overflow-hidden">${q(s.Pais)}</span>`} ${s.Pais}</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div class="rounded-xl border border-white/5 bg-slate-900/50 p-3">
          ...
          <div class="mt-1">
            ...
            <div class="mt-1 h-1.5 w-full rounded-full bg-slate-800 overflow-hidden">
              <div class="h-1.5 rounded-full bg-emerald-500" style="width:${I}%"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="mt-4 space-y-2">
        ${[["Modelo Político",s.ModeloPolitico||"—"],["PIB total",v],["PIB per capita",x],["Orçamento Nacional",`<span class="text-emerald-400">${g(l)}</span>`],["Prod. Veículos/turno",`<span class="text-blue-400">${g(c)}</span>`],["Prod. Aeronaves/turno",`<span class="text-cyan-400">${g(p)}</span>`],["Prod. Navios/turno",`<span class="text-indigo-400">${g(u)}</span>`],["População",f],["War Power Index",`${r}/100`],["Burocracia",`${s.Burocracia||0}%`],["Combustível",`${s.Combustivel||0}`],["Último Turno",`#${s.TurnoUltimaAtualizacao||0}`]].map(([_,Oe])=>`
          <div class="flex items-center justify-between rounded-xl border border-white/5 bg-slate-900/40 px-3 py-2 text-[13px]">
            ...
            <span class="font-medium text-slate-100">${Oe}</span>
          </div>`).join("")}
      </div>
    ...
    </div>`,B=J.calculateCountryConsumption(s),S=Q.calculateCountryProduction(s),Me=Fe.calculateConsumerGoods(s),oe=Math.round(S.Carvao||0),re=Math.round(B.Carvao||0),H=oe-re,le=Math.round(S.Combustivel||0),de=Math.round(B.Combustivel||0),U=le-de,ce=Math.round(S.Metais||0),ue=Math.round(B.Metais||0),V=ce-ue,pe=Math.round(S.Graos||0),me=Math.round(B.Graos||0),G=pe-me,ge=Math.round(S.Energia||0),ve=Math.round(B.Energia||0),K=ge-ve,be=Math.round(Me.percentage||0),Le=`
      ...
      <div class="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto m-4 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="border border-gray-500/30 bg-gray-500/10 rounded-xl p-4">
            ...
            <div class="text-3xl font-bold ${V>=0?"text-green-400":"text-red-400"}">${V>=0?"+":""}${h(V)}</div>
            <div class="text-xs text-slate-400 mt-1">saldo/turno</div>
            <div class="flex justify-between text-xs mt-2 pt-2 border-t border-gray-500/30">
              <span class="text-green-400">Prod: ${h(ce)}</span>
              <span class="text-red-400">Cons: ${h(ue)}</span>
            </div>
          </div>
          ...
          <div class="border border-amber-500/30 bg-amber-500/10 rounded-xl p-4">
            ...
            <div class="text-3xl font-bold ${G>=0?"text-green-400":"text-red-400"}">${G>=0?"+":""}${h(G)}</div>
            <div class="text-xs text-slate-400 mt-1">saldo/turno</div>
            <div class="flex justify-between text-xs mt-2 pt-2 border-t border-amber-500/30">
              <span class="text-green-400">Prod: ${h(pe)}</span>
              <span class="text-red-400">Cons: ${h(me)}</span>
            </div>
          </div>
          ...
          <div class="border border-yellow-500/30 bg-yellow-500/10 rounded-xl p-4">
            ...
            <div class="text-3xl font-bold ${K>=0?"text-green-400":"text-red-400"}">${K>=0?"+":""}${h(K)} MW</div>
            <div class="text-xs text-slate-400 mt-1">saldo/turno</div>
            <div class="flex justify-between text-xs mt-2 pt-2 border-t border-yellow-500/30">
              <span class="text-green-400">Prod: ${h(ge)} MW</span>
              <span class="text-red-400">Cons: ${h(ve)} MW</span>
            </div>
          </div>
          ...
          <div class="border border-blue-500/30 bg-blue-500/10 rounded-xl p-4">
            ...
            <div class="text-3xl font-bold text-blue-400">${be}%</div>
    ...
    ${Le}
    ${Re}
  `;d.countryPanelContent.innerHTML=Ne;const xe=document.getElementById("btn-ver-recursos"),fe=document.getElementById("btn-ver-inventario"),A=document.getElementById("modal-recursos"),M=document.getElementById("modal-inventario"),he=document.getElementById("close-modal-recursos"),ye=document.getElementById("close-modal-inventario");xe&&A&&xe.addEventListener("click",()=>{A.classList.remove("hidden")}),fe&&M&&fe.addEventListener("click",()=>{M.classList.remove("hidden")}),he&&A&&(he.addEventListener("click",()=>{A.classList.add("hidden")}),A.addEventListener("click",_=>{_.target===A&&A.classList.add("hidden")})),ye&&M&&(ye.addEventListener("click",()=>{M.classList.add("hidden")}),M.addEventListener("click",_=>{_.target===M&&M.classList.add("hidden")}));const W=d.countryPanelModal;W.classList.remove("hidden"),requestAnimationFrame(()=>{W.classList.remove("opacity-0");const _=W.querySelector(".transform");_&&_.classList.remove("-translate-y-2")}),Ct(s)}async function Ct(s){const t=window.appState?.playerCountry,e=window.appState?.currentTurn||0;console.log("DEBUG: [setupEspionageSystem] País renderizado:",s),console.log("DEBUG: [setupEspionageSystem] País do jogador (appState):",t);const a=document.getElementById("espionage-button-container"),i=document.getElementById("counter-intel-container"),n=document.getElementById("agency-button-container");if(!(!a||!i)){if(t&&s.id===t.id){if(Ee(s,i),a.innerHTML="",n){n.innerHTML=`
      ...
      `;const o=document.getElementById("btn-open-agency");o&&o.addEventListener("click",()=>{It(s)})}return}if(t&&s.id!==t.id){const o=await y.hasActiveSpying(t.id,s.id,e);if(o){const r=o.validUntilTurn-e;a.innerHTML=`
  ...
  `,document.body.appendChild(t);const e=document.getElementById("close-agency-modal");e&&e.addEventListener("click",()=>{t.remove()}),t.addEventListener("click",i=>{i.target===t&&t.remove()});const a=document.getElementById("agency-dashboard-content");a&&N(s,a)}function Tt(s,t){const{userRoleBadge:e}=d,a=document.querySelector('a[href="narrador.html"]');a&&(a.style.display=s||t?"block":"none"),e&&(t?(e.textContent="Admin",e.className="text-xs px-2 py-1 rounded-full bg-red-500/10 text-red-400 border border-red-500/20"):s?(e.textContent="Narrador",e.className="text-xs px-2 py-1 rounded-full bg-brand-500/10 text-brand-400 border border-brand-500/20"):(e.textContent="Jogador",e.className="text-xs px-2 py-1 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20"))}function wt(s){const t=document.createElement("div");t.className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm";const e=`
    <div class="w-full max-w-2xl max-h-[80vh] rounded-2xl bg-bg-soft border border-bg-ring/70 p-6 overflow-hidden">
      ...
      <div class="max-h-96 overflow-y-auto space-y-2">
        ${s.map(a=>{const i=q(a.Pais,"h-6 w-9");return`
            <div class="pais-option rounded-xl border border-bg-ring/70 p-3 cursor-pointer" data-pais-id="${a.id}" data-pais-nome="${a.Pais}">
              <div class="flex items-center gap-3">
                ...
                <div class="text-right">
                  ...
                  <div class="text-sm font-bold text-slate-200">${se(a)}</div>
                </div>
              </div>
            </div>`}).join("")}
      </div>
    ...
    </div>`;return t.innerHTML=e,document.body.appendChild(t),t}function Et(s){const t=s.filter(r=>r.Player),e=t.map(r=>parseFloat(String(r.PIB).replace(/[$.]+/g,"").replace(",","."))||0),a=t.map(r=>parseFloat(String(r.Estabilidade).replace(/%/g,""))||0),i=e.length>0?e.reduce((r,l)=>r+l,0)/e.length:0,n=a.length>0?a.reduce((r,l)=>r+l,0)/a.length:0,o=s.filter(r=>{const l=(r.Visibilidade||"").toString().trim().toLowerCase();return l==="público"||l==="publico"||l==="public"}).length;d.totalPlayers&&Ce("total-players",t.length),d.pibMedio&&(d.pibMedio.textContent=g(i)),d.estabilidadeMedia&&(d.estabilidadeMedia.textContent=`${Math.round(n)}/100`),d.paisesPublicos&&Ce("paises-publicos",o)}function $t(s,t){if(s&&d.playerPanel){d.playerCountryName&&(d.playerCountryName.textContent=s.Pais||"País do Jogador");const e=document.getElementById("player-flag-container");e&&(e.innerHTML=q(s.Pais,"h-full w-full")),d.playerCurrentTurn&&(d.playerCurrentTurn.textContent=`#${t}`);const a=(parseFloat(s.PIB)||0)/(parseFloat(s.Populacao)||1),i=document.getElementById("player-pib-per-capita");if(i&&(i.textContent=g(a)),d.playerPib){const c=s.PIB||0,p=qe(c);d.playerPib.textContent=p}const n=Number(s.Estabilidade)||0;d.playerEstabilidade&&(d.playerEstabilidade.textContent=`${n}/100`);const o=document.getElementById("player-estabilidade-bar");if(o&&(o.style.width=`${Math.max(0,Math.min(100,n))}%`,n>=75?o.className="h-1.5 rounded-full bg-emerald-400":n>=50?o.className="h-1.5 rounded-full bg-cyan-400":n>=25?o.className="h-1.5 rounded-full bg-yellow-400":o.className="h-1.5 rounded-full bg-red-400"),d.playerCombustivel){const c=J.calculateCountryConsumption(s),p=Q.calculateCountryProduction(s),u=Math.round((p.Combustivel||0)-(c.Combustivel||0));d.playerCombustivel.textContent=u}if(d.playerCombustivelDelta){const c=J.calculateCountryConsumption(s),p=Q.calculateCountryProduction(s),u=Math.round((p.Combustivel||0)-(c.Combustivel||0));d.playerCombustivelDelta.textContent=u>=0?`+${u}`:`${u}`}d.playerPibDelta&&(d.playerPibDelta.textContent="Sem histórico"),d.playerEstabilidadeDelta&&(d.playerEstabilidadeDelta.textContent="Sem histórico"),d.playerHistorico&&(d.playerHistorico.innerHTML=`
