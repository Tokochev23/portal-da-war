const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/agencyFoundationModal-CEqEM4vR.js","assets/preload-helper-f85Crcwt.js","assets/espionageOperationsSystem-C3ZeGfiF.js","assets/firebase-CFOznPL1.js"])))=>i.map(i=>d[i]);
import{h as b,j as g,k as Oe,l as ye}from"./firebase-CFOznPL1.js";import{R as Y}from"./resourceConsumptionCalculator-GQgKGRPk.js";import{R as J}from"./resourceProductionCalculator-DVNFCgNl.js";import{C as qe}from"./consumerGoodsCalculator-DhUsjQdL.js";import{query as M,collection as w,where as y,getDocs as L,addDoc as Q,doc as F,updateDoc as X,getDoc as Ce}from"https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";import{_ as Fe}from"./preload-helper-f85Crcwt.js";import{i as E,I as ke,e as D}from"./espionageOperationsSystem-C3ZeGfiF.js";const W={basic:{name:"Básica",description:"Orçamento e recursos gerais",costMultiplier:1,successBaseChance:.7,icon:"🔍"},intermediate:{name:"Intermediária",description:"Recursos + tecnologias e capacidades",costMultiplier:2.5,successBaseChance:.5,icon:"🔬"},total:{name:"Total",description:"Acesso completo ao inventário militar",costMultiplier:5,successBaseChance:.3,icon:"🎯"}},De=5e4;class je{constructor(){this.activeOperations=new Map,this.lastUpdate=null}async hasActiveSpying(t,e,a){try{const i=M(w(b,"espionageOperations"),y("spyCountryId","==",t),y("targetCountryId","==",e),y("active","==",!0)),n=await L(i);if(n.empty)return null;const r=n.docs[0].data();return r.id=n.docs[0].id,r.validUntilTurn<a?(await this.deactivateOperation(r.id),null):r}catch(i){return console.error("Erro ao verificar espionagem ativa:",i),null}}calculateOperationCost(t,e,a){const i=W[t];if(!i)return 0;let n=De*i.costMultiplier*e;const o=.5+(parseFloat(a.WarPower)||50)/100;return Math.round(n*o)}calculateSuccessChance(t,e,a){const i=W[t];if(!i)return 0;let n=i.successBaseChance;const r=(parseFloat(e.Tecnologia)||0)/100;n+=r*.2;const o=(parseFloat(a.CounterIntelligence)||0)/100;n-=o*3;const l=(parseFloat(a.Urbanizacao)||0)/100;return n-=l*.1,Math.max(.05,Math.min(.95,n))}async initiateOperation(t,e,a,i,n){try{if(await this.hasActiveSpying(t.id,e.id,n))return{success:!1,error:"Você já tem uma operação ativa neste país!"};const o=this.calculateOperationCost(a,i,e);if(this.calculateBudget(t)<o)return{success:!1,error:"Orçamento insuficiente para esta operação!"};const c=this.calculateSuccessChance(a,t,e),u=Math.random()<=c,v=(parseFloat(e.CounterIntelligence)||0)/100*.5,f=Math.random()<=v,x={spyCountryId:t.id,spyCountryName:t.Pais,targetCountryId:e.id,targetCountryName:e.Pais,level:a,startTurn:n,validUntilTurn:n+i,duration:i,investment:o,detected:f,succeeded:u,active:u,createdAt:new Date().toISOString()},C=await Q(w(b,"espionageOperations"),x);return f&&await this.createDetectionNotification(e.id,t.Pais,u),{success:!0,operation:{...x,id:C.id},cost:o,succeeded:u,detected:f,successChance:Math.round(c*100)}}catch(r){return console.error("Erro ao iniciar operação de espionagem:",r),{success:!1,error:"Erro ao processar operação: "+r.message}}}async deactivateOperation(t){try{const e=F(b,"espionageOperations",t);return await X(e,{active:!1,deactivatedAt:new Date().toISOString()}),!0}catch(e){return console.error("Erro ao desativar operação:",e),!1}}async getActiveOperations(t,e){try{const a=M(w(b,"espionageOperations"),y("spyCountryId","==",t),y("active","==",!0)),i=await L(a),n=[];for(const r of i.docs){const o=r.data();o.id=r.id,o.validUntilTurn>=e?n.push(o):await this.deactivateOperation(r.id)}return n}catch(a){return console.error("Erro ao buscar operações ativas:",a),[]}}async getSpyingAttempts(t){try{const e=M(w(b,"espionageOperations"),y("targetCountryId","==",t),y("detected","==",!0));return(await L(e)).docs.map(i=>({id:i.id,...i.data()}))}catch(e){return console.error("Erro ao buscar tentativas de espionagem:",e),[]}}async createDetectionNotification(t,e,a){try{const i={countryId:t,type:"espionage_detected",message:a?`⚠️ Espionagem detectada! ${e} conseguiu acessar informações classificadas.`:`🛡️ Tentativa de espionagem bloqueada! ${e} tentou acessar informações mas foi impedido.`,spyCountry:e,succeeded:a,read:!1,createdAt:new Date().toISOString()};await Q(w(b,"notifications"),i)}catch(i){console.error("Erro ao criar notificação:",i)}}async updateCounterIntelligence(t,e){try{const a=Math.max(0,Math.min(10,parseFloat(e)||0)),i=F(b,"paises",t);return await X(i,{CounterIntelligence:a}),{success:!0,newValue:a}}catch(a){return console.error("Erro ao atualizar contra-espionagem:",a),{success:!1,error:a.message}}}calculateBudget(t){const e=parseFloat(t.PIB)||0,a=(parseFloat(t.Burocracia)||0)/100,i=(parseFloat(t.Estabilidade)||0)/100;return e*.25*a*i*1.5}async cleanExpiredOperations(t){try{const e=M(w(b,"espionageOperations"),y("active","==",!0)),a=await L(e);let i=0;for(const n of a.docs)n.data().validUntilTurn<t&&(await this.deactivateOperation(n.id),i++);return console.log(`🧹 ${i} operações de espionagem expiradas foram limpas.`),i}catch(e){return console.error("Erro ao limpar operações expiradas:",e),0}}getLevels(){return W}}const h=new je;class ze{constructor(){this.modal=null,this.targetCountry=null,this.spyCountry=null,this.currentTurn=0,this.selectedLevel="basic",this.selectedDuration=3,this.createModal()}createModal(){this.modal=document.createElement("div"),this.modal.id="espionage-modal",this.modal.className="hidden fixed inset-0 z-[70] flex items-center justify-center bg-black/70 backdrop-blur-sm",this.modal.innerHTML=`
    ...
    `,document.body.appendChild(this.modal),this.attachEventListeners()}attachEventListeners(){const t=this.modal.querySelector("#close-espionage-modal"),e=this.modal.querySelector("#cancel-espionage");t.addEventListener("click",()=>this.hide()),e.addEventListener("click",()=>this.hide()),this.modal.addEventListener("click",r=>{r.target===this.modal&&this.hide()});const a=this.modal.querySelector("#espionage-duration"),i=this.modal.querySelector("#duration-display");a.addEventListener("input",r=>{this.selectedDuration=parseInt(r.target.value),i.textContent=`${this.selectedDuration} turno${this.selectedDuration>1?"s":""}`,this.updateCostAndChance()}),this.modal.querySelector("#confirm-espionage").addEventListener("click",()=>this.confirmOperation())}async show(t,e,a){this.targetCountry=t,this.spyCountry=e,this.currentTurn=a,this.modal.querySelector("#espionage-target-name").textContent=`Alvo: ${t.Pais}`,this.renderLevels();const i=h.calculateBudget(e);this.modal.querySelector("#available-budget").textContent=g(i),this.updateCostAndChance(),this.modal.classList.remove("hidden"),this.modal.querySelector("#operation-result").classList.add("hidden")}hide(){this.modal.classList.add("hidden")}renderLevels(){const t=this.modal.querySelector("#espionage-levels"),e=h.getLevels();t.innerHTML=Object.entries(e).map(([a,i])=>`
      <button
    ...
    `).join(""),t.querySelectorAll(".espionage-level-btn").forEach(a=>{a.addEventListener("click",i=>{this.selectedLevel=i.currentTarget.dataset.level,this.renderLevels(),this.updateCostAndChance()})})}updateCostAndChance(){if(!this.targetCountry||!this.spyCountry)return;const t=h.calculateOperationCost(this.selectedLevel,this.selectedDuration,this.targetCountry);this.modal.querySelector("#operation-cost").textContent=g(t);const e=h.calculateSuccessChance(this.selectedLevel,this.spyCountry,this.targetCountry),a=Math.round(e*100),i=this.modal.querySelector("#success-chance"),n=this.modal.querySelector("#chance-bar"),r=this.modal.querySelector("#chance-indicator");i.textContent=`${a}%`,n.style.width=`${a}%`,a>=70?(i.className="text-xl font-bold text-green-400",n.className="h-2 rounded-full bg-green-500 transition-all duration-300",r.textContent="Alta",r.className="text-xs px-2 py-0.5 rounded-full bg-green-500/20 text-green-400"):a>=40?(i.className="text-xl font-bold text-amber-400",n.className="h-2 rounded-full bg-amber-500 transition-all duration-300",r.textContent="Média",r.className="text-xs px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-400"):(i.className="text-xl font-bold text-red-400",n.className="h-2 rounded-full bg-red-500 transition-all duration-300",r.textContent="Baixa",r.className="text-xs px-2 py-0.5 rounded-full bg-red-500/20 text-red-400");const o=h.calculateBudget(this.spyCountry),l=this.modal.querySelector("#confirm-espionage");l.disabled=t>o}async confirmOperation(){const t=this.modal.querySelector("#confirm-espionage");t.disabled=!0,t.textContent="⏳ Processando...";const e=await h.initiateOperation(this.spyCountry,this.targetCountry,this.selectedLevel,this.selectedDuration,this.currentTurn);this.showResult(e),t.disabled=!1,t.textContent="🕵️ Iniciar Operação"}showResult(t){const e=this.modal.querySelector("#operation-result"),a=this.modal.querySelector("#result-icon"),i=this.modal.querySelector("#result-title"),n=this.modal.querySelector("#result-message");if(t.success&&t.succeeded){e.className="mt-4 p-4 rounded-xl bg-green-500/10 border border-green-500/30",a.textContent="✅",i.textContent="Operação Bem-Sucedida!",i.className="font-bold text-lg mb-1 text-green-400";let r=`Sua operação de espionagem contra ${this.targetCountry.Pais} foi bem-sucedida! Você terá acesso às informações confidenciais pelos próximos ${this.selectedDuration} turnos.`;t.detected&&(r+=" ⚠️ No entanto, sua operação foi detectada pelo sistema de contra-espionagem deles."),n.textContent=r,n.className="text-sm text-green-300"}else if(t.success&&!t.succeeded){e.className="mt-4 p-4 rounded-xl bg-red-500/10 border border-red-500/30",a.textContent="❌",i.textContent="Operação Falhou",i.className="font-bold text-lg mb-1 text-red-400";let r=`Sua tentativa de espionagem contra ${this.targetCountry.Pais} foi bloqueada. `;t.detected?r+="Pior ainda: sua operação foi detectada! Eles sabem que você tentou espiá-los.":r+="Felizmente, não foram detectados agentes seus na operação.",n.textContent=r,n.className="text-sm text-red-300"}else e.className="mt-4 p-4 rounded-xl bg-amber-500/10 border border-amber-500/30",a.textContent="⚠️",i.textContent="Erro",i.className="font-bold text-lg mb-1 text-amber-400",n.textContent=t.error||"Ocorreu um erro ao processar a operação.",n.className="text-sm text-amber-300";e.classList.remove("hidden"),t.success&&setTimeout(()=>{this.hide(),window.location.reload()},5e3)}}const He=new ze;function we(s,t){if(!s||!t)return;const e=parseFloat(s.CounterIntelligence)||0,i=h.calculateBudget(s)*(e/100);let n,r,o;e>=6?(n="Alta",r="green",o="🛡️"):e>=3?(n="Média",r="amber",o="🔒"):(n="Baixa",r="red",o="⚠️");const l=`
    <div class="mt-6 p-5 rounded-2xl border border-slate-700 bg-slate-800/40">
      ...
      <div class="flex items-center justify-between mb-4">
        ...
        <div class="text-right">
          ...
          <div class="flex items-center gap-1 text-${r}-400">
      ...
      <div class="mb-4 p-3 rounded-lg bg-slate-900/50 border border-slate-700">
        ...
        <ul class="space-y-1.5 text-xs text-slate-400">
          <li class="flex items-start gap-2">
            <span class="text-${r}-400 mt-0.5">●</span>
            <span>Reduz <strong class="text-${r}-400">${Math.round(e*30)}%</strong> a chance de espionagem bem-sucedida</span>
          </li>
          <li class="flex items-start gap-2">
            <span class="text-${r}-400 mt-0.5">●</span>
            <span>Chance de <strong class="text-${r}-400">${Math.round(e*5)}%</strong> de detectar tentativas de espionagem</span>
          </li>
          <li class="flex items-start gap-2">
            <span class="text-${r}-400 mt-0.5">●</span>
  ...
  `;t.innerHTML=l,Ue(s),Ee(s.id)}function Ue(s){const t=document.getElementById("counter-intel-slider"),e=document.getElementById("counter-intel-value"),a=document.getElementById("counter-intel-cost"),i=document.getElementById("save-counter-intel"),n=document.getElementById("refresh-attempts");!t||!e||!a||!i||(t.addEventListener("input",r=>{const o=parseFloat(r.target.value);e.textContent=`${o}%`;const c=h.calculateBudget(s)*(o/100);a.textContent=`${g(c)}/turno`}),i.addEventListener("click",async()=>{const r=parseFloat(t.value);i.disabled=!0,i.textContent="⏳ Salvando...";const o=await h.updateCounterIntelligence(s.id,r),l=document.getElementById("counter-intel-feedback"),c=document.getElementById("counter-intel-feedback-text");o.success?(l.className="mt-3 p-3 rounded-lg bg-green-500/10 border border-green-500/30",c.className="text-sm text-green-300",c.textContent=`✅ Configuração salva! Nível de contra-espionagem: ${o.newValue}%`,s.CounterIntelligence=o.newValue,setTimeout(()=>{const p=document.getElementById("counter-intel-container");p&&we(s,p)},2e3)):(l.className="mt-3 p-3 rounded-lg bg-red-500/10 border border-red-500/30",c.className="text-sm text-red-300",c.textContent=`❌ Erro ao salvar: ${o.error}`),l.classList.remove("hidden"),i.disabled=!1,i.textContent="💾 Salvar Configuração",setTimeout(()=>{l.classList.add("hidden")},5e3)}),n&&n.addEventListener("click",()=>{Ee(s.id)}))}async function Ee(s){const t=document.getElementById("detected-attempts-list");if(t){t.innerHTML='<p class="text-xs text-slate-400">⏳ Carregando...</p>';try{const e=await h.getSpyingAttempts(s);if(e.length===0){t.innerHTML=`
      ...
      `;return}e.sort((i,n)=>new Date(n.createdAt)-new Date(i.createdAt));const a=e.slice(0,5);t.innerHTML=a.map(i=>{const n=!i.succeeded,r=n?"🛡️":"⚠️",o=n?"BLOQUEADO":"SUCESSO",l=n?"green":"red",c=Math.max(0,i.startTurn);return`
  ...
  `;e.innerHTML=a,te(s,t)}async function te(s,t){const e=document.getElementById("pending-alerts-list"),a=document.getElementById("resolved-alerts-list"),i=document.getElementById("pending-count-badge"),n=document.getElementById("resolved-count-badge");if(!e||!a)return;e.innerHTML='<p class="text-sm text-slate-400">⏳ Carregando alertas...</p>',a.innerHTML='<p class="text-sm text-slate-400">⏳ Carregando...</p>';try{const o=await ee.getAllCountryAlerts(s.id),l=o.filter(u=>u.status==="pending"),c=o.filter(u=>u.status==="resolved"||u.status==="investigated");i.textContent=l.length,n.textContent=c.length,l.length===0?e.innerHTML=`
      ...
      `:(e.innerHTML=l.map(u=>Ze(u,t,s)).join(""),Je(s,t));const p=c.slice(0,5);p.length===0?a.innerHTML=`
      ...
      `:a.innerHTML=p.map(u=>Ye(u)).join("")}catch(o){console.error("Erro ao carregar alertas:",o),e.innerHTML='<p class="text-sm text-red-400">❌ Erro ao carregar alertas</p>'}const r=document.getElementById("refresh-alerts-btn");r&&r.addEventListener("click",()=>te(s,t))}function Ze(s,t,e){const a=q[s.severity],i=ee.calculateInvestigationCost(s,e);return`
  ...
  `}function Ye(s){const t=s.investigation||{},e=t.result;let a="✅",i="Investigação Concluída",n="green";e==="CRITICAL_FAILURE"?(a="💥",i="Falha Crítica",n="red"):e==="FAILURE"?(a="❌",i="Falha",n="red"):e==="PARTIAL"?(a="⚠️",i="Sucesso Parcial",n="amber"):e==="COMPLETE"&&(a="🎯",i="Sucesso Total",n="green");const r=s.revealed||{};return`
    <div class="p-4 rounded-xl border border-${n}-500/30 bg-${n}-500/10">
      ...
      ${r.level==="COMPLETE"?`
        <div class="mt-3 p-3 rounded-lg bg-slate-900/50 border border-slate-700">
          <p class="text-sm font-semibold text-red-300 mb-2">🚨 ${r.spyCountry} identificado!</p>
          <div class="space-y-1 text-xs text-slate-400">
            <p>• Operativos: ${r.operativesCount}</p>
            <p>• Fase: ${r.phase}</p>
            <p>• Iniciado: Turno #${r.startedTurn}</p>
          </div>
      ...
      `:r.level==="PARTIAL"?`
        <p class="text-xs text-amber-300 mt-2">${r.info}</p>
      `:`
        <p class="text-xs text-slate-400 mt-2">Investigação inconclusiva</p>
      `}
    </div>
  `}function Je(s,t){document.querySelectorAll(".investigate-btn").forEach(a=>{a.addEventListener("click",async i=>{const n=i.currentTarget.dataset.alertId,r=parseInt(i.currentTarget.dataset.cost);if(confirm(`Investigar esta ameaça custará ${g(r)}. Confirmar?`)){a.disabled=!0,a.textContent="⏳ Investigando...";try{const o=window.appState?.currentTurn||0,l=await ee.investigateAlert(n,t,s,o);l.success?(Qe(l),setTimeout(()=>{te(s,t)},3e3)):(alert("Erro: "+l.error),a.disabled=!1,a.textContent=`🔍 Investigar - ${g(r)}`)}catch(o){console.error("Erro ao investigar:",o),alert("Erro ao processar investigação"),a.disabled=!1,a.textContent=`🔍 Investigar - ${g(r)}`}}})})}function Qe(s){const{roll:t,result:e,cost:a}=s;let i=`
...
🚨 PAÍS IDENTIFICADO: ${e.revealed.spyCountry}`),alert(i)}async function Xe(){try{return(await window.db.collection("paises").get()).docs.map(t=>({id:t.id,...t.data()}))}catch(s){return console.error("Erro ao buscar países:",s),[]}}async function R(s,t){if(!t||!s)return;const e=await E.getAgency(s.id);if(!e){t.innerHTML=`
    ...
    `;const i=document.getElementById("open-agency-foundation");i&&i.addEventListener("click",()=>{Fe(()=>import("./agencyFoundationModal-CEqEM4vR.js"),__vite__mapDeps([0,1,2,3])).then(n=>{const r=window.appState?.currentTurn||0;n.default.show(s,r)})});return}const a=`
    <div class="space-y-6">
      <!-- Header da Agência -->
        ...
        <div class="flex items-start justify-between mb-4">
          ...
          <div class="text-right">
            <div class="flex items-center gap-2 mb-1">
              <span class="text-3xl">${E.getTiers()[e.tier].icon}</span>
  ...
  `;t.innerHTML=a,et(e),$e(e,s),tt(e,s),lt(e,s)}async function et(s){const t=await D.getAgencyOperations(s.id),e=document.getElementById("active-ops-count");e&&(e.textContent=t.length)}function tt(s,t){const e=document.querySelectorAll(".agency-tab");e.forEach(a=>{a.addEventListener("click",i=>{const n=i.currentTarget.dataset.tab;e.forEach(r=>{r.classList.remove("border-brand-500","text-brand-400"),r.classList.add("border-transparent","text-slate-400")}),i.currentTarget.classList.add("border-brand-500","text-brand-400"),i.currentTarget.classList.remove("border-transparent","text-slate-400"),n==="research"?$e(s,t):n==="operations"?Pe(s,t):n==="security"&&it(s,t)})})}function $e(s,t){const e=document.getElementById("agency-tab-content");if(!e)return;const a=s.currentResearch,i=k.getAvailableTechnologies(s.technologies||[],t);let n="";if(a&&a.techId){const r=k.getAllTechnologies()[a.techId];n=`
      <div class="p-4 rounded-xl border border-brand-500/30 bg-brand-500/10 mb-6">
        ...
        <div class="flex items-start justify-between">
          <div class="flex-1">
            <p class="text-lg font-bold text-slate-100">${r.name}</p>
            <p class="text-sm text-slate-400 mb-2">${r.description}</p>
      ...
      ${i.map(r=>`
        <div class="p-4 rounded-xl border border-slate-700 bg-slate-800/50 hover:border-slate-600 transition">
          <div class="flex items-start gap-3 mb-3">
            ...
            <div class="flex-1">
              <h6 class="font-semibold text-slate-100">${r.name}</h6>
              <p class="text-xs text-slate-400">${r.year} • ${r.category.toUpperCase()}</p>
            </div>
          </div>
          <p class="text-xs text-slate-400 mb-3">${r.description}</p>
          <div class="flex items-center justify-between">
            <span class="text-sm text-slate-500">Custo: ${g(E.calculateCostByPIB(r.baseCost,t))}</span>
            <button class="start-research-btn px-3 py-1.5 rounded-lg bg-brand-500/20 hover:bg-brand-500/30 text-brand-300 text-xs font-semibold transition" data-tech-id="${r.id}">
              Pesquisar
            </button>
          </div>
        </div>
  ...
  `,a&&nt(s,t),rt(s,t)}async function Pe(s,t){const e=document.getElementById("agency-tab-content");if(e){e.innerHTML=`
  ...
  `;try{const a=await D.getAgencyOperations(s.id),i=await Xe(),n=i.filter(r=>r.id!==t.id);e.innerHTML=`
      <div class="space-y-6">
            ...
            <div class="space-y-4">
              <div>
                ...
                <select id="target-country-select" class="w-full px-4 py-2 bg-slate-800 border border-slate-600 rounded-lg text-slate-100">
                  ...
                  ${n.map(r=>`
                    <option value="${r.id}">${r.Pais}</option>
                  `).join("")}
                </select>
              </div>
    ...
    `,st(s,t,n)}catch(a){console.error("Erro ao carregar operações:",a),e.innerHTML=`
      <div class="text-center py-12">
    ...
    `}}}function at(s,t){const e=t.find(o=>o.id===s.targetCountryId),a=D.getPhases(),i=s.phase||1,n=a[i]?.name||"Fase Desconhecida",r=a[i]?.icon||"❓";return`
    <div class="p-4 rounded-xl border border-slate-700 bg-slate-800/50 hover:border-slate-600 transition">
      <div class="flex items-start justify-between mb-3">
        <div class="flex-1">
  ...
  `}function st(s,t,e){const a=document.getElementById("start-new-operation-btn"),i=document.getElementById("new-operation-modal"),n=document.getElementById("close-operation-modal"),r=document.getElementById("cancel-operation-btn"),o=document.getElementById("confirm-operation-btn"),l=document.getElementById("target-country-select"),c=document.getElementById("target-country-info");a?.addEventListener("click",()=>{i?.classList.remove("hidden")}),n?.addEventListener("click",()=>{i?.classList.add("hidden")}),r?.addEventListener("click",()=>{i?.classList.add("hidden")}),i?.addEventListener("click",p=>{p.target===i&&i.classList.add("hidden")}),l?.addEventListener("change",p=>{const u=p.target.value;if(u){const m=e.find(v=>v.id===u);m&&(c.classList.remove("hidden"),c.innerHTML=`
        ...
        `,o.disabled=!1)}else c.classList.add("hidden"),o.disabled=!0}),o?.addEventListener("click",async()=>{const p=l.value;if(p){o.disabled=!0,o.textContent="⏳ Iniciando...";try{const u=window.appState?.currentTurn||0,m=e.find(f=>f.id===p),v=await D.initiateOperation(s,m,t,4,u);v.success?(alert("Operação iniciada com sucesso!"),i.classList.add("hidden"),Pe(s,t)):(alert("Erro: "+v.error),o.disabled=!1,o.textContent="Iniciar Infiltração")}catch(u){console.error("Erro ao iniciar operação:",u),alert("Erro ao processar operação"),o.disabled=!1,o.textContent="Iniciar Infiltração"}}})}function it(s,t){const e=document.getElementById("agency-tab-content");if(!e)return;e.innerHTML='<div id="security-alerts-container"></div>';const a=document.getElementById("security-alerts-container");a&&We(t,s,a)}function nt(s,t){const e=document.getElementById("attempt-research-btn");e&&e.addEventListener("click",async()=>{e.disabled=!0,e.textContent="🎲 Rolando...";try{const a=window.appState?.currentTurn||0,i=await k.attemptResearch(s.id,t,a);i.success?(ot(i),setTimeout(()=>{const n=document.getElementById("agency-dashboard-container");n&&R(t,n)},2e3)):alert("Erro: "+i.error)}catch(a){console.error("Erro ao tentar pesquisa:",a),alert("Erro ao processar pesquisa")}e.disabled=!1,e.textContent="🎲 Tentar Pesquisa"})}function rt(s,t){document.querySelectorAll(".start-research-btn").forEach(a=>{a.addEventListener("click",async i=>{const n=i.currentTarget.dataset.techId;if(confirm("Iniciar pesquisa desta tecnologia?")){a.disabled=!0,a.textContent="Iniciando...";try{const r=window.appState?.currentTurn||0,o=await k.startResearch(s.id,n,t,r);if(o.success){if(alert(`Pesquisa iniciada: ${o.tech.name}
Custo: ${g(o.cost)}`),window.reloadCurrentCountry){const c=await window.reloadCurrentCountry();c&&(t=c)}const l=document.getElementById("intelligence-dashboard-container");l&&R(t,l)}else alert("Erro: "+o.error)}catch(r){console.error("Erro ao iniciar pesquisa:",r),alert("Erro ao processar")}a.disabled=!1,a.textContent="Pesquisar"}})})}function ot(s){const{roll:t,result:e,tech:a}=s;let i=`
🎲 Rolagem: ${t.baseRoll} + ${t.modifiers} = ${t.finalRoll}

${e.icon} ${e.message}
  `;e.unlocked&&(i+=`

✅ ${a.name} desbloqueada!`),alert(i)}function lt(s,t){const e=document.getElementById("budget-card");e&&e.addEventListener("click",()=>{dt(s,t)})}async function dt(s,t){const e=E.calculateBudget(t),a=s.budgetPercent,i=E.getTiers(),n=`
  ...
  `,r=document.createElement("div");r.innerHTML=n,document.body.appendChild(r);const o=document.getElementById("budget-change-modal"),l=document.getElementById("budget-slider"),c=document.getElementById("budget-preview"),p=document.getElementById("close-budget-modal"),u=document.getElementById("cancel-budget-btn"),m=document.getElementById("confirm-budget-btn");function v(x){const C=Math.round(e*(x/100)),$=E.calculateTier(x),I=i[$];c.innerHTML=`
      <div class="space-y-3">
        <div class="flex items-center justify-between">
...
Novo orçamento: ${g(C)} (${x}%)`),f(),window.reloadCurrentCountry){const P=await window.reloadCurrentCountry();if(P){const B=document.getElementById("intelligence-dashboard-container");B&&R(P,B)}}}catch(I){console.error("Erro ao atualizar orçamento:",I),alert("Erro ao atualizar orçamento: "+I.message),m.disabled=!1,m.textContent="Confirmar Alteração"}})}const ct={renderAgencyDashboard:R},Lt=Object.freeze(Object.defineProperty({__proto__:null,default:ct,renderAgencyDashboard:R},Symbol.toStringTag,{value:"Module"})),d={countryListContainer:document.getElementById("lista-paises-publicos"),emptyState:document.getElementById("empty-state"),totalCountriesBadge:document.getElementById("total-paises-badge"),totalPlayers:document.getElementById("total-players"),pibMedio:document.getElementById("pib-medio"),estabilidadeMedia:document.getElementById("estabilidade-media"),paisesPublicos:document.getElementById("paises-publicos"),playerCountryName:document.getElementById("player-country-name"),playerCurrentTurn:document.getElementById("player-current-turn"),playerPib:document.getElementById("player-pib"),playerEstabilidade:document.getElementById("player-estabilidade"),playerCombustivel:document.getElementById("player-combustivel"),playerPibDelta:document.getElementById("player-pib-delta"),playerEstabilidadeDelta:document.getElementById("player-estabilidade-delta"),playerCombustivelDelta:document.getElementById("player-combustivel-delta"),playerHistorico:document.getElementById("player-historico"),playerNotifications:document.getElementById("player-notifications"),playerPanel:document.getElementById("player-panel"),userRoleBadge:document.getElementById("user-role-badge"),countryPanelModal:document.getElementById("country-panel-modal"),countryPanelContent:document.getElementById("country-panel-content"),closeCountryPanelBtn:document.getElementById("close-country-panel")};function Te(s,t,e){return Math.max(t,Math.min(e,s))}function Be(s){return s<=20?{label:"Anarquia",tone:"bg-rose-500/15 text-rose-300 border-rose-400/30"}:s<=49?{label:"Instável",tone:"bg-amber-500/15 text-amber-300 border-amber-400/30"}:s<=74?{label:"Neutro",tone:"bg-sky-500/15 text-sky-300 border-sky-400/30"}:{label:"Tranquilo",tone:"bg-emerald-500/15 text-emerald-300 border-emerald-400/30"}}function ae(s){const t=(parseFloat(s.PIB)||0)/(parseFloat(s.Populacao)||1),e=Te(t,0,2e4)/200,a=Math.round(e*.45+(parseFloat(s.Tecnologia)||0)*.55);return Te(a,1,100)}function Se(s){const t=parseFloat(s.PIB)||0,e=(parseFloat(s.Burocracia)||0)/100,a=(parseFloat(s.Estabilidade)||0)/100;return t*.25*e*a*1.5}function se(s){const t=Se(s),e=(parseFloat(s.MilitaryBudgetPercent)||30)/100;return t*e}function ie(s){const t=(parseFloat(s.MilitaryDistributionVehicles)||40)/100,e=(parseFloat(s.MilitaryDistributionAircraft)||30)/100,a=(parseFloat(s.MilitaryDistributionNaval)||30)/100;return{vehicles:t,aircraft:e,naval:a,maintenancePercent:.15}}function ut(s){const t=se(s),e=ie(s);return t*e.vehicles}function pt(s){const t=se(s),e=ie(s);return t*e.aircraft}function mt(s){const t=se(s),e=ie(s);return t*e.naval}const gt={afeganistao:"AF",afghanistan:"AF","africa do sul":"ZA","south africa":"ZA",alemanha:"DE",germany:"DE",argentina:"AR",australia:"AU",austria:"AT",belgica:"BE",belgium:"BE",bolivia:"BO",brasil:"BR",brazil:"BR",canada:"CA",chile:"CL",china:"CN",colombia:"CO","coreia do sul":"KR","south korea":"KR","coreia do norte":"KP","north korea":"KP",cuba:"CU",dinamarca:"DK",denmark:"DK",egito:"EG",egypt:"EG",espanha:"ES",spain:"ES","estados unidos":"US",eua:"US",usa:"US","united states":"US",finlandia:"FI",franca:"FR",france:"FR",grecia:"GR",greece:"GR",holanda:"NL","paises baixos":"NL",netherlands:"NL",hungria:"HU",hungary:"HU",india:"IN",indonesia:"ID",ira:"IR",iran:"IR",iraque:"IQ",iraq:"IQ",irlanda:"IE",ireland:"IE",israel:"IL",italia:"IT",italy:"IT",japao:"JP",japan:"JP",malasia:"MY",malaysia:"MY",marrocos:"MA",morocco:"MA",mexico:"MX",nigeria:"NG",noruega:"NO",norway:"NO","nova zelandia":"NZ","new zealand":"NZ",peru:"PE",polonia:"PL",poland:"PL",portugal:"PT","reino unido":"GB",inglaterra:"GB",uk:"GB","united kingdom":"GB",russia:"RU",urss:"RU","uniao sovietica":"RU",singapura:"SG",singapore:"SG",suecia:"SE",sweden:"SE",suica:"CH",switzerland:"CH",turquia:"TR",turkey:"TR",ucrania:"UA",ukraine:"UA",uruguai:"UY",venezuela:"VE",vietna:"VN",vietnam:"VN",equador:"EC",paraguai:"PY",albania:"AL",argelia:"DZ",algeria:"DZ",andorra:"AD",angola:"AO","antigua e barbuda":"AG","antigua and barbuda":"AG",armenia:"AM",azerbaijao:"AZ",azerbaijan:"AZ",bahamas:"BS",bahrein:"BH",bahrain:"BH",bangladesh:"BD",barbados:"BB",belarus:"BY",bielorrússia:"BY",belize:"BZ",benin:"BJ",butao:"BT",bhutan:"BT","bosnia e herzegovina":"BA","bosnia and herzegovina":"BA",botsuana:"BW",botswana:"BW",brunei:"BN",bulgaria:"BG","burkina faso":"BF",burundi:"BI",camboja:"KH",cambodia:"KH",camarões:"CM",cameroon:"CM","cabo verde":"CV","cape verde":"CV","republica centro-africana":"CF","central african republic":"CF",chade:"TD",chad:"TD",comores:"KM",comoros:"KM",congo:"CG","costa rica":"CR",croacia:"HR",croatia:"HR",chipre:"CY",cyprus:"CY","republica tcheca":"CZ","czech republic":"CZ",tchequia:"CZ","republica dominicana":"DO","dominican republic":"DO","timor-leste":"TL","east timor":"TL","el salvador":"SV","guine equatorial":"GQ","equatorial guinea":"GQ",eritreia:"ER",estonia:"EE",etiopia:"ET",ethiopia:"ET",fiji:"FJ",gabao:"GA",gabon:"GA",gambia:"GM",georgia:"GE",gana:"GH",ghana:"GH",guatemala:"GT",guine:"GN",guinea:"GN","guine-bissau":"GW","guinea-bissau":"GW",guiana:"GY",guyana:"GY",haiti:"HT",honduras:"HN",islandia:"IS",iceland:"IS",jamaica:"JM",jordania:"JO",jordan:"JO",cazaquistao:"KZ",kazakhstan:"KZ",quenia:"KE",kenya:"KE",kiribati:"KI",kuwait:"KW",quirguistao:"KG",kyrgyzstan:"KG",laos:"LA",letonia:"LV",latvia:"LV",libano:"LB",lebanon:"LB",lesoto:"LS",lesotho:"LS",liberia:"LR",libia:"LY",libya:"LY",liechtenstein:"LI",lituania:"LT",lithuania:"LT",luxemburgo:"LU",luxembourg:"LU",madagascar:"MG",malawi:"MW",maldivas:"MV",maldives:"MV",mali:"ML",malta:"MT","ilhas marshall":"MH","marshall islands":"MH",mauritania:"MR",mauricio:"MU",mauritius:"MU",micronesia:"FM",moldova:"MD",monaco:"MC",mongolia:"MN",montenegro:"ME",mocambique:"MZ",mozambique:"MZ",myanmar:"MM",birmania:"MM",namibia:"NA",nauru:"NR",nepal:"NP",nicaragua:"NI",niger:"NE","macedonia do norte":"MK","north macedonia":"MK",oma:"OM",oman:"OM",paquistao:"PK",pakistan:"PK",palau:"PW",panama:"PA","papua-nova guine":"PG","papua new guinea":"PG",filipinas:"PH",philippines:"PH",catar:"QA",qatar:"QA",romenia:"RO",romania:"RO",ruanda:"RW","sao cristovao e nevis":"KN","saint kitts and nevis":"KN","santa lucia":"LC","saint lucia":"LC","sao vicente e granadinas":"VC","saint vincent and the grenadines":"VC",samoa:"WS","san marino":"SM","sao tome e principe":"ST","sao tome and principe":"ST","arabia saudita":"SA","saudi arabia":"SA",senegal:"SN",servia:"RS",serbia:"RS",seicheles:"SC",seychelles:"SC","serra leoa":"SL","sierra leone":"SL",eslovaquia:"SK",slovakia:"SK",eslovenia:"SI",slovenia:"SI","ilhas salomao":"SB","solomon islands":"SB",somalia:"SO","sri lanka":"LK",sudao:"SD",sudan:"SD",suriname:"SR",siria:"SY",syria:"SY",tajiquistao:"TJ",tajikistan:"TJ",tanzania:"TZ",tailandia:"TH",thailand:"TH",togo:"TG",tonga:"TO","trinidad e tobago":"TT","trinidad and tobago":"TT",tunisia:"TN",turcomenistao:"TM",turkmenistan:"TM",tuvalu:"TV",uganda:"UG","emirados arabes unidos":"AE","united arab emirates":"AE",uzbequistao:"UZ",uzbekistan:"UZ",vanuatu:"VU","cidade do vaticano":"VA","vatican city":"VA",vaticano:"VA",iemen:"YE",yemen:"YE",zambia:"ZM",zimbabue:"ZW",zimbabwe:"ZW"};function vt(s){if(!s)return null;const t=(s||"").toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}","gu"),"");return gt[t]||null}function bt(s){return(s||"").toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}","gu"),"").replace(/[^\w\s]/g,"").replace(/\s+/g," ").trim()}const Z={"africa equatorial francesa":"assets/flags/historical/África Equatorial Francesa_.png","africa ocidental francesa":"assets/flags/historical/África Ocidental Francesa.gif","africa portuguesa":"assets/flags/historical/África Portuguesa.png","alemanha ocidental":"assets/flags/historical/Alemanha Ocidental_.png","alemanha oriental":"assets/flags/historical/Alemanha Oriental.png",andorra:"assets/flags/historical/Andorra.png",bulgaria:"assets/flags/historical/Flag_of_Bulgaria_(1948–1967).svg.png",canada:"assets/flags/historical/Flag_of_Canada_(1921–1957).svg.png",espanha:"assets/flags/historical/Flag_of_Spain_(1945–1977).svg.png",grecia:"assets/flags/historical/State_Flag_of_Greece_(1863-1924_and_1935-1973).svg.png",hungria:"assets/flags/historical/Flag_of_Hungary_(1949-1956).svg.png",iugoslavia:"assets/flags/historical/Flag_of_Yugoslavia_(1946-1992).svg.png",romenia:"assets/flags/historical/Flag_of_Romania_(1952–1965).svg.png","caribe britanico":"assets/flags/historical/Caribe Britânico.png",congo:"assets/flags/historical/Flag_of_the_Congo_Free_State.svg.png","costa do ouro":"assets/flags/historical/Flag_of_the_Gold_Coast_(1877–1957).svg.png",egito:"assets/flags/historical/Flag_of_Egypt_(1952–1958).svg.png",etiopia:"assets/flags/historical/Flag_of_Ethiopia_(1897–1974).svg.png",ira:"assets/flags/historical/State_flag_of_the_Imperial_State_of_Iran_(with_standardized_lion_and_sun).svg.png",iran:"assets/flags/historical/State_flag_of_the_Imperial_State_of_Iran_(with_standardized_lion_and_sun).svg.png",iraque:"assets/flags/historical/Flag_of_Iraq_(1924–1959).svg.png",quenia:"assets/flags/historical/Flag_of_Kenya_(1921–1963).svg.png",kenya:"assets/flags/historical/Flag_of_Kenya_(1921–1963).svg.png","rodesia do sul":"assets/flags/historical/Flag_of_Southern_Rhodesia_(1924–1964).svg.png",siria:"assets/flags/historical/Flag_of_the_United_Arab_Republic_(1958–1971),_Flag_of_Syria_(1980–2024).svg.png",syria:"assets/flags/historical/Flag_of_the_United_Arab_Republic_(1958–1971),_Flag_of_Syria_(1980–2024).svg.png","uniao sovietica":"assets/flags/historical/Flag_of_the_Soviet_Union_(1936_–_1955).svg.png",urss:"assets/flags/historical/Flag_of_the_Soviet_Union_(1936_–_1955).svg.png",russia:"assets/flags/historical/Flag_of_the_Soviet_Union_(1936_–_1955).svg.png"};function xt(s){if(!s)return null;const t=bt(s);if(Z[t])return Z[t];for(const[e,a]of Object.entries(Z))if(t.includes(e)||e.includes(t))return a;return null}function O(s,t="h-full w-full"){if(!s)return'<span class="text-slate-400 text-xs">🏴</span>';const e=xt(s);if(e)return`<img src="${e}" alt="Bandeira de ${s}" class="${t} object-contain" loading="lazy">`;const a=vt(s);return a?`<img src="${`assets/flags/countries/${a.toLowerCase()}.png`}" alt="Bandeira de ${s}" class="${t} object-contain" loading="lazy">`:(_e.add(String(s||"").trim()),'<span class="text-slate-400 text-xs">🏴</span>')}const _e=new Set;window.getMissingFlagCountries||(window.getMissingFlagCountries=()=>Array.from(_e).sort());function ft(s){if(!d.countryListContainer)return;d.countryListContainer.innerHTML="";const t=s.filter(e=>e.Pais&&e.PIB&&e.Populacao&&e.Estabilidade&&e.Urbanizacao&&e.Tecnologia);if(d.totalCountriesBadge&&(d.totalCountriesBadge.textContent=`${t.length} países`),t.length===0){d.countryListContainer.innerHTML='<div class="col-span-full text-center py-12"><div class="text-slate-400 mb-2">Nenhum país para exibir.</div></div>';return}t.forEach(e=>{const a=e.PIB??e.geral?.PIB??0,i=e.geral?.Populacao??e.Populacao??0,n=e.geral?.Estabilidade??e.Estabilidade??0,r=e.geral?.Tecnologia??e.Tecnologia??0,o=e.geral?.Urbanizacao??e.Urbanizacao??0,l=g(a),c=Number(i).toLocaleString("pt-BR"),p=Be(parseFloat(n)),u={...e,PIB:a,Populacao:i,Tecnologia:r},m=ae(u),v=O(e.Pais),f=`
      <button class="country-card-button group relative w-full rounded-2xl border border-slate-800/70 bg-slate-900/60 p-3 text-left shadow-[0_1px_0_0_rgba(255,255,255,0.03)_inset,0_6px_20px_-12px_rgba(0,0,0,0.6)] hover:border-slate-600/60 hover:bg-slate-900/70 transition-all" data-country-id="${e.id}">
        ...
        <div class="mt-2">
          <div class="flex items-center justify-between text-[11px] text-slate-400">
            ...
            <span class="text-slate-300">${Math.max(0,Math.min(100,o))}%</span>
          </div>
          <div class="mt-1 h-1.5 w-full rounded-full bg-slate-800 overflow-hidden">
            <div class="h-1.5 rounded-full bg-emerald-500" style="width: ${Math.max(0,Math.min(100,o))}%"></div>
          </div>
        </div>
      </button>`;d.countryListContainer.innerHTML+=f})}function ht(s){if(!d.countryPanelContent||!d.countryPanelModal)return;const t=s.PIB??s.geral?.PIB??0,e=s.geral?.Populacao??s.Populacao??0,a=s.geral?.Estabilidade??s.Estabilidade??0,i=s.geral?.Tecnologia??s.Tecnologia??0,n=s.geral?.Urbanizacao??s.Urbanizacao??0,r={...s,PIB:t,Populacao:e,Tecnologia:i},o=ae(r),l=Se({PIB:t,Burocracia:s.Burocracia,Estabilidade:a}),c=ut({PIB:t,Veiculos:s.Veiculos}),p=pt({PIB:t,Aeronautica:s.Aeronautica}),u=mt({PIB:t,Marinha:s.Marinha}),m=Be(parseFloat(a)),v=g(t),f=Number(e).toLocaleString("pt-BR"),x=g(s.PIBPerCapita||t/e),C=Math.max(0,Math.min(100,parseFloat(n))),I=`
    <div class="space-y-4">
      <div class="flex items-start justify-between gap-3">
        <div>
          <h2 class="text-2xl font-extrabold tracking-tight flex items-center gap-2">${`<span class="inline-grid h-8 w-12 place-items-center rounded-md ring-1 ring-white/10 bg-slate-800 overflow-hidden">${O(s.Pais)}</span>`} ${s.Pais}</h2>
          <div class="text-sm text-slate-400">PIB per capita <span class="font-semibold text-slate-200">${x}</span></div>
        </div>
        <div class="text-center">
          <div class="h-12 w-12 grid place-items-center rounded-full border border-white/10 bg-slate-900/60 text-sm font-bold">${o}</div>
    ...
    <div class="rounded-2xl border border-white/10 bg-slate-900/30 p-4">
      ...
      <div class="mt-4 space-y-2">
        ${[["Modelo Político",s.ModeloPolitico||"—"],["PIB total",v],["PIB per capita",x],["Orçamento Nacional",`<span class="text-emerald-400">${g(l)}</span>`],["Prod. Veículos/turno",`<span class="text-blue-400">${g(c)}</span>`],["Prod. Aeronaves/turno",`<span class="text-cyan-400">${g(p)}</span>`],["Prod. Navios/turno",`<span class="text-indigo-400">${g(u)}</span>`],["População",f],["War Power Index",`${o}/100`],["Burocracia",`${s.Burocracia||0}%`],["Combustível",`${s.Combustivel||0}`],["Último Turno",`#${s.TurnoUltimaAtualizacao||0}`]].map(([S,Ne])=>`
          <div class="flex items-center justify-between rounded-xl border border-white/5 bg-slate-900/40 px-3 py-2 text-[13px]">
            ...
            <span class="font-medium text-slate-100">${Ne}</span>
          </div>`).join("")}
      </div>
    ...
    </div>`,P=Y.calculateCountryConsumption(s),B=J.calculateCountryProduction(s),Ae=qe.calculateConsumerGoods(s),ne=Math.round(B.Carvao||0),re=Math.round(P.Carvao||0),z=ne-re,oe=Math.round(B.Combustivel||0),le=Math.round(P.Combustivel||0),H=oe-le,de=Math.round(B.Metais||0),ce=Math.round(P.Metais||0),U=de-ce,ue=Math.round(B.Graos||0),pe=Math.round(P.Graos||0),V=ue-pe,me=Math.round(B.Energia||0),ge=Math.round(P.Energia||0),G=me-ge,ve=Math.round(Ae.percentage||0),Me=`
      ...
      <div class="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto m-4 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="border border-orange-500/30 bg-orange-500/10 rounded-xl p-4">
            ...
            <div class="text-3xl font-bold ${H>=0?"text-green-400":"text-red-400"}">${H>=0?"+":""}${formatNumber(H)}</div>
            ...
            <div class="flex justify-between text-xs mt-2 pt-2 border-t border-orange-500/30">
              <span class="text-green-400">Prod: ${formatNumber(oe)}</span>
              <span class="text-red-400">Cons: ${formatNumber(le)}</span>
            </div>
          </div>
          ...
          <div class="border border-slate-500/30 bg-slate-500/10 rounded-xl p-4">
            ...
            <div class="text-3xl font-bold ${z>=0?"text-green-400":"text-red-400"}">${z>=0?"+":""}${formatNumber(z)}</div>
            <div class="text-xs text-slate-400 mt-1">saldo/turno</div>
            <div class="flex justify-between text-xs mt-2 pt-2 border-t border-slate-500/30">
              <span class="text-green-400">Prod: ${formatNumber(ne)}</span>
              <span class="text-red-400">Cons: ${formatNumber(re)}</span>
            </div>
          </div>
          ...
          <div class="border border-gray-500/30 bg-gray-500/10 rounded-xl p-4">
            ...
            <div class="text-3xl font-bold ${U>=0?"text-green-400":"text-red-400"}">${U>=0?"+":""}${formatNumber(U)}</div>
            <div class="text-xs text-slate-400 mt-1">saldo/turno</div>
            <div class="flex justify-between text-xs mt-2 pt-2 border-t border-gray-500/30">
              <span class="text-green-400">Prod: ${formatNumber(de)}</span>
              <span class="text-red-400">Cons: ${formatNumber(ce)}</span>
            </div>
          </div>
          ...
          <div class="border border-amber-500/30 bg-amber-500/10 rounded-xl p-4">
            ...
            <div class="text-3xl font-bold ${V>=0?"text-green-400":"text-red-400"}">${V>=0?"+":""}${formatNumber(V)}</div>
            <div class="text-xs text-slate-400 mt-1">saldo/turno</div>
            <div class="flex justify-between text-xs mt-2 pt-2 border-t border-amber-500/30">
              <span class="text-green-400">Prod: ${formatNumber(ue)}</span>
              <span class="text-red-400">Cons: ${formatNumber(pe)}</span>
            </div>
          </div>
          ...
          <div class="border border-yellow-500/30 bg-yellow-500/10 rounded-xl p-4">
            ...
            <div class="text-3xl font-bold ${G>=0?"text-green-400":"text-red-400"}">${G>=0?"+":""}${formatNumber(G)} MW</div>
            <div class="text-xs text-slate-400 mt-1">saldo/turno</div>
            <div class="flex justify-between text-xs mt-2 pt-2 border-t border-yellow-500/30">
              <span class="text-green-400">Prod: ${formatNumber(me)} MW</span>
              <span class="text-red-400">Cons: ${formatNumber(ge)} MW</span>
            </div>
          </div>
          ...
          <div class="border border-blue-500/30 bg-blue-500/10 rounded-xl p-4">
            ...
            <div class="text-3xl font-bold text-blue-400">${ve}%</div>
    ...
    ${Me}
    ${Le}
  `;d.countryPanelContent.innerHTML=Re;const be=document.getElementById("btn-ver-recursos"),xe=document.getElementById("btn-ver-inventario"),_=document.getElementById("modal-recursos"),A=document.getElementById("modal-inventario"),fe=document.getElementById("close-modal-recursos"),he=document.getElementById("close-modal-inventario");be&&_&&be.addEventListener("click",()=>{_.classList.remove("hidden")}),xe&&A&&xe.addEventListener("click",()=>{A.classList.remove("hidden")}),fe&&_&&(fe.addEventListener("click",()=>{_.classList.add("hidden")}),_.addEventListener("click",S=>{S.target===_&&_.classList.add("hidden")})),he&&A&&(he.addEventListener("click",()=>{A.classList.add("hidden")}),A.addEventListener("click",S=>{S.target===A&&A.classList.add("hidden")}));const K=d.countryPanelModal;K.classList.remove("hidden"),requestAnimationFrame(()=>{K.classList.remove("opacity-0");const S=K.querySelector(".transform");S&&S.classList.remove("-translate-y-2")}),yt(s)}async function yt(s){const t=window.appState?.playerCountry,e=window.appState?.currentTurn||0;console.log("DEBUG: [setupEspionageSystem] País renderizado:",s),console.log("DEBUG: [setupEspionageSystem] País do jogador (appState):",t);const a=document.getElementById("espionage-button-container"),i=document.getElementById("counter-intel-container"),n=document.getElementById("agency-button-container");if(!(!a||!i)){if(t&&s.id===t.id){if(we(s,i),a.innerHTML="",n){n.innerHTML=`
      ...
      `;const r=document.getElementById("btn-open-agency");r&&r.addEventListener("click",()=>{Ct(s)})}return}if(t&&s.id!==t.id){const r=await h.hasActiveSpying(t.id,s.id,e);if(r){const o=r.validUntilTurn-e;a.innerHTML=`
        <div class="rounded-xl border border-brand-500/30 bg-brand-500/10 p-3">
          ...
          <p class="text-xs text-brand-400">
            Nível: ${h.getLevels()[r.level]?.name||r.level}
          </p>
          <p class="text-xs text-brand-400">
            Válido por mais ${o} turno${o!==1?"s":""}
          </p>
        </div>
      `}else{a.innerHTML=`
  ...
  `,document.body.appendChild(t);const e=document.getElementById("close-agency-modal");e&&e.addEventListener("click",()=>{t.remove()}),t.addEventListener("click",i=>{i.target===t&&t.remove()});const a=document.getElementById("agency-dashboard-content");a&&R(s,a)}function It(s,t){const{userRoleBadge:e}=d,a=document.querySelector('a[href="narrador.html"]');a&&(a.style.display=s||t?"block":"none"),e&&(t?(e.textContent="Admin",e.className="text-xs px-2 py-1 rounded-full bg-red-500/10 text-red-400 border border-red-500/20"):s?(e.textContent="Narrador",e.className="text-xs px-2 py-1 rounded-full bg-brand-500/10 text-brand-400 border border-brand-500/20"):(e.textContent="Jogador",e.className="text-xs px-2 py-1 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20"))}function Tt(s){const t=document.createElement("div");t.className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm";const e=`
    <div class="w-full max-w-2xl max-h-[80vh] rounded-2xl bg-bg-soft border border-bg-ring/70 p-6 overflow-hidden">
      ...
      <div class="max-h-96 overflow-y-auto space-y-2">
        ${s.map(a=>{const i=O(a.Pais,"h-6 w-9");return`
            <div class="pais-option rounded-xl border border-bg-ring/70 p-3 cursor-pointer" data-pais-id="${a.id}" data-pais-nome="${a.Pais}">
              <div class="flex items-center gap-3">
                ...
                <div class="text-right">
                  ...
                  <div class="text-sm font-bold text-slate-200">${ae(a)}</div>
                </div>
              </div>
            </div>`}).join("")}
      </div>
    ...
    </div>`;return t.innerHTML=e,document.body.appendChild(t),t}function wt(s){const t=s.filter(o=>o.Player),e=t.map(o=>parseFloat(String(o.PIB).replace(/[$.]+/g,"").replace(",","."))||0),a=t.map(o=>parseFloat(String(o.Estabilidade).replace(/%/g,""))||0),i=e.length>0?e.reduce((o,l)=>o+l,0)/e.length:0,n=a.length>0?a.reduce((o,l)=>o+l,0)/a.length:0,r=s.filter(o=>{const l=(o.Visibilidade||"").toString().trim().toLowerCase();return l==="público"||l==="publico"||l==="public"}).length;d.totalPlayers&&ye("total-players",t.length),d.pibMedio&&(d.pibMedio.textContent=g(i)),d.estabilidadeMedia&&(d.estabilidadeMedia.textContent=`${Math.round(n)}/100`),d.paisesPublicos&&ye("paises-publicos",r)}function Et(s,t){if(s&&d.playerPanel){d.playerCountryName&&(d.playerCountryName.textContent=s.Pais||"País do Jogador");const e=document.getElementById("player-flag-container");e&&(e.innerHTML=O(s.Pais,"h-full w-full")),d.playerCurrentTurn&&(d.playerCurrentTurn.textContent=`#${t}`);const a=(parseFloat(s.PIB)||0)/(parseFloat(s.Populacao)||1),i=document.getElementById("player-pib-per-capita");if(i&&(i.textContent=g(a)),d.playerPib){const c=s.PIB||0,p=Oe(c);d.playerPib.textContent=p}const n=Number(s.Estabilidade)||0;d.playerEstabilidade&&(d.playerEstabilidade.textContent=`${n}/100`);const r=document.getElementById("player-estabilidade-bar");if(r&&(r.style.width=`${Math.max(0,Math.min(100,n))}%`,n>=75?r.className="h-1.5 rounded-full bg-emerald-400":n>=50?r.className="h-1.5 rounded-full bg-cyan-400":n>=25?r.className="h-1.5 rounded-full bg-yellow-400":r.className="h-1.5 rounded-full bg-red-400"),d.playerCombustivel){const c=Y.calculateCountryConsumption(s),p=J.calculateCountryProduction(s),u=Math.round((p.Combustivel||0)-(c.Combustivel||0));d.playerCombustivel.textContent=u}if(d.playerCombustivelDelta){const c=Y.calculateCountryConsumption(s),p=J.calculateCountryProduction(s),u=Math.round((p.Combustivel||0)-(c.Combustivel||0));d.playerCombustivelDelta.textContent=u>=0?`+${u}`:`${u}`}d.playerPibDelta&&(d.playerPibDelta.textContent="Sem histórico"),d.playerEstabilidadeDelta&&(d.playerEstabilidadeDelta.textContent="Sem histórico"),d.playerHistorico&&(d.playerHistorico.innerHTML=`
