const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/firebase-BDV7finj.js","assets/preload-helper-f85Crcwt.js","assets/utils-DLoRv3re.js","assets/renderer-CorLewFp.js","assets/resourceConsumptionCalculator-Bk-hb2mA.js","assets/resourceProductionCalculator-C5abBl5S.js","assets/consumerGoodsCalculator-RQh-OK8I.js","assets/shipyardSystem-B7HEfEsS.js","assets/espionageOperationsSystem-VZyzbeX4.js"])))=>i.map(i=>d[i]);
import{_ as _e}from"./preload-helper-f85Crcwt.js";/* empty css             */import{auth as x,checkPlayerCountry as w,db as g,app as Dt,getAllCountries as Ze}from"./firebase-BDV7finj.js";import{a as Lt,s as qe}from"./utils-DLoRv3re.js";import{E as At}from"./economicCalculations-BCE1cIKn.js";import{C as Pt}from"./consumerGoodsCalculator-RQh-OK8I.js";import{R as Xe}from"./resourceConsumptionCalculator-Bk-hb2mA.js";import{R as et}from"./resourceProductionCalculator-C5abBl5S.js";import{S as tt,B as A}from"./shipyardSystem-B7HEfEsS.js";import{g as Be,a as De,R as jt,b as Nt}from"./resourceMapping-BBQTZbLj.js";import{g as Le}from"./renderer-CorLewFp.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-app-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-auth-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-storage-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-functions-compat.js";import"./espionageOperationsSystem-VZyzbeX4.js";const Ot=()=>{};var Ae={};/**
 * @license
 ...
 */const at=function(t){const e=[];let a=0;for(let s=0;s<t.length;s++){let r=t.charCodeAt(s);r<128?e[a++]=r:r<2048?(e[a++]=r>>6|192,e[a++]=r&63|128):(r&64512)===55296&&s+1<t.length&&(t.charCodeAt(s+1)&64512)===56320?(r=65536+((r&1023)<<10)+(t.charCodeAt(++s)&1023),e[a++]=r>>18|240,e[a++]=r>>12&63|128,e[a++]=r>>6&63|128,e[a++]=r&63|128):(e[a++]=r>>12|224,e[a++]=r>>6&63|128,e[a++]=r&63|128)}return e},Ft=function(t){const e=[];let a=0,s=0;for(;a<t.length;){const r=t[a++];if(r<128)e[s++]=String.fromCharCode(r);else if(r>191&&r<224){const o=t[a++];e[s++]=String.fromCharCode((r&31)<<6|o&63)}else if(r>239&&r<365){const o=t[a++],n=t[a++],i=t[a++],l=((r&7)<<18|(o&63)<<12|(n&63)<<6|i&63)-65536;e[s++]=String.fromCharCode(55296+(l>>10)),e[s++]=String.fromCharCode(56320+(l&1023))}else{const o=t[a++],n=t[a++];e[s++]=String.fromCharCode((r&15)<<12|(o&63)<<6|n&63)}}return e.join("")},st={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(t,e){if(!Array.isArray(t))throw Error("encodeByteArray takes an array as a parameter");this.init_();const a=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,s=[];for(let r=0;r<t.length;r+=3){const o=t[r],n=r+1<t.length,i=n?t[r+1]:0,l=r+2<t.length,c=l?t[r+2]:0,u=o>>2,m=(o&3)<<4|i>>4;let d=(i&15)<<2|c>>6,p=c&63;l||(p=64,n||(d=64)),s.push(a[u],a[m],a[d],a[p])}return s.join("")},encodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(t):this.encodeByteArray(at(t),e)},decodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(t):Ft(this.decodeStringToByteArray(t,e))},decodeStringToByteArray(t,e){this.init_();const a=e?this.charToByteMapWebSafe_:this.charToByteMap_,s=[];for(let r=0;r<t.length;){const o=a[t.charAt(r++)],i=r<t.length?a[t.charAt(r)]:0;++r;const c=r<t.length?a[t.charAt(r)]:64;++r;const m=r<t.length?a[t.charAt(r)]:64;if(++r,o==null||i==null||c==null||m==null)throw new Rt;const d=o<<2|i>>4;if(s.push(d),c!==64){const p=i<<4&240|c>>2;if(s.push(p),m!==64){const b=c<<6&192|m;s.push(b)}}}return s},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let t=0;t<this.ENCODED_VALS.length;t++)this.byteToCharMap_[t]=this.ENCODED_VALS.charAt(t),this.charToByteMap_[this.byteToCharMap_[t]]=t,this.byteToCharMapWebSafe_[t]=this.ENCODED_VALS_WEBSAFE.charAt(t),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[t]]=t,t>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(t)]=t,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(t)]=t)}}};class Rt extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Ht=function(t){const e=at(t);return st.encodeByteArray(e,!0)},rt=function(t){return Ht(t).replace(/\./g,"")},Ut=function(t){try{return st.decodeString(t,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zt=()=>Vt().__FIREBASE_DEFAULTS__,Gt=()=>{if(typeof process>"u"||typeof Ae>"u")return;const t=Ae.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},Qt=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&Ut(t[1]);return e&&JSON.parse(e)},nt=()=>{try{return Ot()||zt()||Gt()||Qt()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},Wt=t=>nt()?.emulatorHosts?.[t],Jt=t=>{const e=Wt(t);if(!e)return;const a=e.lastIndexOf(":");if(a<=0||a+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const s=parseInt(e.substring(a+1),10);return e[0]==="["?[e.substring(1,a-1),s]:[e.substring(0,a),s]},ot=()=>nt()?.config;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((e,a)=>{this.resolve=e,this.reject=a})}wrapCallback(e){return(a,s)=>{a?this.reject(a):this.resolve(s),typeof e=="function"&&(this.promise.catch(()=>{}),e.length===1?e(a):e(a,s))}}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $e(t){try{return(t.startsWith("http://")||t.startsWith("https://")?new URL(t).hostname:t).endsWith(".cloudworkstations.dev")}catch{return!1}}async function Yt(t){return(await fetch(t,{credentials:"include"})).ok}const R={};function Zt(){const t={prod:[],emulator:[]};for(const e of Object.keys(R))R[e]?t.emulator.push(e):t.prod.push(e);return t}function Xt(t){let e=document.getElementById(t),a=!1;return e||(e=document.createElement("div"),e.setAttribute("id",t),a=!0),{created:a,element:e}}let Pe=!1;function ea(t,e){if(typeof window>"u"||typeof document>"u"||!$e(window.location.host)||R[t]===e||R[t]||Pe)return;R[t]=e;function a(d){return`__firebase__banner__${d}`}const s="__firebase__banner",o=Zt().prod.length>0;function n(){const d=document.getElementById(s);d&&d.remove()}function i(d){d.style.display="flex",d.style.background="#7faaf0",d.style.position="fixed",d.style.bottom="5px",d.style.left="5px",d.style.padding=".5em",d.style.borderRadius="5px",d.style.alignItems="center"}function l(d,p){d.setAttribute("width","24"),d.setAttribute("id",p),d.setAttribute("height","24"),d.setAttribute("viewBox","0 0 24 24"),d.setAttribute("fill","none"),d.style.marginLeft="-6px"}function c(){const d=document.createElement("span");return d.style.cursor="pointer",d.style.marginLeft="16px",d.style.fontSize="24px",d.innerHTML=" &times;",d.onclick=()=>{Pe=!0,n()},d}function u(d,p){d.setAttribute("id",p),d.innerText="Learn more",d.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",d.setAttribute("target","__blank"),d.style.paddingLeft="5px",d.style.textDecoration="underline"}function m(){const d=Xt(s),p=a("text"),b=document.getElementById(p)||document.createElement("span"),f=a("learnmore"),v=document.getElementById(f)||document.createElement("a"),y=a("preprendIcon"),h=document.getElementById(y)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(d.created){const $=d.element;i($),u(v,f);const L=c();l(h,y),$.append(h,b,v,L),document.body.appendChild($)}o?(b.innerText="Preview backend disconnected.",h.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
...
</defs>`,b.innerText="Preview backend running in this workspace."),b.setAttribute("id",p)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",m):m()}function ta(){try{return typeof indexedDB=="object"}catch{return!1}}function aa(){return new Promise((t,e)=>{try{let a=!0;const s="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(s);r.onsuccess=()=>{r.result.close(),a||self.indexedDB.deleteDatabase(s),t(!0)},r.onupgradeneeded=()=>{a=!1},r.onerror=()=>{e(r.error?.message||"")}}catch(a){e(a)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sa="FirebaseError";class O extends Error{constructor(e,a,s){super(a),this.code=e,this.customData=s,this.name=sa,Object.setPrototypeOf(this,O.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,it.prototype.create)}}class it{constructor(e,a,s){this.service=e,this.serviceName=a,this.errors=s}create(e,...a){const s=a[0]||{},r=`${this.service}/${e}`,o=this.errors[e],n=o?ra(o,s):"Error",i=`${this.serviceName}: ${n} (${r}).`;return new O(r,i,s)}}function ra(t,e){return t.replace(na,(a,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const na=/\{\$([^}]+)}/g;function pe(t,e){if(t===e)return!0;const a=Object.keys(t),s=Object.keys(e);for(const r of a){if(!s.includes(r))return!1;const o=t[r],n=e[r];if(je(o)&&je(n)){if(!pe(o,n))return!1}else if(o!==n)return!1}for(const r of s)if(!a.includes(r))return!1;return!0}function je(t){return t!==null&&typeof t=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ce(t){return t&&t._delegate?t._delegate:t}class z{constructor(e,a,s){this.name=e,this.instanceFactory=a,this.type=s,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oa{constructor(e,a){this.name=e,this.container=a,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const a=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(a)){const s=new Kt;if(this.instancesDeferred.set(a,s),this.isInitialized(a)||this.shouldAutoInitialize())try{const r=this.getOrInitializeService({instanceIdentifier:a});r&&s.resolve(r)}catch{}}return this.instancesDeferred.get(a).promise}getImmediate(e){const a=this.normalizeInstanceIdentifier(e?.identifier),s=e?.optional??!1;if(this.isInitialized(a)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:a})}catch(r){if(s)return null;throw r}else{if(s)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(la(e))try{this.getOrInitializeService({instanceIdentifier:P})}catch{}for(const[a,s]of this.instancesDeferred.entries()){const r=this.normalizeInstanceIdentifier(a);try{const o=this.getOrInitializeService({instanceIdentifier:r});s.resolve(o)}catch{}}}}clearInstance(e=P){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(a=>"INTERNAL"in a).map(a=>a.INTERNAL.delete()),...e.filter(a=>"_delete"in a).map(a=>a._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=P){return this.instances.has(e)}getOptions(e=P){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:a={}}=e,s=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(s))throw Error(`${this.name}(${s}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const r=this.getOrInitializeService({instanceIdentifier:s,options:a});for(const[o,n]of this.instancesDeferred.entries()){const i=this.normalizeInstanceIdentifier(o);s===i&&n.resolve(r)}return r}onInit(e,a){const s=this.normalizeInstanceIdentifier(a),r=this.onInitCallbacks.get(s)??new Set;r.add(e),this.onInitCallbacks.set(s,r);const o=this.instances.get(s);return o&&e(o,s),()=>{r.delete(e)}}invokeOnInitCallbacks(e,a){const s=this.onInitCallbacks.get(a);if(s)for(const r of s)try{r(e,a)}catch{}}getOrInitializeService({instanceIdentifier:e,options:a={}}){let s=this.instances.get(e);if(!s&&this.component&&(s=this.component.instanceFactory(this.container,{instanceIdentifier:ia(e),options:a}),this.instances.set(e,s),this.instancesOptions.set(e,a),this.invokeOnInitCallbacks(s,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,s)}catch{}return s||null}normalizeInstanceIdentifier(e=P){return this.component?this.component.multipleInstances?e:P:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function ia(t){return t===P?void 0:t}function la(t){return t.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ca{constructor(e){this.name=e,this.providers=new Map}addComponent(e){const a=this.getProvider(e.name);if(a.isComponentSet())throw new Error(`Component ${e.name} has already been registered with ${this.name}`);a.setComponent(e)}addOrOverwriteComponent(e){this.getProvider(e.name).isComponentSet()&&this.providers.delete(e.name),this.addComponent(e)}getProvider(e){if(this.providers.has(e))return this.providers.get(e);const a=new oa(e,this);return this.providers.set(e,a),a}getProviders(){return Array.from(this.providers.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var _;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(_||(_={}));const da={debug:_.DEBUG,verbose:_.VERBOSE,info:_.INFO,warn:_.WARN,error:_.ERROR,silent:_.SILENT},ua=_.INFO,pa={[_.DEBUG]:"log",[_.VERBOSE]:"log",[_.INFO]:"info",[_.WARN]:"warn",[_.ERROR]:"error"},ma=(t,e,...a)=>{if(e<t.logLevel)return;const s=new Date().toISOString(),r=pa[e];if(r)console[r](`[${s}]  ${t.name}:`,...a);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class ba{constructor(e){this.name=e,this._logLevel=ua,this._logHandler=ma,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in _))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?da[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,_.DEBUG,...e),this._logHandler(this,_.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,_.VERBOSE,...e),this._logHandler(this,_.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,_.INFO,...e),this._logHandler(this,_.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,_.WARN,...e),this._logHandler(this,_.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,_.ERROR,...e),this._logHandler(this,_.ERROR,...e)}}const ga=(t,e)=>e.some(a=>t instanceof a);let Ne,Oe;function fa(){return Ne||(Ne=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function va(){return Oe||(Oe=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const lt=new WeakMap,me=new WeakMap,ct=new WeakMap,ie=new WeakMap,Me=new WeakMap;function xa(t){const e=new Promise((a,s)=>{const r=()=>{t.removeEventListener("success",o),t.removeEventListener("error",n)},o=()=>{a(B(t.result)),r()},n=()=>{s(t.error),r()};t.addEventListener("success",o),t.addEventListener("error",n)});return e.then(a=>{a instanceof IDBCursor&&lt.set(a,t)}).catch(()=>{}),Me.set(e,t),e}function ha(t){if(me.has(t))return;const e=new Promise((a,s)=>{const r=()=>{t.removeEventListener("complete",o),t.removeEventListener("error",n),t.removeEventListener("abort",n)},o=()=>{a(),r()},n=()=>{s(t.error||new DOMException("AbortError","AbortError")),r()};t.addEventListener("complete",o),t.addEventListener("error",n),t.addEventListener("abort",n)});me.set(t,e)}let be={get(t,e,a){if(t instanceof IDBTransaction){if(e==="done")return me.get(t);if(e==="objectStoreNames")return t.objectStoreNames||ct.get(t);if(e==="store")return a.objectStoreNames[1]?void 0:a.objectStore(a.objectStoreNames[0])}return B(t[e])},set(t,e,a){return t[e]=a,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function ya(t){be=t(be)}function wa(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...a){const s=t.call(le(this),e,...a);return ct.set(s,e.sort?e.sort():[e]),B(s)}:va().includes(t)?function(...e){return t.apply(le(this),e),B(lt.get(this))}:function(...e){return B(t.apply(le(this),e))}}function Ea(t){return typeof t=="function"?wa(t):(t instanceof IDBTransaction&&ha(t),ga(t,fa())?new Proxy(t,be):t)}function B(t){if(t instanceof IDBRequest)return xa(t);if(ie.has(t))return ie.get(t);const e=Ea(t);return e!==t&&(ie.set(t,e),Me.set(e,t)),e}const le=t=>Me.get(t);function _a(t,e,{blocked:a,upgrade:s,blocking:r,terminated:o}={}){const n=indexedDB.open(t,e),i=B(n);return s&&n.addEventListener("upgradeneeded",l=>{s(B(n.result),l.oldVersion,l.newVersion,B(n.transaction),l)}),a&&n.addEventListener("blocked",l=>a(l.oldVersion,l.newVersion,l)),i.then(l=>{o&&l.addEventListener("close",()=>o()),r&&l.addEventListener("versionchange",c=>r(c.oldVersion,c.newVersion,c))}).catch(()=>{}),i}const $a=["get","getKey","getAll","getAllKeys","count"],Ca=["put","add","delete","clear"],ce=new Map;function Fe(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(ce.get(e))return ce.get(e);const a=e.replace(/FromIndex$/,""),s=e!==a,r=Ca.includes(a);if(!(a in(s?IDBIndex:IDBObjectStore).prototype)||!(r||$a.includes(a)))return;const o=async function(n,...i){const l=this.transaction(n,r?"readwrite":"readonly");let c=l.store;return s&&(c=c.index(i.shift())),(await Promise.all([c[a](...i),r&&l.done]))[0]};return ce.set(e,o),o}ya(t=>({...t,get:(e,a,s)=>Fe(e,a)||t.get(e,a,s),has:(e,a)=>!!Fe(e,a)||t.has(e,a)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ma{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(a=>{if(ka(a)){const s=a.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(a=>a).join(" ")}}function ka(t){return t.getComponent()?.type==="VERSION"}const ge="@firebase/app",Re="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S=new ba("@firebase/app"),Ia="@firebase/app-compat",Ta="@firebase/analytics-compat",Sa="@firebase/analytics",qa="@firebase/app-check-compat",Ba="@firebase/app-check",Da="@firebase/auth",La="@firebase/auth-compat",Aa="@firebase/database",Pa="@firebase/data-connect",ja="@firebase/database-compat",Na="@firebase/functions",Oa="@firebase/functions-compat",Fa="@firebase/installations",Ra="@firebase/installations-compat",Ha="@firebase/messaging",Ua="@firebase/messaging-compat",Va="@firebase/performance",za="@firebase/performance-compat",Ga="@firebase/remote-config",Qa="@firebase/remote-config-compat",Wa="@firebase/storage",Ja="@firebase/storage-compat",Ka="@firebase/firestore",Ya="@firebase/ai",Za="@firebase/firestore-compat",Xa="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fe="[DEFAULT]",es={[ge]:"fire-core",[Ia]:"fire-core-compat",[Sa]:"fire-analytics",[Ta]:"fire-analytics-compat",[Ba]:"fire-app-check",[qa]:"fire-app-check-compat",[Da]:"fire-auth",[La]:"fire-auth-compat",[Aa]:"fire-rtdb",[Pa]:"fire-data-connect",[ja]:"fire-rtdb-compat",[Na]:"fire-fn",[Oa]:"fire-fn-compat",[Fa]:"fire-iid",[Ra]:"fire-iid-compat",[Ha]:"fire-fcm",[Ua]:"fire-fcm-compat",[Va]:"fire-perf",[za]:"fire-perf-compat",[Ga]:"fire-rc",[Qa]:"fire-rc-compat",[Wa]:"fire-gcs",[Ja]:"fire-gcs-compat",[Ka]:"fire-fst",[Za]:"fire-fst-compat",[Ya]:"fire-vertex","fire-js":"fire-js",[Xa]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const J=new Map,ts=new Map,ve=new Map;function He(t,e){try{t.container.addComponent(e)}catch(a){S.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,a)}}function K(t){const e=t.name;if(ve.has(e))return S.debug(`There were multiple attempts to register component ${e}.`),!1;ve.set(e,t);for(const a of J.values())He(a,t);for(const a of ts.values())He(a,t);return!0}function as(t,e){const a=t.container.getProvider("heartbeat").getImmediate({optional:!0});return a&&a.triggerHeartbeat(),t.container.getProvider(e)}function ss(t){return t==null?!1:t.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ns{constructor(e,a,s){this._isDeleted=!1,this._options={...e},this._config={...a},this._name=a.name,this._automaticDataCollectionEnabled=a.automaticDataCollectionEnabled,this._container=s,this.container.addComponent(new z("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this.checkDestroyed(),this._automaticDataCollectionEnabled=e}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(e){this._isDeleted=e}checkDestroyed(){if(this.isDeleted)throw D.create("app-deleted",{appName:this._name})}}function os(t,e={}){let a=t;typeof e!="object"&&(e={name:e});const s={name:fe,automaticDataCollectionEnabled:!0,...e},r=s.name;if(typeof r!="string"||!r)throw D.create("bad-app-name",{appName:String(r)});if(a||(a=ot()),!a)throw D.create("no-options");const o=J.get(r);if(o){if(pe(a,o.options)&&pe(s,o.config))return o;throw D.create("duplicate-app",{appName:r})}const n=new ca(r);for(const l of ve.values())n.addComponent(l);const i=new ns(a,s,n);return J.set(r,i),i}function is(t=fe){const e=J.get(t);if(!e&&t===fe&&ot())return os();if(!e)throw D.create("no-app",{appName:t});return e}function H(t,e,a){let s=es[t]??t;a&&(s+=`-${a}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const n=[`Unable to register library "${s}" with version "${e}":`];r&&n.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&n.push("and"),o&&n.push(`version name "${e}" contains illegal characters (whitespace or "/")`),S.warn(n.join(" "));return}K(new z(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ls="firebase-heartbeat-database",cs=1,G="firebase-heartbeat-store";let de=null;function dt(){return de||(de=_a(ls,cs,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(G)}catch(a){console.warn(a)}}}}).catch(t=>{throw D.create("idb-open",{originalErrorMessage:t.message})})),de}async function ds(t){try{const a=(await dt()).transaction(G),s=await a.objectStore(G).get(ut(t));return await a.done,s}catch(e){if(e instanceof O)S.warn(e.message);else{const a=D.create("idb-get",{originalErrorMessage:e?.message});S.warn(a.message)}}}async function Ue(t,e){try{const s=(await dt()).transaction(G,"readwrite");await s.objectStore(G).put(e,ut(t)),await s.done}catch(a){if(a instanceof O)S.warn(a.message);else{const s=D.create("idb-set",{originalErrorMessage:a?.message});S.warn(s.message)}}}function ut(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const us=1024,ps=30;class ms{constructor(e){this.container=e,this._heartbeatsCache=null;const a=this.container.getProvider("app").getImmediate();this._storage=new gs(a),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){try{const a=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=Ve();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:a}),this._heartbeatsCache.heartbeats.length>ps){const r=fs(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){S.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Ve(),{heartbeatsToSend:a,unsentEntries:s}=bs(this._heartbeatsCache.heartbeats),r=rt(JSON.stringify({version:2,heartbeats:a}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(e){return S.warn(e),""}}}function Ve(){return new Date().toISOString().substring(0,10)}function bs(t,e=us){const a=[];let s=t.slice();for(const r of t){const o=a.find(n=>n.agent===r.agent);if(o){if(o.dates.push(r.date),ze(a)>e){o.dates.pop();break}}else if(a.push({agent:r.agent,dates:[r.date]}),ze(a)>e){a.pop();break}s=s.slice(1)}return{heartbeatsToSend:a,unsentEntries:s}}class gs{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ta()?aa().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const a=await ds(this.app);return a?.heartbeats?a:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return Ue(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return Ue(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function ze(t){return rt(JSON.stringify({version:2,heartbeats:t})).length}function fs(t){if(t.length===0)return-1;let e=0,a=t[0].date;for(let s=1;s<t.length;s++)t[s].date<a&&(a=t[s].date,e=s);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vs(t){K(new z("platform-logger",e=>new Ma(e),"PRIVATE")),K(new z("heartbeat",e=>new ms(e),"PRIVATE")),H(ge,Re,t),H(ge,Re,"esm2020"),H("fire-js","")}vs("");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xs="type.googleapis.com/google.protobuf.Int64Value",hs="type.googleapis.com/google.protobuf.UInt64Value";function pt(t,e){const a={};for(const s in t)t.hasOwnProperty(s)&&(a[s]=e(t[s]));return a}function Y(t){if(t==null)return null;if(t instanceof Number&&(t=t.valueOf()),typeof t=="number"&&isFinite(t)||t===!0||t===!1||Object.prototype.toString.call(t)==="[object String]")return t;if(t instanceof Date)return t.toISOString();if(Array.isArray(t))return t.map(e=>Y(e));if(typeof t=="function"||typeof t=="object")return pt(t,e=>Y(e));throw new Error("Data cannot be encoded in JSON: "+t)}function N(t){if(t==null)return t;if(t["@type"])switch(t["@type"]){case xs:case hs:{const e=Number(t.value);if(isNaN(e))throw new Error("Data cannot be decoded from JSON: "+t);return e}default:throw new Error("Data cannot be decoded from JSON: "+t)}return Array.isArray(t)?t.map(e=>N(e)):typeof t=="function"||typeof t=="object"?pt(t,e=>N(e)):t}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ge={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class k extends O{constructor(e,a,s){super(`${ke}/${e}`,a||""),this.details=s,Object.setPrototypeOf(this,k.prototype)}}function ys(t){if(t>=200&&t<300)return"ok";switch(t){case 0:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 500:return"internal";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}function Z(t,e){let a=ys(t),s=a,r;try{const o=e&&e.error;if(o){const n=o.status;if(typeof n=="string"){if(!Ge[n])return new k("internal","internal");a=Ge[n],s=n}const i=o.message;typeof i=="string"&&(s=i),r=o.details,r!==void 0&&(r=N(r))}}catch{}return a==="ok"?null:new k(a,s,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ws{constructor(e,a,s,r){this.app=e,this.auth=null,this.messaging=null,this.appCheck=null,this.serverAppAppCheckToken=null,ss(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.auth=a.getImmediate({optional:!0}),this.messaging=s.getImmediate({optional:!0}),this.auth||a.get().then(o=>this.auth=o,()=>{}),this.messaging||s.get().then(o=>this.messaging=o,()=>{}),this.appCheck||r?.get().then(o=>this.appCheck=o,()=>{})}async getAuthToken(){if(this.auth)try{return(await this.auth.getToken())?.accessToken}catch{return}}async getMessagingToken(){if(!(!this.messaging||!("Notification"in self)||Notification.permission!=="granted"))try{return await this.messaging.getToken()}catch{return}}async getAppCheckToken(e){if(this.serverAppAppCheckToken)return this.serverAppAppCheckToken;if(this.appCheck){const a=e?await this.appCheck.getLimitedUseToken():await this.appCheck.getToken();return a.error?null:a.token}return null}async getContext(e){const a=await this.getAuthToken(),s=await this.getMessagingToken(),r=await this.getAppCheckToken(e);return{authToken:a,messagingToken:s,appCheckToken:r}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xe="us-central1",Es=/^data: (.*?)(?:\n|$)/;function _s(t){let e=null;return{promise:new Promise((a,s)=>{e=setTimeout(()=>{s(new k("deadline-exceeded","deadline-exceeded"))},t)}),cancel:()=>{e&&clearTimeout(e)}}}class $s{constructor(e,a,s,r,o=xe,n=(...i)=>fetch(...i)){this.app=e,this.fetchImpl=n,this.emulatorOrigin=null,this.contextProvider=new ws(e,a,s,r),this.cancelAllRequests=new Promise(i=>{this.deleteService=()=>Promise.resolve(i())});try{const i=new URL(o);this.customDomain=i.origin+(i.pathname==="/"?"":i.pathname),this.region=xe}catch{this.customDomain=null,this.region=o}}_delete(){return this.deleteService()}_url(e){const a=this.app.options.projectId;return this.emulatorOrigin!==null?`${this.emulatorOrigin}/${a}/${this.region}/${e}`:this.customDomain!==null?`${this.customDomain}/${e}`:`https://${this.region}-${a}.cloudfunctions.net/${e}`}}function Cs(t,e,a){const s=$e(e);t.emulatorOrigin=`http${s?"s":""}://${e}:${a}`,s&&(Yt(t.emulatorOrigin+"/backends"),ea("Functions",!0))}function Ms(t,e,a){const s=r=>Is(t,e,r,{});return s.stream=(r,o)=>Ss(t,e,r,o),s}function mt(t){return t.emulatorOrigin&&$e(t.emulatorOrigin)?"include":void 0}async function ks(t,e,a,s,r){a["Content-Type"]="application/json";let o;try{o=await s(t,{method:"POST",body:JSON.stringify(e),headers:a,credentials:mt(r)})}catch{return{status:0,json:null}}let n=null;try{n=await o.json()}catch{}return{status:o.status,json:n}}async function bt(t,e){const a={},s=await t.contextProvider.getContext(e.limitedUseAppCheckTokens);return s.authToken&&(a.Authorization="Bearer "+s.authToken),s.messagingToken&&(a["Firebase-Instance-ID-Token"]=s.messagingToken),s.appCheckToken!==null&&(a["X-Firebase-AppCheck"]=s.appCheckToken),a}function Is(t,e,a,s){const r=t._url(e);return Ts(t,r,a,s)}async function Ts(t,e,a,s){a=Y(a);const r={data:a},o=await bt(t,s),n=s.timeout||7e4,i=_s(n),l=await Promise.race([ks(e,r,o,t.fetchImpl,t),i.promise,t.cancelAllRequests]);if(i.cancel(),!l)throw new k("cancelled","Firebase Functions instance was deleted.");const c=Z(l.status,l.json);if(c)throw c;if(!l.json)throw new k("internal","Response is not valid JSON object.");let u=l.json.data;if(typeof u>"u"&&(u=l.json.result),typeof u>"u")throw new k("internal","Response is missing data field.");return{data:N(u)}}function Ss(t,e,a,s){const r=t._url(e);return qs(t,r,a,s||{})}async function qs(t,e,a,s){a=Y(a);const r={data:a},o=await bt(t,s);o["Content-Type"]="application/json",o.Accept="text/event-stream";let n;try{n=await t.fetchImpl(e,{method:"POST",body:JSON.stringify(r),headers:o,signal:s?.signal,credentials:mt(t)})}catch(d){if(d instanceof Error&&d.name==="AbortError"){const b=new k("cancelled","Request was cancelled.");return{data:Promise.reject(b),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(b)}}}}}}const p=Z(0,null);return{data:Promise.reject(p),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(p)}}}}}}let i,l;const c=new Promise((d,p)=>{i=d,l=p});s?.signal?.addEventListener("abort",()=>{const d=new k("cancelled","Request was cancelled.");l(d)});const u=n.body.getReader(),m=Bs(u,i,l,s?.signal);return{stream:{[Symbol.asyncIterator](){const d=m.getReader();return{async next(){const{value:p,done:b}=await d.read();return{value:p,done:b}},async return(){return await d.cancel(),{done:!0,value:void 0}}}}},data:c}}function Bs(t,e,a,s){const r=(n,i)=>{const l=n.match(Es);if(!l)return;const c=l[1];try{const u=JSON.parse(c);if("result"in u){e(N(u.result));return}if("message"in u){i.enqueue(N(u.message));return}if("error"in u){const m=Z(0,u);i.error(m),a(m);return}}catch(u){if(u instanceof k){i.error(u),a(u);return}}},o=new TextDecoder;return new ReadableStream({start(n){let i="";return l();async function l(){if(s?.aborted){const c=new k("cancelled","Request was cancelled");return n.error(c),a(c),Promise.resolve()}try{const{value:c,done:u}=await t.read();if(u){i.trim()&&r(i.trim(),n),n.close();return}if(s?.aborted){const d=new k("cancelled","Request was cancelled");n.error(d),a(d),await t.cancel();return}i+=o.decode(c,{stream:!0});const m=i.split(`
`);i=m.pop()||"";for(const d of m)d.trim()&&r(d.trim(),n);return l()}catch(c){const u=c instanceof k?c:Z(0,null);n.error(u),a(u)}}},cancel(){return t.cancel()}})}const Qe="@firebase/functions",We="0.13.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ds="auth-internal",Ls="app-check-internal",As="messaging-internal";function Ps(t){const e=(a,{instanceIdentifier:s})=>{const r=a.getProvider("app").getImmediate(),o=a.getProvider(Ds),n=a.getProvider(As),i=a.getProvider(Ls);return new $s(r,o,n,i,s)};K(new z(ke,e,"PUBLIC").setMultipleInstances(!0)),H(Qe,We,t),H(Qe,We,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,a}async getAvailableResources(){const e=window.currentCountry;if(!e)return[];const a=window.ResourceProductionCalculator.calculateCountryProduction(e),s=window.ResourceConsumptionCalculator.calculateCountryConsumption(e),r=[];return Object.entries(jt).forEach(([o,n])=>{const i=a[o]||0,l=s[o]||0,c=i-l;c>0&&r.push({gameResourceId:n.gameResourceId,displayName:n.displayName,unit:n.defaultUnit,available:Math.round(c),defaultMarketType:n.marketTypes[0].id,hasMultipleTypes:n.marketTypes.length>1,types:n.marketTypes})}),r}setupEventListeners(){if(!this.currentModal)return;this.currentModal.querySelectorAll('[data-action="close"]').forEach(r=>{r.addEventListener("click",()=>this.closeModal())}),this.currentModal.querySelectorAll('input[name="resource"]').forEach(r=>{r.addEventListener("change",o=>this.onResourceSelected(o.target))}),this.currentModal.querySelectorAll("[data-quantity-preset]").forEach(r=>{r.addEventListener("click",o=>{const n=parseInt(o.target.dataset.quantityPreset);this.applyQuantityPreset(n)})}),this.currentModal.querySelectorAll("[data-price-preset]").forEach(r=>{r.addEventListener("click",o=>{const n=o.target.dataset.pricePreset;this.applyPricePreset(n)})});const e=this.currentModal.querySelector("#quantity-input"),a=this.currentModal.querySelector("#price-input");e?.addEventListener("input",()=>this.validateAndUpdateSummary()),a?.addEventListener("input",()=>this.validateAndUpdateSummary()),this.currentModal.querySelector("form")?.addEventListener("submit",r=>this.handleSubmit(r))}onResourceSelected(e){const a=e.dataset.marketType,s=e.dataset.unit,r=parseInt(e.dataset.available),o=this.currentModal.querySelector("#quantity-unit");o&&(o.textContent=s);const n=this.currentModal.querySelector("#quantity-input");n&&(n.max=r,n.setAttribute("data-available",r));const i=Nt(a,r);if(i){const l=this.currentModal.querySelector("#price-suggestion"),c=this.currentModal.querySelector("#price-range");l&&c&&(l.classList.remove("hidden"),c.textContent=`${i.min} - ${i.max}`,this.currentModal.setAttribute("data-price-low",i.min),this.currentModal.setAttribute("data-price-market",i.suggested),this.currentModal.setAttribute("data-price-high",i.max));const u=this.currentModal.querySelector("#price-input");u&&!u.value&&(u.value=i.suggested)}this.validateAndUpdateSummary()}applyQuantityPreset(e){const a=this.currentModal.querySelector("#quantity-input"),s=parseInt(a.getAttribute("data-available")||0),r=Math.floor(s*(e/100));a.value=r,this.validateAndUpdateSummary()}applyPricePreset(e){const a=this.currentModal.querySelector("#price-input");let s=0;e==="low"?s=this.currentModal.getAttribute("data-price-low"):e==="market"?s=this.currentModal.getAttribute("data-price-market"):e==="high"&&(s=this.currentModal.getAttribute("data-price-high")),s&&(a.value=s,this.validateAndUpdateSummary())}validateAndUpdateSummary(){const e=this.currentModal.querySelector("#quantity-input"),a=this.currentModal.querySelector("#price-input"),s=parseInt(e?.value||0),r=parseFloat(a?.value||0),o=parseInt(e?.getAttribute("data-available")||0),n=this.currentModal.querySelector("#quantity-feedback"),i=this.currentModal.querySelector("#quantity-progress");if(s>0){const m=Math.min(s/o*100,100);i.style.width=`${m}%`,s>o?(n.className="mt-2 text-sm text-red-400",n.textContent=`❌ Quantidade excede o disponível (${o.toLocaleString()})`,n.classList.remove("hidden")):(n.className="mt-2 text-sm text-green-400",n.textContent=`✅ Válido (${(s/o*100).toFixed(1)}% do estoque)`,n.classList.remove("hidden"))}else i.style.width="0%",n.classList.add("hidden");const l=s*r;this.currentModal.querySelector("#total-value").textContent=`${l.toLocaleString("en-US",{minimumFractionDigits:2})}`,this.currentModal.querySelector("#unit-value").textContent=`${r.toLocaleString("en-US",{minimumFractionDigits:2})}`,this.currentModal.querySelector("#summary-quantity").textContent=s.toLocaleString();const c=parseFloat(this.currentModal.getAttribute("data-price-market")||0),u=this.currentModal.querySelector("#profit-estimate");if(c>0&&r>0){const m=(r-c)/c*100;m>5?(u.className="font-semibold text-green-400",u.textContent=`+${m.toFixed(1)}% acima do mercado`):m<-5?(u.className="font-semibold text-red-400",u.textContent=`${m.toFixed(1)}% abaixo do mercado`):(u.className="font-semibold text-yellow-400",u.textContent="≈ Preço de mercado")}}async handleSubmit(e){e.preventDefault();const a=e.target,s=this.currentModal.querySelector("#submit-offer-btn"),r=s.textContent;try{s.disabled=!0,s.textContent="⏳ Criando oferta...";const o=new FormData(a),n=a.querySelector('input[name="resource"]:checked'),i=n.dataset.marketType,l=n.dataset.unit,c={type:"sell",category:"resources",item_id:i,item_name:n.parentElement.querySelector(".font-medium").textContent,quantity:parseInt(o.get("quantity")),unit:l,price_per_unit:parseFloat(o.get("price_per_unit")),min_quantity:parseInt(o.get("min_quantity"))||1,delivery_time_days:parseInt(o.get("delivery_time_days"))||30,duration_days:parseInt(o.get("duration_days"))||14,title:o.get("custom_title")||null};c.title||(c.title=`${c.item_name} - ${c.quantity.toLocaleString()} ${l}`),console.log("📤 Enviando oferta:",c);const u=await this.marketplaceSystem.createOffer(c);if(u.success)s.textContent="✅ Oferta criada!",s.classList.add("bg-green-600"),setTimeout(()=>{this.closeModal(),window.location.reload()},1500);else throw new Error(u.error||"Erro desconhecido")}catch(o){console.error("❌ Erro ao criar oferta:",o),s.textContent="❌ Erro",s.classList.add("bg-red-600"),alert(`Erro ao criar oferta: ${o.message}`),setTimeout(()=>{s.textContent=r,s.classList.remove("bg-red-600"),s.disabled=!1},3e3)}}closeModal(){this.currentModal&&(this.currentModal.remove(),this.currentModal=null)}}class Fs{constructor(){this.modal=null,this.country=null,this.lawsConfig=null}openModal(e,a,s){if(this.country=a,this.lawsConfig=s,document.getElementById("law-change-modal"))return;const r=this.renderModal(e);document.body.insertAdjacentHTML("beforeend",r),this.modal=document.getElementById("law-change-modal"),this.setupEventListeners(e)}renderModal(e){const a=this.lawsConfig[e+"Laws"],s=this.country[e+"Law"],r=!!this.country.lawChange;return`
    ...
    `}calculateTransitionTime(e,a){const s=this.country.inWarWith&&this.country.inWarWith.length>0,o=Math.abs(e-a)*2;return s?Math.max(1,o):Math.max(2,o*2)}getLawEffects(e){const a=[];return e.bonuses&&Object.entries(e.bonuses).forEach(([s,r])=>{const o=this.getEffectDisplayName(s);a.push(`
        ...
        `)}),a.length===0?'<div class="text-slate-500 italic">Nenhum efeito especial</div>':`<div class="flex flex-wrap gap-2">${a.join("")}</div>`}getEffectDisplayName(e){return{resourceProduction:"Produção de Recursos",civilianFactoryEfficiency:"Eficiência Civil",militaryProductionSpeed:"Produção Militar",recruitablePopulation:"População Recrutável",militaryProductionCost:"Custo Militar",warExhaustionPassiveGain:"Exaustão de Guerra",militaryCapacity:"Capacidade Militar"}[e]||e}setupEventListeners(e){this.modal.addEventListener("click",a=>{const s=a.target.closest("[data-action]");if(!s)return;const r=s.dataset.action;r==="close"?this.closeModal():r==="adopt"&&this.handleAdopt(s.dataset.lawId,s.dataset.lawType)}),this.modal.addEventListener("click",a=>{a.target.id==="law-change-modal"&&this.closeModal()})}async handleAdopt(e,a){const s=this.lawsConfig[a+"Laws"][e],r=this.lawsConfig[a+"Laws"][this.country[a+"Law"]],o=this.calculateTransitionTime(s.level,r.level);if(!await Lt("Confirmar Mudança de Lei",`Você tem certeza que deseja iniciar a transição para a lei "${s.name}"? O processo levará ${o} turnos e não poderá ser cancelado.`))return;const i={type:a,originLaw:this.country[a+"Law"],targetLaw:e,progress:0,totalTurns:o};try{await g.collection("paises").doc(this.country.id).update({lawChange:i}),qe("success",`Transição para ${s.name} iniciada!`),this.closeModal(),setTimeout(()=>window.location.reload(),500)}catch(l){console.error("Erro ao iniciar mudança de lei:",l),qe("error",`Erro: ${l.message}`)}}closeModal(){this.modal&&(this.modal.remove(),this.modal=null)}}function Rs(t){return t<=20?{label:"Anarquia",tone:"bg-rose-500/15 text-rose-300 border-rose-400/30"}:t<=49?{label:"Instável",tone:"bg-amber-500/15 text-amber-300 border-amber-400/30"}:t<=74?{label:"Neutro",tone:"bg-sky-500/15 text-sky-300 border-sky-400/30"}:{label:"Tranquilo",tone:"bg-emerald-500/15 text-emerald-300 border-emerald-400/30"}}function q(t){if(!t||isNaN(t))return"0";const e=parseFloat(t);return e>=1e9?(e/1e9).toFixed(1)+"B":e>=1e6?(e/1e6).toFixed(1)+"M":e>=1e3?(e/1e3).toFixed(0)+"K":Math.round(e).toLocaleString("pt-BR")}function M(t){if(!t)return"US$ 0";const e=parseFloat(t);return e>=1e9?"US$ "+(e/1e9).toFixed(1)+"B":e>=1e6?"US$ "+(e/1e6).toFixed(1)+"M":e>=1e3?"US$ "+(e/1e3).toFixed(1)+"K":"US$ "+e.toLocaleString()}function E(t){const e=parseFloat(t)||0;return e===0?"US$ 0":e>=1e9?`US$ ${(e/1e9).toFixed(1)}bi`:e>=1e6?`US$ ${(e/1e6).toFixed(1)}mi`:e>=1e3?`US$ ${(e/1e3).toFixed(1)}mil`:`US$ ${Math.round(e)}`}function Hs(t){const e=parseFloat(t.WarPower)||0;return Math.round(e)}function Q(t){const e=parseFloat(t.PIB)||0,a=(parseFloat(t.Burocracia)||0)/100,s=(parseFloat(t.Estabilidade)||0)/100,r=e*.25*a*(s*1.5),o=parseFloat(t.OrcamentoGasto||0),n=parseFloat(t.AgencyBudgetSpent||0);return Math.max(0,r-o-n)}function ft(t){const e=Q(t),a=(parseFloat(t.MilitaryBudgetPercent)||30)/100;return e*a}function vt(t){const e=(parseFloat(t.MilitaryDistributionVehicles)||40)/100,a=(parseFloat(t.MilitaryDistributionAircraft)||30)/100,s=(parseFloat(t.MilitaryDistributionNaval)||30)/100;return{vehicles:e,aircraft:a,naval:s,maintenancePercent:.15}}function Us(t){const s=(parseFloat(t.MilitaryBudgetPercent)||30)-30;let r=0,o=0;return s>0&&(r=Math.floor(s/2)*-1,o=s*-.5),{stabilityPenalty:r,economicPenalty:o,isOverBudget:s>0}}function ue(t){const e=ft(t),a=vt(t),s=e*(1-a.maintenancePercent),r=(parseFloat(t.Tecnologia)||0)/100,o=(parseFloat(t.IndustrialEfficiency)||30)/100,n=(parseFloat(t.Marinha)||0)/100,i=(parseFloat(t.Urbanizacao)||0)/100;return s*a.naval*r*o*n*i}async function Vs(t){let e=null;try{const h=await g.collection("gameConfig").doc("nationalLaws").get();h.exists&&(e=h.data())}catch(h){console.error("Erro ao carregar configuração de leis:",h)}e?.mobilizationLaws&&e?.economicLaws||console.warn("⚠️ Configuração de leis nacionais não encontrada no gameConfig"),At.computeEnergyDemandGW(t);const s=Pt.calculateConsumerGoods(t),r=Xe.calculateCountryConsumption(t),o=et.calculateCountryProduction(t),n={Carvao:Math.round((o.Carvao||0)-(r.Carvao||0)),Combustivel:Math.round((o.Combustivel||0)-(r.Combustivel||0)),Metais:Math.round((o.Metais||0)-(r.Metais||0)),Graos:Math.round((o.Graos||0)-(r.Graos||0)),Energia:Math.round((o.Energia||0)-(r.Energia||0))},i=Rs(parseFloat(t.Estabilidade)||0),l=Hs(t),c=(parseFloat(t.PIB)||0)/(parseFloat(t.Populacao)||1),u=Q(t),m=ft(t),d=vt(t),p=1+(t.currentModifiers?.militaryCapacity||0),b=m*d.vehicles*p,f=m*d.aircraft*p,v=m*d.naval*p,y=Us(t);return`
      ...
      <div class="max-w-7xl mx-auto px-6 py-6">
            ...
            <div class="lg:col-span-2 space-y-6">
              ...
              <div class="bg-slate-900/50 border border-slate-800/50 rounded-xl p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                  ${Object.entries(n).map(([h,$])=>{const L={Carvao:"🪨",Combustivel:"⛽",Metais:"🔩",Graos:"🌾",Energia:"⚡"},re={Carvao:"Carvão",Combustivel:"Combustível",Metais:"Metais",Graos:"Grãos",Energia:"Energia"},j=h==="Energia"?"MW":"";return`
                      <div class="text-center">
                        <div class="text-lg mb-1">${L[h]}</div>
                        <div class="text-xs text-slate-400 mb-1">${re[h]}</div>
        ...
        <div id="tab-resources" class="dashboard-tab-content hidden">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ${["Carvao","Combustivel","Metais","Graos","Energia"].map(h=>{const $={Carvao:"🪨",Combustivel:"⛽",Metais:"🔩",Graos:"🌾",Energia:"⚡"},L={Carvao:"Carvão",Combustivel:"Combustível",Metais:"Metais",Graos:"Grãos",Energia:"Energia"},re=t[`Potencial${h}`]||(h==="Energia"?"N/A":"3"),j=Math.round(o[h]||0),ne=Math.round(r[h]||0),W=n[h],oe=h==="Energia"?"MW":"unidades";return`
                <div class="bg-slate-900/50 border border-slate-800/50 rounded-xl p-6">
                  <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        ${h!=="Energia"?`<p class="text-sm text-slate-400">Potencial: ${re}/10</p>`:""}
                      </div>
                    </div>
                    <div class="text-right">
                      <div class="text-2xl font-bold ${W>=0?"text-emerald-400":"text-red-400"}">
                        ${W>=0?"+":""}${q(W)}
                      </div>
                      <div class="text-xs text-slate-400">${oe}/mês</div>
                    </div>
                  </div>
                  ...
                  <div class="grid grid-cols-2 gap-4 mb-4">
                    <div class="bg-slate-800/30 rounded-lg p-3">
                      ...
                      <div class="text-lg font-semibold text-cyan-400">${q(j)} ${oe}</div>
                    </div>
                    <div class="bg-slate-800/30 rounded-lg p-3">
                      <div class="text-xs text-slate-400 uppercase tracking-wide">Consumo</div>
                      <div class="text-lg font-semibold text-amber-400">${q(ne)} ${oe}</div>
                    </div>
                  </div>
                  ...
                  <div class="space-y-2">
                    <div class="flex justify-between text-sm">
                      ...
                      <span class="text-slate-200">${j>0?Math.round(j/Math.max(ne,1)*100):0}%</span>
                    </div>
                    <div class="w-full bg-slate-800 rounded-full h-2">
                      <div class="h-2 rounded-full ${W>=0?"bg-emerald-500":"bg-red-500"}"
                           style="width: ${Math.min(Math.max(j/Math.max(ne,1)*100,0),100)}%"></div>
                    </div>
                  </div>
                </div>
              `}).join("")}
  ...
  `}function zs(){document.addEventListener("click",t=>{if(t.target.matches(".dashboard-tab")){const e=t.target.dataset.tab;document.querySelectorAll(".dashboard-tab").forEach(a=>{a.classList.remove("active","border-blue-500","text-blue-400"),a.classList.add("border-transparent","text-slate-400")}),t.target.classList.add("active","border-blue-500","text-blue-400"),t.target.classList.remove("border-transparent","text-slate-400"),document.querySelectorAll(".dashboard-tab-content").forEach(a=>{a.classList.add("hidden")}),document.getElementById(`tab-${e}`)?.classList.remove("hidden"),e==="vehicles"&&Gs(),e==="aircraft"&&Qs(),e==="army"&&Te(),e==="naval"&&ht(),e==="market"&&or(),e==="intelligence"&&lr()}if(t.target.matches(".inventory-category-card")||t.target.closest(".inventory-category-card")){const a=t.target.closest(".inventory-category-card").dataset.category;Ks(a)}if(t.target.matches(".equipment-item")||t.target.closest(".equipment-item")){const e=t.target.closest(".equipment-item"),a=e.dataset.equipment,s=e.dataset.category;xt(s,a)}})}async function Gs(){try{const t=document.getElementById("vehicles-inventory-container");if(!t)return;t.innerHTML=`
    ...
    `;const e=x.currentUser;if(!e)return;const a=await w(e.uid);if(!a)return;const s=await g.collection("inventory").doc(a).get();if(!s.exists){t.innerHTML=`
      ...
      `;return}const r=s.data();t.innerHTML=Js(r)}catch(t){console.error("Erro ao carregar inventário:",t);const e=document.getElementById("vehicles-inventory-container");e&&(e.innerHTML=`
      ...
      `)}}async function Qs(){try{const t=document.getElementById("aircraft-inventory-container");if(!t)return;t.innerHTML=`
      <div class="flex items-center justify-center py-8">
    ...
    `;const e=x.currentUser;if(!e)return;const a=await w(e.uid);if(!a)return;const s=await g.collection("inventory").doc(a).get();if(!s.exists){t.innerHTML=`
      ...
      `;return}const r=s.data();t.innerHTML=Ws(r)}catch(t){console.error("Erro ao carregar inventário aeronáutico:",t);const e=document.getElementById("aircraft-inventory-container");e&&(e.innerHTML=`
        <div class="bg-red-900/50 border border-red-800/50 rounded-xl p-6 text-center">
          <div class="text-6xl mb-4">❌</div>
          <h3 class="text-xl font-semibold text-red-200 mb-2">Erro</h3>
          <p class="text-red-400">Erro ao carregar inventário aeronáutico: ${t.message}</p>
        </div>
      `)}}function Ws(t){const e=["Caca","CAS","Bomber","BomberAJato","BomberEstrategico","BomberEstrategicoAJato","AWAC","HeliTransporte","HeliAtaque","TransporteAereo","Carga"],a=Object.keys(t).filter(o=>e.includes(o));if(a.length===0)return`
      <div class="bg-slate-900/50 border border-slate-800/50 rounded-xl p-6 text-center">
        <div class="text-6xl mb-4">✈️</div>
        <h3 class="text-xl font-semibold text-slate-200 mb-2">Inventário Aeronáutico Vazio</h3>
        <p class="text-slate-400">Nenhuma aeronave encontrada</p>
  ...
  `}function Js(t){const e=Object.keys(t);if(e.length===0)return`
      <div class="bg-slate-900/50 border border-slate-800/50 rounded-xl p-6 text-center">
        <div class="text-6xl mb-4">📦</div>
        <h3 class="text-xl font-semibold text-slate-200 mb-2">Inventário Vazio</h3>
        <p class="text-slate-400">Nenhum equipamento aprovado encontrado</p>
  ...
  `}async function Ks(t){try{const e=x.currentUser;if(!e)return;const a=await w(e.uid);if(!a)return;const s=await g.collection("inventory").doc(a).get();if(!s.exists)return;const o=s.data()[t];if(!o)return;const n=document.getElementById("inventory-details-modal");n&&n.remove();const i=document.createElement("div");i.id="inventory-details-modal",i.className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4";const l=document.createElement("div");l.className="bg-bg border border-bg-ring/70 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col";const c=Object.entries(o),u=c.reduce((d,[p,b])=>d+(b.quantity||0),0),m=c.reduce((d,[p,b])=>{const f=b.quantity||0,y=(b.cost||0)*.05;return d+y*f},0);l.innerHTML=`
    ...
    `,p.appendChild(b),p.addEventListener("click",v=>{v.target===p&&p.remove()}),b.querySelector("#close-equipment-modal").addEventListener("click",()=>{p.remove()});const f=b.querySelector("#view-equipment-sheet");f&&n.sheetImageUrl&&f.addEventListener("click",()=>{Ys(e,n.sheetImageUrl)}),document.addEventListener("keydown",function v(y){y.key==="Escape"&&(p.remove(),document.removeEventListener("keydown",v))}),document.body.appendChild(p)}catch(a){console.error("Erro ao carregar detalhes do equipamento:",a)}}function Ys(t,e){const a=document.getElementById("equipment-sheet-modal");a&&a.remove();const s=document.createElement("div");s.id="equipment-sheet-modal",s.className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4";const r=document.createElement("div");r.className="bg-bg border border-bg-ring/70 rounded-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col",r.innerHTML=`
  ...
  `,s.appendChild(r),s.addEventListener("click",o=>{o.target===s&&s.remove()}),r.querySelector("#close-sheet-modal").addEventListener("click",()=>{s.remove()}),r.querySelector("#open-sheet-new-tab").addEventListener("click",()=>{window.open(e,"_blank")}),document.addEventListener("keydown",function o(n){n.key==="Escape"&&(s.remove(),document.removeEventListener("keydown",o))}),document.body.appendChild(s)}function Zs(t){const e=new Map;return t.forEach(a=>{const s=Xs(a);if(e.has(s)){const r=e.get(s);r.count++,r.ids.push(a.id)}else e.set(s,{division:a,count:1,ids:[a.id]})}),Array.from(e.values())}function Xs(t){const e=t.name.replace(/\s*#\d+$/,""),a=JSON.stringify((t.combatUnits||[]).sort()),s=JSON.stringify((t.supportUnits||[]).sort());return`${e}|${t.trainingLevel}|${a}|${s}`}async function Te(){try{const t=document.getElementById("army-divisions-container");if(!t)return;t.innerHTML=`
      <div class="flex items-center justify-center py-8">
    ...
    `;const e=x.currentUser;if(!e)return;const a=await w(e.uid);if(!a)return;const s=await g.collection("inventory").doc(a).get(),r=s.exists?s.data().divisions||[]:[];if(r.length===0){t.innerHTML=`
      ...
      `;return}const o=Zs(r);o.sort((n,i)=>new Date(i.division.updatedAt)-new Date(n.division.updatedAt)),t.innerHTML=`
      <div class="mb-6 flex items-center justify-between">
        <div>
          <h2 class="text-2xl font-bold text-slate-100">Divisões do Exército</h2>
          <p class="text-slate-400 text-sm">Gerencie suas divisões militares (${r.length} total)</p>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ${o.map(n=>er(n.division,n.count,n.ids)).join("")}
      </div>
    `}catch(t){console.error("Erro ao carregar divisões:",t);const e=document.getElementById("army-divisions-container");e&&(e.innerHTML=`
      ...
      <div class="flex items-start justify-between mb-3">
        <div class="flex-1 ${e>1?"pr-12":""}">
          ...
          <div class="flex items-center gap-2">
            ...
            ${e>1?`<span class="text-xs text-slate-500">(${e} divisões)</span>`:""}
          </div>
        </div>
      </div>
  ...
  `}function tr(t,e,a){const s=t.approvalStatus||"approved";let r="";s==="pending"?r=`
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <a href="criador-navios.html" class="block p-4 bg-slate-800/30 hover:bg-slate-700/50 rounded-lg border border-slate-700/30 transition-colors">
            <div class="flex items-center justify-between">
              ...
              <div class="text-right">
                <div class="text-sm font-semibold text-slate-200">${E(ue(a))}/turno</div>
              </div>
            </div>
          </a>
          ...
          <div class="p-4 bg-slate-800/30 rounded-lg border border-slate-700/30">
            ...
            <div class="space-y-2 text-sm">
              <div class="flex justify-between">
                ...
                <span class="text-slate-200">${E(ue(a))}</span>
              </div>
              <div class="flex justify-between">
              ...
              <div class="flex justify-between border-t border-slate-600 pt-2">
                ...
                <span class="text-emerald-400 font-semibold">${E(ue(a)*(1+n.parallelBonus/100))}</span>
              </div>
            </div>
          </div>
        </div>
...
📈 Novos bônus: +${n.levelInfo.parallelBonus}% paralelo, -${n.levelInfo.timeReduction}% tempo`),setTimeout(()=>{ht()},1500)):(s.textContent="❌ Erro",s.classList.add("bg-red-600"),alert("Erro ao fazer upgrade: "+n.error),setTimeout(()=>{s.textContent=r,s.classList.remove("bg-red-600"),s.disabled=!1},3e3))}catch(e){console.error("Erro ao fazer upgrade do estaleiro:",e),alert("Erro ao fazer upgrade: "+e.message),event.target&&(event.target.textContent="❌ Erro",event.target.classList.add("bg-red-600"),setTimeout(()=>{event.target.textContent="⬆️ Fazer Upgrade",event.target.classList.remove("bg-red-600"),event.target.disabled=!1},3e3))}};window.showEquipmentDetails=xt;async function yt(){try{const t=x.currentUser;if(!t)return null;const e=await w(t.uid);if(!e)return null;const a=await g.collection("paises").doc(e).get();if(a.exists){const s={id:a.id,...a.data()};return window.currentCountry=s,s}return null}catch(t){return console.error("Erro ao recarregar país:",t),null}}window.reloadCurrentCountry=yt;async function nr(t){const e=document.getElementById("budget-box");if(!e){console.error("❌ Elemento budget-box não encontrado!");return}console.log("✅ Budget tooltip configurado para",t.Pais||t.id);let a=null;e.addEventListener("mouseenter",async()=>{console.log("🖱️ Mouse entrou no budget-box"),a&&(a.remove(),a=null);try{console.log("📊 Buscando breakdown para",t.id);const r=await A.getBreakdown(t.id);if(!r){console.warn("⚠️ Budget breakdown não encontrado - mostrando dados base");const n=A.calculateBase(t),i={base:n.calculated,baseFormatted:A.formatCurrency(n.calculated),additions:[],additionsTotal:0,additionsTotalFormatted:A.formatCurrency(0),subtractions:[],subtractionsTotal:0,subtractionsTotalFormatted:A.formatCurrency(0),available:n.calculated,availableFormatted:A.formatCurrency(n.calculated)};s(i,new Date().toISOString());return}console.log("✅ Breakdown encontrado:",r);const o=A.generateReport(r);console.log("📋 Report gerado:",o),s(o,r.lastUpdated)}catch(r){console.error("❌ Erro ao carregar budget breakdown:",r)}});function s(r,o){console.log("🎨 Criando elemento do tooltip");const n=`
    ...
    `;e.style.position="relative",e.insertAdjacentHTML("beforeend",n),a=document.getElementById("budget-tooltip"),console.log("✅ Tooltip criado:",a?"Sucesso":"Falhou")}e.addEventListener("mouseleave",()=>{a&&(a.remove(),a=null)})}async function Je(){try{await new Promise(o=>{x.onAuthStateChanged(o)});const t=x.currentUser;if(!t){document.getElementById("dashboard-content").innerHTML=`
      ...
      `;return}const e=await w(t.uid),a=await Ze(),s=e?a.find(o=>o.id===e):null;if(!s){document.getElementById("dashboard-content").innerHTML=`
        <div class="min-h-screen flex items-center justify-center bg-slate-950">
          <div class="text-center">
            <h2 class="text-2xl font-bold text-slate-200 mb-4">Acesso Negado</h2>
      ...
      `;return}window.currentCountry=s;const r=new Fs;window.openLawModal=async o=>{const n=await g.collection("gameConfig").doc("nationalLaws").get(),i=n.exists?n.data():null;if(!i){console.error("Configuração de leis não encontrada");return}const l=await yt();r.openModal(o,l,i)},document.getElementById("dashboard-content").innerHTML=await Vs(s),zs(),nr(s)}catch(t){console.error("Erro ao carregar dashboard:",t),document.getElementById("dashboard-content").innerHTML=`
      <div class="min-h-screen flex items-center justify-center bg-slate-950">
        <div class="text-center">
    ...
    `;const s=document.getElementById("marketplace-search")?.value||"",r=document.getElementById("marketplace-sort")?.value||"date",o=document.getElementById("marketplace-type")?.value||"all",n=parseFloat(document.getElementById("price-min")?.value)||null,i=parseFloat(document.getElementById("price-max")?.value)||null,l=parseInt(document.getElementById("quantity-min")?.value)||null,c=parseInt(document.getElementById("quantity-max")?.value)||null,u=document.getElementById("country-filter")?.value||null,m=parseInt(document.getElementById("time-filter")?.value)||null,d={category:t,type:o,searchTerm:s,current_country_id:e,orderBy:cr(r),orderDirection:dr(r),limit:50,priceMin:n,priceMax:i,quantityMin:l,quantityMax:c,countryFilter:u,timeFilter:m};let p=[],b={success:!0,offers:[]};if(t==="favorites"){const y=Bt();if(y.length===0)p=[],b={success:!0,offers:[],totalCount:0};else{const h={...d,category:"all",limit:1e3};b=await C.getOffers(h),b.success&&(p=b.offers.filter($=>y.includes($.id)))}}else b=await C.getOffers(d),p=b.offers||[];if(!b.success)throw new Error(b.error);if(p.length===0){const y=await he(e);a.innerHTML=`
        <div class="text-center py-12">
          <div class="text-6xl mb-4">📦</div>
      ...
      `;return}const f=await he(e);let v="";f.hasEmbargoes&&(v+=`
    ...
    `,a.innerHTML=v,Fr(p),jr(e,t,d)}catch(s){console.error("Erro ao carregar ofertas:",s),a.innerHTML=`
  ...
  `}async function ur(t){if(!t||!confirm("Tem certeza que deseja cancelar esta oferta de venda? Os itens serão restituídos ao seu inventário."))return;const e=document.getElementById(`cancel-offer-btn-${t}`);e&&(e.disabled=!0,e.textContent="Cancelando...");try{C||(C=new Ie);const a=await C.cancelOffer(t);if(a.success){const s=document.getElementById(`offer-card-${t}`);s&&(s.style.transition="opacity 0.5s ease",s.style.opacity="0",setTimeout(()=>s.remove(),500)),alert("Oferta cancelada com sucesso!")}else throw new Error(a.error||"Erro desconhecido ao cancelar a oferta.")}catch(a){console.error("Erro ao cancelar oferta:",a),alert(`Não foi possível cancelar a oferta: ${a.message}`),e&&(e.disabled=!1,e.textContent="Cancelar")}}window.cancelOffer=ur;async function pr(t){try{C&&C.incrementOfferViews(t);const e=x.currentUser;if(!e){alert("Você precisa estar logado para visualizar detalhes");return}const a=await w(e.uid);if(!a){alert("Você precisa estar associado a um país");return}const r=(await Ze()).find(h=>h.id===a);if(!r){alert("Dados do país não encontrados");return}const o=document.querySelectorAll('[onclick*="openOfferDetails"]');let n=null;try{const h=await C.getOffers({limit:1e3});h.success&&h.offers&&(n=h.offers.find($=>$.id===t))}catch(h){console.error("Error finding offer:",h)}if(!n){alert("Oferta não encontrada");return}const i=document.getElementById("offer-details-modal");i&&i.remove();const l=document.createElement("div");l.id="offer-details-modal",l.className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4";const c=n.player_id===e.uid||n.country_id===a,u=!c&&n.type==="sell"&&n.status==="active",m=!c&&n.type==="buy"&&n.status==="active",d=u||m,p=Q(r),b=n.quantity*n.price_per_unit,f=p>=b,v=n.expires_at?.toDate?n.expires_at.toDate():new Date(n.expires_at),y=Math.max(0,Math.ceil((v-new Date)/(1440*60*1e3)));l.innerHTML=`
      <div class="bg-bg-soft border border-bg-ring rounded-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        <div class="p-6 border-b border-bg-ring/50">
          <div class="flex items-center justify-between">
    ...
    `,document.body.appendChild(l),mr(n,r,a)}catch(e){console.error("Erro ao abrir detalhes da oferta:",e),alert("Erro ao carregar detalhes da oferta")}}function X(){const t=document.getElementById("offer-details-modal");t&&t.remove()}function mr(t,e,a){const s=document.getElementById("offer-details-modal");if(!s)return;const r=s.querySelector("#transaction-quantity");r&&r.addEventListener("input",()=>{br(t,r.value)}),s.addEventListener("click",o=>{o.target===s&&X()}),document.addEventListener("keydown",function o(n){n.key==="Escape"&&(X(),document.removeEventListener("keydown",o))})}function br(t,e){const a=document.getElementById("offer-details-modal");if(!a)return;const s=a.querySelector("#summary-quantity"),r=a.querySelector("#summary-total");if(s&&r){const o=parseInt(e)||1,n=o*t.price_per_unit;s.textContent=o.toLocaleString(),r.textContent=M(n)}}async function gr(t){try{const e=document.getElementById("offer-details-modal"),a=e.querySelector("#transaction-quantity"),s=e.querySelector("#process-transaction-btn"),r=s.textContent;if(!a){alert("Erro: quantidade não especificada");return}const o=parseInt(a.value);if(!o||o<=0){alert("Por favor, especifique uma quantidade válida"),a.focus();return}const n=x.currentUser;if(!n){alert("Você precisa estar logado");return}if(!await w(n.uid)){alert("Você precisa estar associado a um país");return}const c=(await C.getOffers({limit:1e3})).offers?.find(b=>b.id===t);if(!c){alert("Oferta não encontrada");return}if(o<(c.min_quantity||1)){alert(`Quantidade mínima: ${c.min_quantity||1} ${c.unit}`);return}if(o>(c.max_quantity||c.quantity)){alert(`Quantidade máxima: ${c.max_quantity||c.quantity} ${c.unit}`);return}if(o>c.quantity){alert(`Quantidade disponível: ${c.quantity} ${c.unit}`);return}const u=o*c.price_per_unit,d=`
    ...
    `,document.body.appendChild(i),i.addEventListener("click",l=>{l.target===i&&ye()}),document.addEventListener("keydown",function l(c){c.key==="Escape"&&(ye(),document.removeEventListener("keydown",l))})}catch(s){console.error("Erro ao abrir detalhes do equipamento:",s),alert("Erro ao carregar detalhes do equipamento")}}function ye(){const t=document.getElementById("equipment-details-modal");t&&t.remove()}window.openOfferDetails=pr;window.openEquipmentDetails=fr;window.closeEquipmentDetailsModal=ye;window.closeOfferDetailsModal=X;window.processTransaction=gr;async function vr(){try{const t=x.currentUser;if(!t){alert("Você precisa estar logado para criar ofertas");return}const e=await w(t.uid);if(!e){alert("Você precisa estar associado a um país");return}window.paisId=e,U||(C||(C=new Ie),U=new gt(C)),await U.openSelectionModal()}catch(t){console.error("Erro ao abrir modal de criação:",t),alert("Erro ao abrir formulário de criação de ofertas")}}function xr(){const t=document.getElementById("create-offer-modal"),e=document.getElementById("resource-sell-modal");t&&t.remove(),e&&e.remove()}window.closeCreateOfferModal=xr;function hr(t,e){let a;return function(...r){const o=()=>{clearTimeout(a),t(...r)};clearTimeout(a),a=setTimeout(o,e)}}async function yr(){try{const t=x.currentUser;if(!t)return;const e=await w(t.uid);if(!e)return;const a=document.createElement("div");a.className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4",a.id="notifications-modal",a.innerHTML=`
    ...
    `,document.body.appendChild(a),wr(e),await Er(e)}catch(t){console.error("Erro ao abrir modal de notificações:",t)}}function we(){const t=document.getElementById("notifications-modal");t&&t.remove()}function wr(t){const e=document.getElementById("notifications-modal");if(!e)return;const a=e.querySelectorAll(".notification-filter-btn");a.forEach(s=>{s.addEventListener("click",()=>{a.forEach(o=>{o.classList.remove("active","bg-brand-500/20","text-brand-400","border-brand-400/30"),o.classList.add("bg-bg/50","text-slate-300","border-bg-ring")}),s.classList.add("active","bg-brand-500/20","text-brand-400","border-brand-400/30"),s.classList.remove("bg-bg/50","text-slate-300","border-bg-ring");const r=s.dataset.filter;te(r)})}),e.addEventListener("click",s=>{s.target===e&&we()}),document.addEventListener("keydown",function s(r){r.key==="Escape"&&(we(),document.removeEventListener("keydown",s))})}let T=[];async function Er(t){try{const e=await g.collection("notifications").where("target_country_id","==",t).orderBy("created_at","desc").limit(50).get();T=[],e.forEach(a=>{T.push({id:a.id,...a.data()})}),Et(T)}catch(e){console.error("Erro ao carregar notificações:",e);const a=document.getElementById("notifications-list");a&&(a.innerHTML=`
        <div class="text-center py-8 text-red-400">
          <div class="text-4xl mb-2">❌</div>
          <p>Erro ao carregar notificações</p>
        </div>
      `)}}function Et(t){const e=document.getElementById("notifications-list");if(e){if(t.length===0){e.innerHTML=`
      <div class="text-center py-8 text-slate-400">
        <div class="text-4xl mb-2">📪</div>
        <p>Nenhuma notificação encontrada</p>
      </div>
    `;return}e.innerHTML=t.map(a=>_r(a)).join("")}}function _r(t){const e=!t.read,a=t.created_at?.toDate?t.created_at.toDate():new Date(t.created_at),s=kr(a),r={embargo_applied:"🚫",embargo_lifted:"✅",transaction_created:"💰",transaction_completed:"✅",trade_offer:"📦",diplomatic:"🏛️"},o={embargo_applied:"border-red-400/30 bg-red-400/10",embargo_lifted:"border-green-400/30 bg-green-400/10",transaction_created:"border-blue-400/30 bg-blue-400/10",transaction_completed:"border-green-400/30 bg-green-400/10",trade_offer:"border-yellow-400/30 bg-yellow-400/10",diplomatic:"border-purple-400/30 bg-purple-400/10"},n=r[t.type]||"📬";return`
  ...
  `}function te(t){let e=T;t==="unread"?e=T.filter(a=>!a.read):t==="embargo"?e=T.filter(a=>a.type&&a.type.includes("embargo")):t==="transaction"&&(e=T.filter(a=>a.type&&a.type.includes("transaction"))),Et(e)}async function $r(t){try{await g.collection("notifications").doc(t).update({read:!0,read_at:new Date});const e=T.find(s=>s.id===t);e&&(e.read=!0);const a=document.querySelector(".notification-filter-btn.active")?.dataset.filter||"all";te(a),await ae()}catch(e){console.error("Erro ao marcar notificação como lida:",e)}}async function Cr(){try{const t=x.currentUser;if(!t||!await w(t.uid))return;const a=g.batch();T.forEach(r=>{if(!r.read){const o=g.collection("notifications").doc(r.id);a.update(o,{read:!0,read_at:new Date}),r.read=!0}}),await a.commit();const s=document.querySelector(".notification-filter-btn.active")?.dataset.filter||"all";te(s),await ae()}catch(t){console.error("Erro ao marcar todas as notificações como lidas:",t)}}async function Mr(t){try{if(!confirm("Tem certeza que deseja excluir esta notificação?"))return;await g.collection("notifications").doc(t).delete(),T=T.filter(a=>a.id!==t);const e=document.querySelector(".notification-filter-btn.active")?.dataset.filter||"all";te(e),await ae()}catch(e){console.error("Erro ao excluir notificação:",e)}}async function ae(){try{const t=x.currentUser;if(!t)return;const e=await w(t.uid);if(!e)return;const s=(await g.collection("notifications").where("target_country_id","==",e).where("read","==",!1).get()).size,r=document.getElementById("notifications-count-badge");r&&(s>0?(r.textContent=s>99?"99+":s.toString(),r.classList.remove("hidden")):r.classList.add("hidden"))}catch(t){console.error("Erro ao atualizar contador de notificações:",t)}}function kr(t){const a=new Date-t,s=Math.floor(a/(1e3*60)),r=Math.floor(a/(1e3*60*60)),o=Math.floor(a/(1e3*60*60*24));return s<1?"Agora há pouco":s<60?`${s} min atrás`:r<24?`${r}h atrás`:o<7?`${o} dias atrás`:t.toLocaleDateString("pt-BR")}window.closeNotificationsModal=we;window.markNotificationAsRead=$r;window.markAllNotificationsAsRead=Cr;window.deleteNotification=Mr;window.openEmbargoesModal=_t;window.closeEmbargoesModal=Ir;window.openCreateEmbargoModal=Ct;window.closeCreateEmbargoModal=Mt;window.liftEmbargo=qr;async function _t(){try{const t=x.currentUser;if(!t)return;const e=await w(t.uid);if(!e)return;const a=document.createElement("div");a.className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4",a.id="embargoes-modal",a.innerHTML=`
      <div class="bg-bg-soft border border-bg-ring rounded-xl max-w-4xl w-full max-h-[80vh] overflow-y-auto">
        <div class="p-6 border-b border-bg-ring/50">
          <div class="flex items-center justify-between">
  ...
  `}function Ir(){const t=document.getElementById("embargoes-modal");t&&t.remove()}async function Ct(){try{const t=x.currentUser;if(!t)return;const e=await w(t.uid);if(!e)return;const a=await g.collection("paises").get(),s=[];a.forEach(o=>{const n=o.data();o.id!==e&&s.push({id:o.id,name:n.Pais,flag:n.Flag||"🏳️"})});const r=document.createElement("div");r.className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4",r.id="create-embargo-modal",r.innerHTML=`
    ...
    `,document.body.appendChild(r),Tr()}catch(t){console.error("Erro ao abrir modal de criar embargo:",t)}}function Tr(){const t=document.querySelectorAll('input[name="embargo-type"]'),e=document.getElementById("categories-section");t.forEach(s=>{s.addEventListener("change",()=>{s.value==="partial"?e.classList.remove("hidden"):e.classList.add("hidden")})});const a=document.getElementById("create-embargo-form");a&&a.addEventListener("submit",Sr)}async function Sr(t){t.preventDefault();try{const e=new FormData(t.target),a=document.getElementById("target-country").value,s=e.get("embargo-type"),r=document.getElementById("embargo-reason").value,o=document.getElementById("embargo-duration").value;if(!a){alert("Selecione um país alvo");return}let n=[];if(s==="partial"){const d=document.querySelectorAll('input[name="blocked-categories"]:checked');if(n=Array.from(d).map(p=>p.value),n.length===0){alert("Selecione pelo menos uma categoria para embargo parcial");return}}let i=null;o&&(i=new Date(Date.now()+parseInt(o)*24*60*60*1e3));const l={target_country_id:a,type:s,categories_blocked:n,reason:r||"Motivos diplomáticos",expires_at:i},c=t.target.querySelector('button[type="submit"]'),u=c.textContent;c.textContent="Aplicando...",c.disabled=!0;const m=await C.applyEmbargo(l);if(m.success){alert("Embargo aplicado com sucesso!"),Mt();const d=x.currentUser;if(d){const p=await w(d.uid);if(p){const b=document.querySelector(".marketplace-category-btn.active")?.dataset.category||"all";I(b,p),Se(p)}}}else throw new Error(m.error)}catch(e){console.error("Erro ao aplicar embargo:",e),alert(`Erro ao aplicar embargo: ${e.message}`);const a=t.target.querySelector('button[type="submit"]');a.textContent="Aplicar Embargo",a.disabled=!1}}function Mt(){const t=document.getElementById("create-embargo-modal");t&&t.remove()}async function qr(t){try{if(!confirm("Tem certeza que deseja suspender este embargo?"))return;await g.collection("marketplace_embargoes").doc(t).update({status:"lifted",updated_at:new Date}),alert("Embargo suspenso com sucesso!");const e=x.currentUser;if(e){const a=await w(e.uid);if(a){await $t(a);const s=document.querySelector(".marketplace-category-btn.active")?.dataset.category||"all";I(s,a),Se(a)}}}catch(e){console.error("Erro ao suspender embargo:",e),alert(`Erro ao suspender embargo: ${e.message}`)}}async function Se(t){try{const e=await he(t),a=document.getElementById("embargo-status-indicator"),s=document.getElementById("embargo-count-badge");if(!a||!s)return;if(e.hasEmbargoes){const r=e.hasFullEmbargo?"todas as categorias":`${e.blockedCategories.length} categoria(s)`;a.innerHTML=`
      ...
      `,s.classList.add("hidden")}catch(e){console.error("Erro ao atualizar indicador de embargo:",e)}}function Br(){const t=document.getElementById("toggle-advanced-filters"),e=document.getElementById("advanced-filters-panel"),a=document.getElementById("advanced-filters-icon");t&&e&&a&&t.addEventListener("click",()=>{e.classList.toggle("hidden"),a.classList.toggle("rotate-180")});const s=document.getElementById("apply-filters-btn"),r=document.getElementById("clear-filters-btn"),o=document.getElementById("save-filters-btn");s&&s.addEventListener("click",kt),r&&r.addEventListener("click",Dr),o&&o.addEventListener("click",Lr),Ar()}async function kt(){const t=x.currentUser;if(!t)return;const e=await w(t.uid);if(!e)return;qt();const a=document.querySelector(".marketplace-category-btn.active")?.dataset.category||"all";await I(a,e)}function Dr(){document.getElementById("marketplace-search").value="",document.getElementById("marketplace-sort").value="date",document.getElementById("marketplace-type").value="all",document.getElementById("price-min").value="",document.getElementById("price-max").value="",document.getElementById("quantity-min").value="",document.getElementById("quantity-max").value="",document.getElementById("country-filter").value="",document.getElementById("time-filter").value="",kt()}function Lr(){const t={search:document.getElementById("marketplace-search").value,sort:document.getElementById("marketplace-sort").value,type:document.getElementById("marketplace-type").value,priceMin:document.getElementById("price-min").value,priceMax:document.getElementById("price-max").value,quantityMin:document.getElementById("quantity-min").value,quantityMax:document.getElementById("quantity-max").value,country:document.getElementById("country-filter").value,timeFilter:document.getElementById("time-filter").value};localStorage.setItem("marketplace-filters",JSON.stringify(t));const e=document.getElementById("save-filters-btn"),a=e.textContent;e.textContent="✅ Salvo!",e.disabled=!0,setTimeout(()=>{e.textContent=a,e.disabled=!1},2e3)}function Ar(){try{const t=localStorage.getItem("marketplace-filters");if(!t)return;const e=JSON.parse(t);e.search&&(document.getElementById("marketplace-search").value=e.search),e.sort&&(document.getElementById("marketplace-sort").value=e.sort),e.type&&(document.getElementById("marketplace-type").value=e.type),e.priceMin&&(document.getElementById("price-min").value=e.priceMin),e.priceMax&&(document.getElementById("price-max").value=e.priceMax),e.quantityMin&&(document.getElementById("quantity-min").value=e.quantityMin),e.quantityMax&&(document.getElementById("quantity-max").value=e.quantityMax),e.country&&(document.getElementById("country-filter").value=e.country),e.timeFilter&&(document.getElementById("time-filter").value=e.timeFilter)}catch(t){console.error("Erro ao carregar filtros salvos:",t)}}async function Pr(){try{const t=await g.collection("paises").get(),e=document.getElementById("country-filter");if(!e)return;for(;e.children.length>1;)e.removeChild(e.lastChild);const a=[];t.forEach(s=>{const r=s.data();a.push({id:s.id,name:r.Pais,flag:r.Flag||"🏳️"})}),a.sort((s,r)=>s.name.localeCompare(r.name)),a.forEach(s=>{const r=document.createElement("option");r.value=s.id,r.textContent=`${s.flag} ${s.name}`,e.appendChild(r)})}catch(t){console.error("Erro ao carregar países para filtro:",t)}}let Ee=1,F=!1,V=!1,ee=null;function jr(t,e,a){const s=document.getElementById("load-more-btn"),r=document.getElementById("infinite-scroll-toggle"),o=document.getElementById("infinite-scroll-icon");ee={...a,countryId:t,category:e},s&&s.addEventListener("click",()=>{It()}),r&&o&&(r.addEventListener("click",()=>{F=!F,F?(o.textContent="♾️",r.title="Carregamento automático ativado",Nr()):(o.textContent="🔄",r.title="Carregamento automático desativado",Tt()),localStorage.setItem("marketplace-infinite-scroll",F)}),localStorage.getItem("marketplace-infinite-scroll")==="true"&&r.click())}async function It(){if(V||!ee)return;V=!0;const t=document.getElementById("load-more-btn"),e=document.getElementById("load-more-state"),a=document.getElementById("offers-grid");t&&(t.disabled=!0),e&&e.classList.remove("hidden");try{Ee++;const s={...ee,limit:20,offset:(Ee-1)*20},r=await C.getOffers(s);if(r.success&&r.offers.length>0){const o=r.offers.map(l=>wt(l)).join("");a&&(a.innerHTML+=o);const n=a?.children.length||0,i=document.querySelector(".text-sm.text-slate-400");i&&(i.textContent=`Mostrando ${n} ofertas`),r.offers.length<20&&t&&(t.textContent="✅ Todas as ofertas carregadas",t.disabled=!0)}else t&&(t.textContent="✅ Todas as ofertas carregadas",t.disabled=!0)}catch(s){console.error("Erro ao carregar mais ofertas:",s),t&&(t.disabled=!1)}finally{V=!1,e&&e.classList.add("hidden")}}function Nr(){Tt(),window.addEventListener("scroll",St)}function Tt(){window.removeEventListener("scroll",St)}function St(){if(!F||V)return;const t=window.innerHeight+window.scrollY,e=document.documentElement.offsetHeight;if(t>=e-200){const s=document.getElementById("load-more-btn");s&&!s.disabled&&It()}}function qt(){Ee=1,V=!1,ee=null}function Bt(){try{const t=localStorage.getItem("marketplace-favorites");return t?JSON.parse(t):[]}catch(t){return console.error("Erro ao carregar favoritos:",t),[]}}function Or(t){return Bt().includes(t)}function Fr(t){t.forEach(e=>{const a=document.getElementById(`favorite-btn-${e.id}`),s=document.getElementById(`favorite-icon-${e.id}`);a&&s&&(Or(e.id)?(a.classList.remove("bg-slate-600/20","text-slate-400"),a.classList.add("bg-yellow-500/20","text-yellow-400"),a.title="Remover dos favoritos",s.textContent="🌟"):(a.classList.remove("bg-yellow-500/20","text-yellow-400"),a.classList.add("bg-slate-600/20","text-slate-400"),a.title="Adicionar aos favoritos",s.textContent="⭐"))})}async function se(t){const e=document.getElementById("trade-relations-content");if(e)try{const a=await g.collection("marketplace_transactions").where("seller_country_id","==",t).where("status","==","pending").get(),s=await g.collection("marketplace_transactions").where("buyer_country_id","==",t).where("status","==","pending").get(),r=[],o=[];if(a.forEach(i=>r.push({id:i.id,...i.data()})),s.forEach(i=>o.push({id:i.id,...i.data()})),r.length===0&&o.length===0){e.innerHTML=`
        <div class="text-center py-8 text-slate-400">
          <div class="text-4xl mb-2">🌐</div>
    ...
    `}}function Ye(t,e){const a=e==="sell"?"text-brand-400":"text-blue-400",s=e==="sell"?"💰":"🛒",r=e==="sell"?"Vendendo para":"Comprando de",o=e==="sell"?"Venda Recorrente":"Compra Recorrente",n=e==="sell"?t.buyer_country_name:t.seller_country_name;return`
...
Prazo de entrega: ${new Date(a.delivery_deadline?.toDate?a.delivery_deadline.toDate():a.delivery_deadline).toLocaleDateString()}
    `.trim())}catch(e){console.error("Erro ao buscar detalhes:",e),alert("❌ Erro ao carregar detalhes: "+e.message)}}window.loadTradeRelations=se;window.cancelTransaction=Rr;window.viewTransactionDetails=Hr;async function Ur(t){try{if(!confirm(`⚠️ Tem certeza que deseja deletar esta divisão?

Esta ação não pode ser desfeita!`))return;const a=x.currentUser;if(!a)return;const s=await w(a.uid);if(!s)return;const r=g.collection("inventory").doc(s),o=await r.get();if(!o.exists){alert("❌ Inventário não encontrado");return}let n=o.data().divisions||[];n=n.filter(i=>i.id!==t),await r.update({divisions:n}),showNotification("success","✅ Divisão deletada com sucesso!"),await Te()}catch(e){console.error("Erro ao deletar divisão:",e),showNotification("error","❌ Erro ao deletar divisão: "+e.message)}}async function Vr(t){try{const e=t.length;if(!confirm(`⚠️ Tem certeza que deseja deletar ${e} divisões?

Esta ação não pode ser desfeita!`))return;const s=x.currentUser;if(!s)return;const r=await w(s.uid);if(!r)return;const o=g.collection("inventory").doc(r),n=await o.get();if(!n.exists){alert("❌ Inventário não encontrado");return}let i=n.data().divisions||[];i=i.filter(l=>!t.includes(l.id)),await o.update({divisions:i}),showNotification("success",`✅ ${e} divisões deletadas com sucesso!`),await Te()}catch(e){console.error("Erro ao deletar grupo de divisões:",e),showNotification("error","❌ Erro ao deletar divisões: "+e.message)}}window.deleteDivision=Ur;window.deleteDivisionGroup=Vr;document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Je):Je();
