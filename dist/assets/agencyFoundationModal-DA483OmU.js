...
import{_ as m}from"./preload-helper-f85Crcwt.js";import{i,A as p}from"./espionageOperationsSystem-CZU0ABJE.js";import{f as d}from"./utils-DLoRv3re.js";import"./firebase-DaxaZSOr.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-app-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-auth-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-storage-compat.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-functions-compat.js";import"./shipyardSystem-DYaoVOt1.js";class x{constructor(){this.modal=null,this.country=null,this.currentTurn=0,this.selectedBudgetPercent=5,this.selectedFocus="external_espionage",this.createModal()}createModal(){this.modal=document.createElement("div"),this.modal.id="agency-foundation-modal",this.modal.className="hidden fixed inset-0 z-[70] flex items-center justify-center bg-black/70 backdrop-blur-sm",this.modal.innerHTML=`
