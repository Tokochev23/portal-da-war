...
export const GENERIC_EQUIPMENT = {
  ...
  aircraft: {
    ...
    "BomberEstrategico": {
      name: "Bomber Estratégico Genérico",
    ...
    "BomberEstrategicoAJato": {
      name: "Bomber Estratégico a Jato Genérico",
    ...
    "HeliTransporte": {
      name: "Helicóptero de Transporte Genérico",
    ...
    "HeliAtaque": {
      name: "Helicóptero de Ataque Genérico",
    ...
    "TransporteAereo": {
      name: "Transporte Aéreo Genérico",
    ...
    "Carga": {
      name: "Aeronave de Carga Genérica",
  ...
  naval: {
    ...
    "CruzadorMisseis": {
      name: "Cruzador de Mísseis Genérico",
    ...
    "SubmarinoBalístico": {
      name: "Submarino Balístico Genérico",
    ...
    "SubmarinoNuclear": {
      name: "Submarino Nuclear Genérico",
    ...
    "TransporteNaval": {
      name: "Transporte Naval Genérico",
    ...
    "Desembarque": {
      name: "Navio de Desembarque Genérico",
